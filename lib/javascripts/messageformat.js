...
function MessageFormat(locale, pluralFunc) {
  ...
  pluralFunc =
    pluralFunc ||
    MessageFormat
      .locale[fallbackLocale = MessageFormat.Utils.getFallbackLocale(locale)];
...
MessageFormat.Utils = {
  numSub: function(string, key, depth) {
    ...
    return string.replace(/^#|[^\\]#/g, function(m) {
      ...
      return prefix + '" + (function(){ var x = ' + key +
...
var mparser = (function() {
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_messageFormatElement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, argIdx, efmt) {
            var res = { type: "messageFormatElement", argumentIndex: argIdx };
            if (efmt && efmt.length) {
      ...
      function parse_elementFormat() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, t, s) {
            return { type: "elementFormat", key: t, val: s.val };
      ...
      function parse_pluralFormatPattern() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, op, pf) {
            var res = { type: "pluralFormatPattern", pluralForms: pf };
            if (op) {
              res.offset = op;
            } else {
              res.offset = 0;
      ...
      function parse_string() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, ws, s) {
            ...
            return { type: "string", val: ws + tmp.join('') };
          })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
      ...
      if (result === null || pos !== input.length) {
        ...
        throw new this.SyntaxError(cleanupExpected(rightmostFailuresExpected),
                                   found, offset, errorPosition.line,
  ...
  result.SyntaxError = function(expected, found, offset, line, column) {
    function buildMessage(expected, found) {
      ...
      return "Expected " + expectedHumanized + " but " + foundHumanized +
             " found.";
    }
  ...
  function interpMFP(ast, data) {
    ...
    case 'elementFormat':
      if (ast.key === 'select') {
        ...
        s += 'r += (pf_' + data.pf_count + '[ k_' + (data.pf_count + 1) +
             ' ] || pf_' + data.pf_count + '[ "other" ])( d );\n';
        ...
        s += 'r += pf_' + data.pf_count + '[ k_' + (data.pf_count + 1) +
             ' + "" ]( d ); \n';
        s += '}\nelse {\n';
        s += 'r += (pf_' + data.pf_count + '[ MessageFormat.locale["' +
             self.fallbackLocale + '"]( k_' + (data.pf_count + 1) + ' - off_' +
             (data.pf_count) + ' ) ] || pf_' + data.pf_count +
             '[ "other" ] )( d );\n';
        s += '}\n';
      }
      return s;
    ...
    case 'pluralFormatPattern':
      ...
      for (i = 0; i < ast.pluralForms.length; ++i) {
        ...
        s += '"' + ast.pluralForms[i].key +
             '" : ' + interpMFP(ast.pluralForms[i].val, (function() {
      ...
      s += '\n};\n';
      if (needOther) {
        throw new Error("No 'other' form found in pluralFormatPattern " +
                        data.pf_count);
      }
      return s;
    case 'selectFormatPattern':
      ...
      s += '\n};\n';
      if (needOther) {
        throw new Error("No 'other' form found in selectFormatPattern " +
                        data.pf_count);
      }
      return s;
    /* // Unreachable
