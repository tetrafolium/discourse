...
if (!Object.entries) {
  Object.entries = function(obj) {
    var ownProps = Object.keys(obj), i = ownProps.length,
...
var setupSymbolInternals = function(symbol, desc) {
  defineProperties(symbol, {
    ...
    _isSymbol: { value: true },
    _id: { value: getNextSymbolId() }
  });
  return symbol;
};

var checkSymbolInternals = function(symbol) {
  return (symbol._isSymbol === true && typeof symbol._id === "number" &&
...
var appendArray = function(array1, array2) {
  ...
  if (!(typeof array1.length === "number" && array1.length >= 0 &&
        typeof array2.length === "number" && array2.length >= 0))
    return;
  var length1 = Math.floor(array1.length), length2 = Math.floor(array2.length),
      i = 0;
...
var es6ArrayPrototypeConcat = function concat() {
  ...
  var self = Object(this), targets = slice.call(arguments),
...
var es6ForOfLoop = function(iterable, callback, thisArg) {
  ...
  while (true) {
    ...
    if (!isObject(iterationResult))
      throw new TypeError("Iterator result " + iterationResult +
                          " is not an object");
...
defineProperty(StringIterator.prototype, Symbol.toStringTag.toString(),
               { value: "String Iterator", configurable: true });
...
if (isES6Running())
  ...
  defineProperties(ES6, {
    ...
    isSymbol: { value: isSymbol, writable: true, configurable: true },
    ...
    instanceOf:
      { value: es6InstanceOfOperator, writable: true, configurable: true },

    // This method behaves exactly same as ES6 for...of loop.
    forOf: { value: es6ForOfLoop, writable: true, configurable: true },
    ...
    spreadOperator:
      { value: es6SpreadOperator, writable: true, configurable: true }
  });
  ...
  defineProperty(
    ...
    { value: es6ArrayPrototypeConcat, writable: true, configurable: true });

  defineProperty(
    Object.prototype, "toString",
    { value: es6ObjectPrototypeToString, writable: true, configurable: true });
  ...
  defineProperty(Array, "from",
                 { value: es6ArrayFrom, writable: true, configurable: true });

  defineProperty(
    Array.prototype, "entries",
    { value: es6ArrayPrototypeEntries, writable: true, configurable: true });

  defineProperty(
    Array.prototype, "keys",
    { value: es6ArrayPrototypeKeys, writable: true, configurable: true });
