...
function setUp($el, settings) {
  var width = $el.data('width'), height = $el.data('height'),
      ratio = ($el.data('ratio')) ? $el.data('ratio') : settings.default_ratio,
      id = $el.data('youtube-id'), title = $el.data('youtube-title'),
      padding_bottom, innerHtml = [], $thumb, thumb_img,
  ...
  $thumb = $el.find('.ytp-thumbnail')
             .css({
               'background-image':
                 ['url(//img.youtube.com/vi/', id, '/', thumb_img, ')'].join('')
             })
             ...
             .on('click', function(e) {
               ...
               if (!$el.hasClass('lazyYT-video-loaded') &&
                 ...
                 $el
                   .html('<iframe src="//www.youtube.com/embed/' + id +
                         '?autoplay=1&' + youtube_parameters +
