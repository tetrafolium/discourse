ace.define(
  ...
  [
    "require", "exports", "module", "ace/config", "ace/lib/oop",
  ...
  function(e, t, n) {
    ...
    var
      r = e("../config").$modes,
      i = e("../lib/oop"), s = e("./text_highlight_rules").TextHighlightRules,
      o = function() {
        this.$rules = {
          start: [
            {
              ...
              onMatch: function(e, t, n, r) {
                var i = /^\s*/.exec(r)[0], s = e.match(/^(\s*)(\w+):/),
                    o = s[2];
                return /^(javascript|ruby|coffee|markdown|css|scss|sass|less)$/
                           .test(o) ||
                         (o = ""),
                       n.unshift("language-embed", [], [i, o], t), this.token
              },
              ...
              next: [
                {
                  ...
                  onMatch: function(e, t, n, r) {
                    ...
                    return i.length >= e.length
                             ? (n.splice(0, 3), this.next = n.shift(),
                                this.token)
                ...
                },
                {
                  ...
                  onMatch: function(e, t, n, i) {
                    ...
                    if (r[o]) {
                      var a = r[o].getTokenizer().getLineTokens(
                        i.slice(s.length), u.slice(0));
            ...
            },
            {
              ...
              onMatch: function(e, t, n, r) {
                var i = /^\s*/.exec(r)[0];
                return n.length < 1 ? n.push(this.next) : n[0] = "mlString",
                                                          n.length < 2
                                                            ? n.push(i.length)
                                                            : n[1] = i.length,
                                                          this.token
          ...
          mlString: [
            {
              ...
              onMatch: function(e, t, n) {
                var r = n[1];
                return r >= e.length ? (this.next = "start", n.splice(0))
                                     : this.next = "mlString",
                                       this.token
              },
              next: "start"
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
      "ace/mode/text", "ace/mode/xml_highlight_rules", "ace/mode/behaviour/xml",
      "ace/mode/folding/xml", "ace/worker/worker_client"
    ],
    function(e, t, n) {
      "use strict";
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var
        r = e("../config").$modes,
        i = e("../lib/oop"), s = e("../lib/lang"),
        o = e("./text_highlight_rules").TextHighlightRules,
        u = e("./html_highlight_rules").HtmlHighlightRules, a = function(e) {
          ...
          var e = {
            ...
            next: "githubblock"
              ...
              t = [{
                ...
                regex: ".*",
                onMatch: function(e, t, n, i) {
                  var s = n[1], o = n[2][0], u = n[2][1], a = n[2][2],
                      f = /^(\s*)(`+|~+)\s*$/.exec(e);
                  if (f && f[1].length < o.length + 3 &&
                      f[2].length >= u.length && f[2][0] == u[0])
      ...
      r.inherits(o, i), function() {
        ...
        this.getFoldWidget = function(e, t, n) {
          ...
          return this.foldingStartMarker.test(r)
                   ? r[0] == "`"
                       ? e.bgTokenizer.getState(n) == "start" ? "end" : "start"
                       : "start"
                   : ""
        }, this.getFoldWidgetRange = function(e, t, n) {
          function l(t) {
          ...
          this.$rules = {
            start: [
                ...
                rules: {
                  heredoc: [{
                    onMatch: function(e, t, n) {
                      return e === n[1]
                               ? (n.shift(), n.shift(),
                                  this.next = n[0] || "start", "support.class")
                               : (this.next = "", "string")
                    },
                    regex: ".*$",
                    next: "start"
              ...
              },
              {
                ...
                token: "empty",
                next: function(e, t) {
                  return t[0] === "heredoc" || t[0] === "indentedHeredoc" ? t[0]
                                                                          : e
                }
              },
              {
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/sh_highlight_rules", "ace/range", "ace/mode/folding/cstyle",
    ...
    function(e, t, n) {
      ...
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          o = e("../range").Range, u = e("./folding/cstyle").FoldMode,
          a = e("./behaviour/cstyle").CstyleBehaviour, f = function() {
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/javascript", "ace/mode/xml", "ace/mode/html",
      "ace/mode/markdown_highlight_rules", "ace/mode/folding/markdown",
      "ace/mode/javascript", "ace/mode/html", "ace/mode/sh", "ace/mode/sh",
      "ace/mode/xml", "ace/mode/css"
    ],
    function(e, t, n) {
      "use strict";
      ...
      r.inherits(l, i), function() {
        this.type = "text", this.blockComment = { start: "<!--", end: "-->" },
        this.getNextLineIndent = function(e, t, n) {
          if (e == "listblock") {
            var r = /^(\s*)(?:([-+*])|(\d+)\.)(\s+)/.exec(t);
            if (!r) return "";
  ...
  ace.define(
    "ace/mode/coffee",
    [
      "require", "exports", "module", "ace/mode/coffee_highlight_rules",
      "ace/mode/matching_brace_outdent", "ace/mode/folding/coffee", "ace/range",
      "ace/mode/text", "ace/worker/worker_client", "ace/lib/oop"
    ],
    function(e, t, n) {
      "use strict";
      function l() {
        this.HighlightRules = r, this.$outdent = new i,
      ...
      var r = e("./coffee_highlight_rules").CoffeeHighlightRules,
          ...
          u = e("./text").Mode, a = e("../worker/worker_client").WorkerClient,
          f = e("../lib/oop");
    ...
    function(e, t, n) {
      ...
      var
        ...
        o = e("./css_highlight_rules"), u = function() {
          var
            e = i.arrayToMap(o.supportType.split("|")),
            t = i.arrayToMap(
  ...
  ace.define(
    ...
    function(e, t, n) {
      "use strict";
      var r = e("../lib/oop"), i = e("../lib/lang"),
          s = e("./scss_highlight_rules").ScssHighlightRules, o = function() {
            s.call(this);
               ...
               this.$rules.comment = [
                 {
                   ...
                   onMatch: function(e, t, n) {
                     return n[1] === -1 &&
                            ...
                            e.length <= n[1] ? (n.shift(), n.shift(), n.shift(),
  ...
  ace.define("ace/mode/sass",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
               "ace/mode/sass_highlight_rules", "ace/mode/folding/coffee"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./text").Mode,
      ...
      var
        ...
        s = e("./css_highlight_rules"), o = function() {
          var
            ...
            t = e.split("|"), n = s.supportType.split("|"),
          ...
          this.$rules = {
            start: [
              ...
              {
                token: function(e) {
                  return t.indexOf(e.toLowerCase()) > -1 ? "keyword"
                                                         : "variable"
                },
                regex: "[@\\$][a-z0-9_\\-@\\$]*\\b"
              },
  ...
  ace.define("ace/mode/less",
             [
               ...
               "ace/mode/less_highlight_rules",
               "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css",
               "ace/mode/css_completions", "ace/mode/folding/cstyle"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./text").Mode,
                   ...
                   f = e("./folding/cstyle").FoldMode, l = function() {
                     this.HighlightRules = s, this.$outdent = new o,
                     this.$behaviour = new u, this.$completer = new a,
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/ruby_highlight_rules", "ace/mode/matching_brace_outdent",
      "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/coffee"
    ],
    function(e, t, n) {
      "use strict";
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          o = e("./matching_brace_outdent").MatchingBraceOutdent,
          u = e("../range").Range, a = e("./behaviour/cstyle").CstyleBehaviour,
          f = e("./folding/coffee").FoldMode, l = function() {
            this.HighlightRules = s, this.$outdent = new o,
            this.$behaviour = new a, this.foldingRules = new f
          };
      r.inherits(l, i), function() {
        ...
        this.getNextLineIndent = function(e, t, n) {
          ...
          return /^\s+(end|else)$/.test(t + n) ||
                 this.$outdent.checkOutdent(t, n)
        }, this.autoOutdent = function(e, t, n) {
          var r = t.getLine(n);
          if (/}/.test(r)) return this.$outdent.autoOutdent(t, n);
          var i = this.$getIndent(r), s = t.getLine(n - 1),
              o = this.$getIndent(s), a = t.getTabString();
          o.length <= i.length && i.slice(-a.length) == a &&
  ...
  ace.define("ace/mode/slim",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
               "ace/mode/slim_highlight_rules", "ace/mode/javascript",
               "ace/mode/markdown", "ace/mode/coffee", "ace/mode/scss",
               "ace/mode/sass", "ace/mode/less", "ace/mode/ruby", "ace/mode/css"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./text").Mode,
