ace.define(
  ...
  ace.define(
    ...
    [
      ...
      "ace/mode/logiql_highlight_rules", "ace/mode/folding/coffee",
      "ace/token_iterator", "ace/range", "ace/mode/behaviour/cstyle",
    ...
    function(e, t, n) {
      ...
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          u = e("../token_iterator").TokenIterator, a = e("../range").Range,
          ...
          c = function() {
            ...
            this.$outdent = new l, this.$behaviour = new f
          };
