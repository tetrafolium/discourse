ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop",
      "ace/mode/javascript_highlight_rules", "ace/mode/text_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      var
        ...
        s = e("./text_highlight_rules").TextHighlightRules, o = function() {
            ...
            n = function(e) {
              ...
              return {
                token: e.token, regex: e.regex, next: n(function(t, n) {
                  return n.length === 0 && n.unshift(t), n.unshift(e.next),
                         e.next
                })
              }
            }, s = function(e) {
          ...
          for (var u = 0; u < this.$rules.no_regex.length; u++) {
            ...
            f.indexOf("paren") == -1 && (!a.next || a.next.isContextAware) &&
              o.push(a)
          }
  ...
  ace.define("ace/mode/sjs",
             [
               "require", "exports", "module", "ace/lib/oop",
               "ace/mode/javascript", "ace/mode/sjs_highlight_rules",
