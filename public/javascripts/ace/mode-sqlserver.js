ace.define("ace/mode/doc_comment_highlight_rules",
      ...
      var
        ...
        s = e("./text_highlight_rules").TextHighlightRules, o = function() {
          ...
          s +=
            ...
            s += "|LOOP|HASH|MERGE|REMOTE", s += "|TRY|CATCH|THROW",
            s += "|TYPE", s = s.split("|"), s = s.filter(function(r, i, s) {
          ...
          c(r.split("|"), "procedure"), c(e.split("|"), "operator"),
            c(t.split("|"), "function"), c(n.split("|"), "type"),
            c(u, "statement"), c(s.split("|"), "keyword"), this.completions = l
        };
  ...
  ace.define("ace/mode/folding/sqlserver",
             ...
             function(e, t, n) {
               "use strict";
               var r = e("../../lib/oop"), i = e("../../range").Range,
                   s = e("./cstyle").FoldMode, o = t.FoldMode = function() {};
               r.inherits(o, s), function() {
                 ...
                 this.getFoldWidgetRange = function(e, t, n, r) {
                   ...
                   var s = { row: t, column: n + r.length }, o = e.getLength(),
                       u, a = 1, f = /(\bCASE\b|\bBEGIN\b)|(\bEND\b)/i;
                   while (++t < o) {
                     u = e.getLine(t);
                     var l = f.exec(u);
                     if (!l) continue;
