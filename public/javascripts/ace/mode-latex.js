ace.define(
    ...
    function(e, t, n) {
      ...
      r.inherits(a, i), function() {
        ...
        this.getFoldWidgetRange = function(e, t, n) {
          ...
          var i = { "\\begin": 1, "\\end": -1 }, u = new o(e, t, n),
              a = u.getCurrentToken();
          if (!a ||
          ...
          return l === -1 ? new s(t, e.getLine(t).length, d, p)
  ...
  ace.define("ace/mode/latex",
             [
               ...
               "ace/mode/latex_highlight_rules", "ace/mode/behaviour/cstyle",
               "ace/mode/folding/latex"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./text").Mode,
                   ...
                   u = e("./folding/latex").FoldMode, a = function() {
