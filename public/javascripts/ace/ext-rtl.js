ace.define(
  "ace/ext/rtl",
  [
    "require", "exports", "module", "ace/lib/dom", "ace/lib/lang", "ace/editor",
    "ace/config"
  ],
  function(e, t, n) {
    "use strict";
    function u(e, t) {
      ...
      t.session.$bidiHandler.isRtlLine(n.row) && n.column === 0 &&
        (t.session.$bidiHandler.isMoveLeftOperation && n.row > 0
           ? t.getSelection().moveCursorTo(n.row - 1,
                                           t.session.getLine(n.row - 1).length)
           : t.getSelection().isEmpty() ? n.column += 1
    ...
    function f(e, t) {
      ...
      if (t.$bidiHandler.isRtlLine(e.start.row) && e.action === "insert" &&
          e.lines.length > 1)
    ...
    e("../config").defineOptions(o.prototype, "editor", {
      rtlText: {
        set: function(e) {
          e ? (this.on("session", f), this.on("changeSelection", u),
               this.renderer.on("afterRender", l), this.commands.on("exec", a),
               this.commands.addCommands(s))
            : (this.off("session", f), this.off("changeSelection", u),
               this.renderer.off("afterRender", l),
               this.commands.off("exec", a), this.commands.removeCommands(s),
               c(this.renderer)),
