ace.define(
  ...
  function(e, t, n) {
    ...
    var r = e("./lib/oop"), i = e("./lib/event_emitter").EventEmitter,
        ...
        f = e("./tokenizer").Tokenizer, l = o.comparePoints, c = function() {
    ...
    (function() {
          ...
          return c.$tokenizer = new f({
                   ...
                   snippetVar: [
                     ...
                     },
                     {
                       ...
                       onMatch: function(e, t, n) {
                         var r = n[0];
                         return r.fmtString = e, e = this.splitRegex.exec(e),
                                r.guard = e[1], r.fmt = e[2], r.flag = e[3], ""
                       },
                       next: "start"
                     },
                     {
      ...
      this.insertSnippetForSelection =
        ...
        for (var l = 0; l < o.length; l++) {
          ...
          m.unshift(l + 1, Math.max(0, d - l)), m.push(c),
            a[p] = c, o.splice.apply(o, m), v.indexOf(c) === -1 && v.push(c)
        }
        var g = 0, y = 0, b = "";
        o.forEach(function(e) {
          if (typeof e == "string") {
            var t = e.split("\n");
            t.length > 1 ? (y = t[t.length - 1].length, g += t.length - 1)
                         : y += e.length,
              b += e
          } else
        ...
        var w = e.getSelectionRange(), E = e.session.replace(w, b),
            S = new h(e), x = e.inVirtualSelectionMode && e.selection.index;
      ...
      this.$getScope =
        ...
        if (t === "html" || t === "php") {
          ...
          typeof r == "object" && (r = r[0]),
            r.substring && (r.substring(0, 3) == "js-"
                              ? t = "javascript"
                              : r.substring(0, 4) == "css-"
                                  ? t = "css"
      ...
      this.register = function(e, t) {
        ...
        e || (e = []), e && e.content ? a(e) : Array.isArray(e) && e.forEach(a),
    ...
    (function() {
      this.attach = function(e) {
        ...
        this.$openTabstops = null, this.selectedTabstop = null, this.editor = e,
        ...
        this.tabstops.forEach(this.removeTabstopMarkers, this),
          this.ranges = null, this.tabstops = null, this.selectedTabstop = null,
          this.editor.removeListener("change", this.$onChange),
          this.editor.removeListener("changeSelection",
                                     this.$onChangeSelection),
    ...
    function(e, t, n) {
      ...
      var r = e("../virtual_renderer").VirtualRenderer,
          ...
          f = function(e) {
            ...
            e && e.appendChild(t), t.style.display = "none",
            ...
            n.on("mousedown", function(e) {
              ...
              n.selection.moveToPosition(t), c.start.row = c.end.row = t.row,
                                             e.stop()
            });
            ...
            n.setSelectOnHover = function(e) {
              ...
              r !== t.selectedNode && t.selectedNode &&
            ...
            n.on("changeSelection", h), n.session.doc.getLength = function() {
            ...
            return d.$tokenizeRow =
              ...
              var i = t.caption || t.value || t.name, o = i.toLowerCase(),
                  u = (n.filterText || "").toLowerCase(), a = 0, f = 0;
              for (var l = 0; l <= u.length; l++)
                if (l != f && (t.matchMask & 1 << l || l == u.length)) {
                  ...
                  var h = o.indexOf(c, a);
                  if (h == -1) continue;
                  s(i.slice(a, h), ""), a = h + c.length,
                                        s(i.slice(h, a), "completion-highlight")
                }
              return s(i.slice(a, i.length), ""),
                     t.meta &&
                       r.push({ type: "completion-meta", value: t.meta }),
                     r
            },
                   ...
                   n.isOpen = !1, n.isTopdown = !1, n.autoSelect = !0,
                   n.filterText = "", n.data = [], n.setData = function(e, t) {
                     n.filterText = t || "",
                     ...
                     e = Math.max(this.autoSelect ? 0 : -1,
                     ...
                     var s = this.container, o = window.innerHeight,
                         ...
                         f = a.$maxLines * t * 1.4,
                         l = e.top + this.$borderSize, c = l > o / 2 && !r;
                     c && l + t + f > o
                       ? (a.$maxPixelHeight = l - 2 * this.$borderSize,
                          s.style.top = "", s.style.bottom = o - l + "px",
                          n.isTopdown = !1)
                       : (l += t, a.$maxPixelHeight = o - l - .2 * t,
                          s.style.top = l + "px", s.style.bottom = "",
                          n.isTopdown = !0),
                       s.style.display = "";
                     var h = e.left;
                     h + s.offsetWidth > u && (h = u - s.offsetWidth),
                       s.style.left = h + "px", this._signal("show"), i = null,
                       n.isOpen = !0
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var r = e("./keyboard/hash_handler").HashHandler,
          i = e("./autocomplete/popup").AcePopup, s = e("./autocomplete/util"),
          o = e("./lib/event"), u = e("./lib/lang"), a = e("./lib/dom"),
          f = e("./snippets").snippetManager, l = function() {
            this.autoInsert = !1, this.autoSelect = !0, this.exactMatch = !1,
            this.gatherCompletionsId = 0, this.keyboardHandler = new r,
      ...
      (function() {
        this.$init =
          ...
          return this.popup = new i(document.body || document.documentElement),
                 ...
                 this.popup.on("changeHoverMarker",
        ...
        this.openPopup =
          ...
          if (!n) {
            ...
            s.top += o.top - r.layerConfig.offset,
              s.left += o.left - e.renderer.scrollLeft, s.left += r.gutterWidth,
              this.popup.show(s, i)
          } else
            n && !t && this.detach()
        },
        this.detach =
          ...
          this.editor.keyBinding.removeKeyboardHandler(this.keyboardHandler),
            ...
            this.base && this.base.detach(), this.activated = !1,
        ...
        this.blurListener =
          ...
          var t = document.activeElement,
              ...
              r = e.relatedTarget && this.tooltipNode &&
        ...
        this.insertMatch =
          ...
          if (e.completer && e.completer.insertMatch)
            ...
            e.snippet ? f.insertSnippet(this.editor, e.snippet)
        ...
        this.gatherCompletions = function(e, t) {
          ...
          this.editor && this.detach(),
            this.activated = !0, this.editor = e,
            e.completer != this &&
          ...
          t.style.bottom = n.container.style.bottom, t.style.display = "block",
          window.innerWidth - r.right < 320
            ? r.left < 320 ? n.isTopdown
                               ? (t.style.top = r.bottom + "px",
                                  t.style.left = r.left + "px",
                                  t.style.right = "", t.style.bottom = "")
                               : (t.style.top = n.container.offsetTop -
                                                t.offsetHeight + "px",
                                  t.style.left = r.left + "px",
                                  t.style.right = "", t.style.bottom = "")
          ...
          !this.editor.isFocused() && document.activeElement == e &&
            this.editor.focus(),
            this.tooltipNode = null, e.parentNode && e.parentNode.removeChild(e)
      ...
      (function() {
        this.setFilter = function(e) {
          if (e.length > this.filterText &&
            ...
            var t = this.all;
          this.filterText = e, t = this.filterCompletions(t, this.filterText),
  ...
  ace.define("ace/autocomplete/text_completer",
             ...
             function(e, t, n) {
               ...
               function o(e, t) {
                 var n = s(e, t), r = e.getValue().split(i),
                     o = Object.create(null), u = r[n];
               ...
               t.getCompletions = function(e, t, n, r, i) {
                 ...
                 i(null, u.map(function(e) {
                   return {
                     caption: e, value: e, score: s[e], meta: "local"
                   }
                 }))
               }
             }),
