ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define("ace/mode/drools_highlight_rules",
             [
               "require", "exports", "module", "ace/lib/oop",
               "ace/mode/text_highlight_rules", "ace/mode/java_highlight_rules",
                   ...
                   this.$rules = {
                     start: [].concat(
                       ...
                       [
                         ...
                         {
                           token: [
                             "keyword", "text", "entity.name.type", "text",
                             "variable"
                           ],
  ...
  ace.define("ace/mode/folding/drools",
             [
               ...
               "ace/mode/folding/fold_mode", "ace/token_iterator"
             ],
             function(e, t, n) {
               "use strict";
                   ...
                   if (s) {
                     ...
                     if (s[1]) {
                       var a = { row: n, column: r.length },
                           f = new o(e, a.row, a.column), l = "end",
                           c = f.getCurrentToken();
                       c.value == "when" && (l = "then");
                       while (c) {
                         if (c.value == l)
  ...
  ace.define("ace/mode/drools",
             [
               ...
               "ace/mode/drools_highlight_rules", "ace/mode/folding/drools"
             ],
             function(e, t, n) {
               "use strict";
