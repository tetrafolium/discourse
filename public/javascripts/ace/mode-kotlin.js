ace.define(
      ...
      i = e("./text_highlight_rules").TextHighlightRules, s = function() {
        this.$rules = {
          ...
          "#expressions": [
            ...
            { include: "#types" }, { include: "#strings" },
            { include: "#constants" }, { include: "#comments" },
            { include: "#keywords" }
          ],
          "#functions": [{
            token: "text",
          ...
          "#types": [
            ...
            },
            {
              ...
              push: [
                { token: "text", regex: />/, next: "pop" },
                { include: "#types" }, { include: "#keywords" }
              ]
            },
            {
              token: "text",
  ...
  ace.define("ace/mode/kotlin",
             [
               ...
               "ace/mode/kotlin_highlight_rules", "ace/mode/behaviour/cstyle",
