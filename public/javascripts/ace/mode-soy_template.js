ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var
        r = e("../lib/oop"),
        i = e("./html_highlight_rules").HtmlHighlightRules, s = function() {
          i.call(this);
          var e = {
            start: [
              { include: "#template" }, { include: "#if" },
              { include: "#comment-line" }, { include: "#comment-block" },
              { include: "#comment-doc" }, { include: "#call" },
              { include: "#css" }, { include: "#param" }, { include: "#print" },
              { include: "#msg" }, { include: "#for" }, { include: "#foreach" },
              { include: "#switch" }, { include: "#tag" },
              { include: "text.html.basic" }
            ],
            "#call": [{
              token:
                ["punctuation.definition.tag.begin.soy", "meta.tag.call.soy"],
              ...
              push: [
                ...
                {
                  token: [
                    "entity.other.attribute-name.soy", "text",
            ...
            "#template": [{
              ...
              push: [
                ...
                },
                {
                  token: [
                    "entity.other.attribute-name.soy", "text",
                    "keyword.operator.soy", "text", "string.quoted.double.soy"
                  ],
                ...
                },
                {
                  token: [
                    "entity.other.attribute-name.soy", "text",
                    "keyword.operator.soy", "text", "string.quoted.single.soy"
                  ],
                  regex: "\\b(private)(\\s*)(=)(\\s*)('true'|'false')"
                },
                {
          ...
          for (var t in e)
            this.$rules[t] ? this.$rules[t].unshift.apply(this.$rules[t], e[t])
                           : this.$rules[t] = e[t];
          this.normalizeRules()
        };
      s.metaData = {
