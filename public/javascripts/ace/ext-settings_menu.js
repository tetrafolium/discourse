ace.define(
  ...
  function(e, t, n) {
    ...
    r.importCssString(i), n.exports.overlayPage = function(t, n, i, s, o, u) {
      ...
      i = i ? "top: " + i + ";" : "", o = o ? "bottom: " + o + ";" : "",
      s = s ? "right: " + s + ";" : "", u = u ? "left: " + u + ";" : "";
      ...
      a.addEventListener("click",
                         function() {
                           document.removeEventListener("keydown", l),
                             a.parentNode.removeChild(a), t.focus(), a = null
                         }),
      document.addEventListener("keydown", l), f.style.cssText = i + s + o + u,
      ...
      c.appendChild(h), f.appendChild(c), f.appendChild(n), a.appendChild(f),
      document.body.appendChild(a), t.blur()
    }
  }),
  ace.define(
    "ace/ext/modelist", ["require", "exports", "module"],
    function(e, t, n) {
      "use strict";
      function i(e) {
      ...
      var r = [], s = function(e, t, n) {
        this.name = e, this.caption = t, this.mode = "ace/mode/" + e,
        this.extensions = n;
        var r;
      ...
      var o = {
        ...
        Django: ["html"]
          ...
          a = {};
      for (var f in o) {
        var l = o[f], c = (u[f] || f).replace(/_/g, " "), h = f.toLowerCase(),
            p = new s(h, c, l[0]);
        a[h] = p, r.push(p)
      }
  ...
  ace.define(
    ...
    [
      ...
      "ace/lib/dom", "ace/lib/oop", "ace/lib/event_emitter", "ace/ext/modelist",
      "ace/ext/themelist"
    ],
    function(e, t, n) {
      "use strict";
      var r = e("./menu_tools/overlay_page").overlayPage, i = e("../lib/dom"),
          s = e("../lib/oop"), o = e("../lib/event_emitter").EventEmitter,
          u = i.buildDom, a = e("./modelist"), f = e("./themelist"),
          l = { Bright: [], Dark: [] };
      f.themes.forEach(function(e) {
        l[e.isDark ? "Dark" : "Bright"].push(
          { caption: e.caption, value: e.theme })
      });
      var
        c = a.modes.map(function(e) {
          return {
            caption: e.caption, value: e.mode
          }
        }),
        h = {
          Main: {
            ...
            Overscroll: {
              ...
              path: "scrollPastEnd",
              items: [
                { caption: "None", value: 0 }, { caption: "Half", value: .5 },
        ...
        p = function(e, t) {
          this.editor = e, this.container = t || document.createElement("div"),
      ...
      (function() {
        s.implement(this, o), this.add = function(e) {
          ...
          return Object.keys(e)
            .map(function(t, n) {
              var r = e[t];
              return r.position || (r.position = n / 1e4),
                     r.label || (r.label = t), r
            })
            .sort(function(e, t) {
          ...
          return [
            ...
            ["td", ["label", { "for": n }, e]], ["td", r]
          ]
        }, this.setOption = function(e, t) {
          typeof e == "string" && (e = this.options[e]),
            t == "false" && (t = !1), t == "true" && (t = !0),
            t == "null" && (t = null), t == "undefined" && (t = undefined),
            typeof t == "string" && parseFloat(t).toString() == t &&
              (t = parseFloat(t)),
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/ext/options",
      "ace/ext/menu_tools/overlay_page", "ace/editor"
    ],
    function(e, t, n) {
      "use strict";
      function s(e) {
