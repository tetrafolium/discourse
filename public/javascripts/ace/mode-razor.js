ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
      "ace/mode/doc_comment_highlight_rules", "ace/mode/html_highlight_rules",
      "ace/mode/csharp_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
            ...
            this.$rules.start.unshift(
              {
                ...
                onMatch: function(e, n, r) {
                  ...
                  return r.unshift(e), r.unshift(i + t), this.next = i + t,
                                                         "paren.lparen"
                }
              },
            ...
            this.$rules[t].unshift({
              ...
              onMatch: function(t, r, i) {
                ...
                return n[s] !== t
                         ? "invalid.illegal"
                         : (i.shift(), i.shift(),
                            this.next = e(t, i[0]) || "start", "paren.rparen")
              }
            })
          };
      r.inherits(f, u);
      var l = function() {
        ...
        var e = {
          regex: "@[({]|@functions{",
          onMatch: function(e, t, n) {
            return n.unshift(e), n.unshift("razor-block-start"),
                   this.next = "razor-block-start", "punctuation.block.razor"
          }
        },
            t = { "@{": "}", "@(": ")", "@functions{": "}" }, n = {
              regex: "[})]",
            ...
            r = {
              regex: "@(?![{(])",
              onMatch: function(e, t, n) {
                return n.unshift("razor-short-start"),
    ...
    function(e, t, n) {
      ...
      (function() {
        this.getCompletions = function(e, t, n, r) {
          ...
          return s.map(function(e) {
            return {
              value: e, meta: "keyword", score: 1e6
            }
          })
  ...
  ace.define("ace/mode/razor",
             [
               ...
               "ace/mode/razor_highlight_rules", "ace/mode/razor_completions",
               "ace/mode/html_completions"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./html").Mode,
                   ...
                   u = e("./html_completions").HtmlCompletions, a = function() {
                     i.call(this), this.$highlightRules = new s,
