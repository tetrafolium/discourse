...
!function(e) {
    ...
    .define("ace/mode/css/csslint", [],
            function(require, exports, module) {
              ...
              function clone(e, t, n, r) {
                ...
                return typeof t == "undefined" && (t = !0),
                       typeof n == "undefined" && (n = Infinity), u(e, n)
              }
              ...
              (function() {
                ...
                function i(e, n) {
                  ...
                  this._token = null, this._tokenData = n, this._lt = [],
                ...
                t.prototype = {
                  ...
                  readTo: function(e) {
                    ...
                    while (t.length < e.length ||
                      ...
                      n = this.read();
                      if (!n)
                        throw new Error('Expected "' + e + '" at line ' +
                ...
                i.prototype = {
                  ...
                  mustMatch: function(e, t) {
                    ...
                    if (!this.match.apply(this, arguments))
                      throw r = this.LT(1),
                            new n("Expected " + this._tokenData[e[0]].name +
                                    " at line " + r.startLine + ", col " +
                                    r.startCol + ".",
                    ...
                    return u = this._getToken(),
                           u.type > -1 && !t[u.type].hide &&
                             (u.channel = t[u.type].channel, this._token = u,
                              this._lt.push(u),
                              this._ltIndexCache.push(this._lt.length -
                                                      this._ltIndex + i),
                ...
                function() {
                  ...
                  function MediaQuery(e, t, n, r, i) {
                    SyntaxUnit.call(this,
                                    (e ? e + " " : "") + (t ? t : "") +
                                      (t && n.length > 0 ? " and " : "") +
                                      n.join(" and "),
                                    r, i, Parser.MEDIA_QUERY_TYPE),
                      this.modifier = e, this.mediaType = t, this.features = n
                  }
                  function Parser(e) {
                    EventTarget.call(this), this.options = e || {},
                  ...
                  function PropertyValue(e, t, n) {
                    SyntaxUnit.call(this, e.join(" "), t, n,
                                    Parser.PROPERTY_VALUE_TYPE),
                      this.parts = e
                  }
                  function PropertyValueIterator(e) {
                    this._i = 0, this._parts = e.parts, this._marks = [],
                    this.value = e
                  }
                  function PropertyValuePart(text, line, col) {
                    ...
                    if (/^([+\-]?[\d\.]+)([a-z]+)$/i.test(text)) {
                      this.type = "dimension", this.value = +RegExp.$1,
                      this.units = RegExp.$2;
                                    ...
                                    ? (this.type = "color", temp = RegExp.$1,
                                       temp.length == 3
                                         ...
                                         : (this.red = parseInt(
                                            ...
                                            this.green = parseInt(
                                              temp.substring(2, 4), 16),
                                            this.blue = parseInt(
                                              temp.substring(4, 6), 16)))
                  ...
                  function SelectorSubPart(e, t, n, r) {
                    SyntaxUnit.call(this, e, n, r,
                                    Parser.SELECTOR_SUB_PART_TYPE),
                      this.type = t, this.args = []
                  }
                  ...
                  Combinator
                    .prototype = new SyntaxUnit,
          Combinator.prototype.constructor = Combinator,
          MediaFeature.prototype = new SyntaxUnit,
          MediaFeature.prototype.constructor = MediaFeature,
          MediaQuery.prototype = new SyntaxUnit,
          MediaQuery.prototype.constructor = MediaQuery,
          Parser.DEFAULT_TYPE = 0, Parser.COMBINATOR_TYPE = 1,
          Parser.MEDIA_FEATURE_TYPE = 2, Parser.MEDIA_QUERY_TYPE = 3,
          Parser.PROPERTY_NAME_TYPE = 4, Parser.PROPERTY_VALUE_TYPE = 5,
          Parser.PROPERTY_VALUE_PART_TYPE = 6, Parser.SELECTOR_TYPE = 7,
          Parser.SELECTOR_PART_TYPE = 8, Parser.SELECTOR_SUB_PART_TYPE = 9,
          Parser.prototype = function() {
            var e = new EventTarget, t, n = {
              ...
              _stylesheet: function() {
                ...
                this.fire("startstylesheet"), this._charset(),
                  this._skipCruft();
              ...
              _namespace: function(e) {
                ...
                t.mustMatch(Tokens.NAMESPACE_SYM),
                  ...
                  e !== !1 &&
                    this.fire(
                      { type: "namespace", prefix: i, uri: s, line: n, col: r })
              },
              _media: function() {
              ...
              _media_expression: function() {
                ...
                return e.mustMatch(Tokens.LPAREN), this._readWhitespace(),
                       t = this._media_feature(), this._readWhitespace(),
                       e.match(Tokens.COLON) &&
                         (this._readWhitespace(), n = e.LT(1),
                          r = this._expression()),
              ...
              _unary_operator: function() {
                var e = this._tokenStream;
                return e.match([Tokens.MINUS, Tokens.PLUS]) ? e.token().value
                                                            : null
              },
              _property: function() {
              ...
              _class: function() {
                ...
                return e.match(Tokens.DOT)
                         ? (e.mustMatch(Tokens.IDENT), t = e.token(),
                            new SelectorSubPart("." + t.value, "class",
                                                t.startLine, t.startCol - 1))
                         : null
              },
              _element_name: function() {
                ...
                return e.match(Tokens.IDENT)
                         ? (t = e.token(),
                            new SelectorSubPart(t.value, "elementName",
              ...
              _attrib: function() {
                ...
                return e.match(Tokens.LBRACKET)
                         ? (r = e.token(), t = r.value,
                            ...
                            new SelectorSubPart(t + "]", "attribute",
                                                r.startLine, r.startCol))
                         : null
              },
              _pseudo: function() {
                ...
                return e.match(Tokens.COLON) &&
                         (e.match(Tokens.COLON) && (n += ":"),
                          ...
                          t &&
                            (t = new SelectorSubPart(n + t, "pseudo", r, i))),
                       t
              },
              ...
              _declaration: function() {
                var e = this._tokenStream, t = null, n = null, r = null,
                    i = null, s = null, o = "";
                t = this._property();
                if (t !== null) {
              ...
              _expr: function(e) {
                ...
                return n.length > 0 ? new PropertyValue(n, n[0].line, n[0].col)
                                    : null
              },
              _term: function(e) {
                var t = this._tokenStream, n = null, r = null, i = null, s, o,
                    u;
                return n = this._unary_operator(),
                       ...
                       t.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                         ...
                         : e && t.match([
                             ...
                             ? (s = t.token(), i = s.endChar,
                                r = s.value + this._expr(e).text,
                                n === null && (o = t.token().startLine,
                                               u = t.token().startCol),
                                t.mustMatch(Tokens.type(i)), r += i,
                                this._readWhitespace())
                             : t.match([
              ...
              _function: function() {
                ...
                if (e.match(Tokens.FUNCTION)) {
                  t = e.token().value, this._readWhitespace(),
                  n = this._expr(!0), t += n;
                  if (this.options.ieFilters && e.peek() == Tokens.EQUALS) do {
                      this._readWhitespace() && (t += e.token().value),
                        ...
                        e.match(Tokens.EQUALS), t += e.token().value,
                        r = e.peek();
                      while (r != Tokens.COMMA && r != Tokens.S &&
                             r != Tokens.RPAREN)
              ...
              _keyframes: function() {
                ...
                e.mustMatch(Tokens.KEYFRAMES_SYM),
                  ...
                  this._readWhitespace(), e.mustMatch(Tokens.LBRACE),
                  this.fire({
                    type: "startkeyframes",
                    name: r,
                    prefix: i,
              ...
              _key_list: function() {
                ...
                while (e.match(Tokens.COMMA))
                  this._readWhitespace(), r.push(this._key()),
                    this._readWhitespace();
                return r
              },
              _key: function() {
              ...
              _unexpectedToken: function(e) {
                throw new SyntaxError("Unexpected token '" + e.value +
                                        "' at line " + e.startLine + ", col " +
                                        e.startCol + ".",
            ...
            return e
                  ...
                  var
                    Properties = {
                      ...
                      azimuth: function(e) {
                        var
                          t = "<angle> | leftwards | rightwards | inherit",
                          n =
                      ...
                      "border-image": 1,
                      "border-image-outset":
                        { multi: "<length> | <number>", max: 4 },
                      "border-image-repeat":
                        { multi: "stretch | repeat | round", max: 2 },
                      "border-image-slice": function(e) {
                        var t = !1, n = "<number> | <percentage>", r = !1,
                            i = 0, s = 4, o;
                  ...
                  PropertyValueIterator.prototype.peek =
                    function(e) {
                    return this.hasNext() ? this._parts[this._i + (e || 0)]
                                          : null
                  },
                  ...
                  PropertyValuePart.fromToken = function(e) {
                    return new PropertyValuePart(e.value, e.startLine,
                                                 e.startCol)
                  };
                  var Pseudos = {
                    ":first-letter": 1,
                  ...
                  Specificity.calculate = function(e) {
                    function u(e) {
                      var t, n, r, a,
                        f = e.elementName ? e.elementName.text : "", l;
                  ...
                  TokenStream.prototype = mix(new TokenStreamBase, {
                    _getToken: function(e) {
                      var t, n = this._reader, r = null, i = n.getLine(),
                             s = n.getCol();
                      t = n.read();
                      while (t) {
                        switch (t) {
                    ...
                    createToken: function(e, t, n, r, i) {
                      var s = this._reader;
                      return i = i || {}, {
                        value: t, type: e, channel: i.channel,
                          endChar: i.endChar, hide: i.hide || !1, startLine: n,
                          startCol: r, endLine: s.getLine(), endCol: s.getCol()
                      }
                    },
                    atRuleToken: function(e, t, n) {
                      var r = e, i = this._reader, s = Tokens.CHAR, o = !1, u,
                          a;
                      i.mark(), u = this.readName(), r = e + u,
                    ...
                    numberToken: function(e, t, n) {
                      var r = this._reader, i = this.readNumber(e), s,
                          o = Tokens.NUMBER, u = r.peek();
                    ...
                    stringToken: function(e, t, n) {
                      var r = e, i = e, s = this._reader, o = e,
                          u = Tokens.STRING, a = s.read();
                      while (a) {
                        i += a;
                        if (a == r && o != "\\") break;
                    ...
                    readString: function() {
                      var e = this._reader, t = e.read(), n = t, r = t,
                          i = e.peek();
                      while (i) {
                        i = e.read(), n += i;
                        if (i == t && r != "\\") break;
                    ...
                    readURI: function(e) {
                      ...
                      while (i && isWhitespace(i))
                        t.read(), i = t.peek();
                      i == "'" || i == '"' ? r = this.readString()
                                           : r = this.readURL(),
                                             i = t.peek();
                      while (i && isWhitespace(i))
                        t.read(), i = t.peek();
                      return r === "" || i != ")" ? (n = e, t.reset())
                                                  : n += r + t.read(),
                             n
                    },
                    readURL: function() {
                    ...
                    readEscape: function(e) {
                      ...
                      return n.length == 3 && /\s/.test(i) || n.length == 7 ||
                                 n.length == 1
                               ? t.read()
                               : i = "",
                                 n + i
                  ...
                  var Validation = {
                    validate: function(e, t) {
                      var n = e.toString().toLowerCase(), r = t.parts,
                          i = new PropertyValueIterator(t), s = Properties[n],
                          o, u, a, f, l, c, h, p, d, v, m;
                      if (!s) {
                        if (n.indexOf("-") !== 0)
                          throw new ValidationError(
                            "Unknown property '" + e + "'.", e.line, e.col)
                      } else
                        typeof s != "number" &&
                          (typeof s == "string"
                             ? s.indexOf("||") > -1
                    ...
                    groupProperty: function(e, t, n) {
                      var r = !1, i = t.value, s = e.split("||").length,
                          o = { count: 0 }, u = !1, a, f;
                      while (t.hasNext() && !r) {
                  ...
                  var ValidationTypes = {
                    ...
                    simple: {
                      ...
                      "<attachment>": function(e) {
                        return ValidationTypes.isLiteral(
                          e, "scroll | fixed | local")
                      },
                      "<attr>": function(e) {
                        return e.type == "function" && e.name == "attr"
                      },
                      "<bg-image>": function(e) {
                        return this["<image>"](e) || this["<gradient>"](e) ||
                               e == "none"
                      },
                      "<gradient>": function(e) {
                      ...
                      "<box>": function(e) {
                        return ValidationTypes.isLiteral(
                          e, "padding-box | border-box | content-box")
                      },
                      "<content>": function(e) {
                      ...
                      "<flex-direction>": function(e) {
                        return ValidationTypes.isLiteral(
                          e, "row | row-reverse | column | column-reverse")
                      },
                    ...
                    complex: {
                      "<bg-position>": function(e) {
                        ...
                        while (e.peek(o) && e.peek(o) != ",")
                          o++;
                        return o < 3
                                 ? ValidationTypes.isAny(e,
                                                         i + " | center | " + r)
                                     ? (n = !0, ValidationTypes.isAny(
                                                  e, s + " | center | " + r))
                      ...
                      "<bg-size>": function(e) {
                        var t = this, n = !1,
                            r = "<percentage> | <length> | auto", i, s, o;
                      ...
                      "<x-one-radius>": function(e) {
                        var t = !1, n = "<length> | <percentage> | inherit";
                        return ValidationTypes.isAny(e, n) &&
                          ...
                          : ValidationTypes.isType(e, "<flex-grow>")
                              ? e.peek()
                                  ? ValidationTypes.isType(e, "<flex-shrink>")
                                      ? e.peek() ? n = ValidationTypes.isType(
                                                     e, "<flex-basis>")
                                                 : n = !0
              ...
              var CSSLint = function() {
                ...
                return r.version = "@VERSION@", r.addRule = function(t) {
                  ...
                  o = new Reporter(u, r), r.errors = 2;
                  for (s in r)
                    r.hasOwnProperty(s) && r[s] && e[s] && e[s].init(f, o);
                  try {
                    f.parse(t)
                  } catch (l) {
                    o.error("Fatal error, cannot continue: " + l.message,
                            l.line, l.col, {})
                  }
                  return a = {
                    messages: o.messages,
              ...
              Reporter
                ...
                rollupError: function(e, t) {
                  this.messages.push(
                    { type: "error", rollup: !0, message: e, rule: t })
                },
                rollupWarn: function(e, t) {
                  this.messages.push(
                    { type: "warning", rollup: !0, message: e, rule: t })
                },
                stat: function(e, t) {
                  this.stats[e] = t
                }
                ...
                for (l = 0; l < s.parts.length; l++) {
                  ...
                  if (o.type === e.SELECTOR_PART_TYPE) {
                    ...
                    for (c = 0; c < o.modifiers.length; c++)
                      ...
                      a > 1 && t.report("Don't use adjoining classes.", o.line,
                                        o.col, n)
                  }
                }
              }
          ...
          init: function(e, t) {
            ...
            function a() {
              ...
              if (!o) {
                if (s.height)
                  for (e in i)
                    i.hasOwnProperty(e) && s[e] &&
                      (u = s[e].value,
                       (e !== "padding" || u.parts.length !== 2 ||
                        u.parts[0].value !== 0) &&
                         t.report(
                           "Using height with " + e +
            ...
            var n = this, r = {
              ...
              "padding-right": 1
                ...
                s, o = !1;
            e.addListener("startrule", u), e.addListener("startfontface", u),
              ...
              e.addListener("endpage", a), e.addListener("endpagemargin", a),
                  ...
                  if (c.length > h.length)
                    for (s = 0, o = c.length; s < o; s++)
                      ...
                      CSSLint.Util.indexOf(h, p) === -1 &&
                        (d = h.length === 1 ? h[0]
                                            : h.length === 2 ? h.join(" and ")
                                                             : h.join(", "),
                         t.report("The property " + p + " is compatible with " +
                                    d + " and should be included as well.",
                                  l.actualNodes[0].line, l.actualNodes[0].col,
                                  n))
                }
            })
          }
          ...
          init: function(e, t) {
            function s(e, s, o) {
              i[e] &&
                ...
                t.report(o || e + " can't be used with display: " + s + ".",
                         i[e].line, i[e].col, n)
            }
            function o() {
              i = {}
            ...
            function u() {
              ...
              if (e) switch (e) {
                case "inline":
                  s("height", e), s("width", e), s("margin", e),
                    s("margin-top", e), s("margin-bottom", e),
                    s("float", e,
                ...
                default:
                  e.indexOf("table-") === 0 &&
                    (s("margin", e), s("margin-left", e), s("margin-right", e),
                     s("margin-top", e), s("margin-bottom", e), s("float", e))
                }
            }
            var n = this, r = {
              display: 1,
              ...
              "vertical-align": 1
                ...
                i;
            e.addListener("startrule", o), e.addListener("startfontface", o),
              ...
              e.addListener("endpagemargin", u), e.addListener("endpage", u)
          }
        }),
        CSSLint.addRule({
        ...
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            var n = this, r, i;
            e.addListener("startrule", s), e.addListener("startfontface", s),
              ...
              e.addListener("property", function(e) {
                ...
                r[o] && (i !== o || r[o] === e.value.text) &&
                  t.report("Duplicate property '" + e.property + "' found.",
                           e.line, e.col, n),
                  r[o] = e.value.text, i = o
              })
          }
        }),
        CSSLint.addRule({
        ...
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            e.addListener("startrule", o), e.addListener("startfontface", o),
              ...
              e.addListener("startkeyframerule", o),
              e.addListener("property", function(e) {
                var s = e.property, o = s.text.toLowerCase(), u = e.value.parts,
                    a = 0, f = "", l = u.length;
                if (i[o])
                  while (a < l)
                    u[a].type === "color" &&
                      ("alpha" in u[a] || "hue" in u[a]
                         ? (/([^\)]+)\(/.test(u[a]) &&
                            ...
                            (!r || r.property.text.toLowerCase() !== o ||
                             r.colorType !== "compat") &&
                              t.report("Fallback " + o +
                                         " (hex or RGB) should precede " + f +
                                         " " + o + ".",
                                       e.line, e.col, n))
                         : e.colorType = "compat"),
                      a++;
        ...
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            e.addListener("property", function(e) {
              ...
              t.stat("font-sizes", r),
                r >= 10 && t.rollupWarn("Too many font-size declarations (" +
                                          r + "), abstraction needed.",
                                        n)
            })
          }
        }),
            ...
            e.addListener("startrule", function(r) {
              ...
              for (f = 0; f < i.length; f++) {
                ...
                a === 1
                  ...
                  : a > 1 && t.report(a + " IDs in the selector, really?",
                                      s.line, s.col, n)
              }
            })
          }
        ...
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            e.addListener("startrule", i), e.addListener("startfontface", i),
            ...
            e.addListener("startrule", i), e.addListener("startfontface", i),
              ...
              e.addListener("property",
                            function(e) {
                              var t = e.property.text.toLowerCase(),
                                  n = e.value;
                              r && (r.propCount++, t === "outline" &&
                                                     (n.toString() === "none" ||
                                                      n.toString() === "0") &&
                                                     (r.outline = !0))
                            }),
              e.addListener("endrule", s), e.addListener("endfontface", s),
              e.addListener("endpage", s), e.addListener("endpagemargin", s),
            ...
            e.addListener("startrule", function(r) {
              ...
              for (u = 0; u < i.length; u++) {
                ...
                for (a = 0; a < s.parts.length; a++)
                  o = s.parts[a],
                  o.type === e.SELECTOR_PART_TYPE && o.elementName &&
                    /h[1-6]/.test(o.elementName.toString()) && a > 0 &&
                ...
                for (f = 0; f < s.parts.length; f++) {
                  ...
                  if (o.type === e.SELECTOR_PART_TYPE)
                    for (l = 0; l < o.modifiers.length; l++)
                      u = o.modifiers[l],
                      u.type === "attribute" && /([\~\|\^\$\*]=)/.test(u) &&
                        t.report("Attribute selectors with " + RegExp.$1 +
                                   " are slow!",
                                 u.line, u.col, n)
                }
              }
            ...
            function r(e) {
              ...
              for (r = 0, i = d.length; r < i; r++) {
                ...
                for (o = 0, a = s.parts.length; o < a; o++)
                  for (u = o + 1; u < a; u++)
                    f = s.parts[o], l = s.parts[u], c = f.type, h = f.line,
                    p = l.line,
                    c === "descendant" && p > h &&
                      t.report(
          ...
          init: function(e, t) {
              ...
              for (r in a)
                if (a.hasOwnProperty(r)) {
                  ...
                  for (i = 0, s = a[r].length; i < s; i++)
                    o += u[a[r][i]] ? 1 : 0;
                  o === a[r].length &&
                    t.report("The properties " + a[r].join(", ") +
            ...
            for (r in a)
              if (a.hasOwnProperty(r))
                for (i = 0, s = a[r].length; i < s; i++)
                  o[a[r][i]] = r;
            e.addListener("startrule", f), e.addListener("startfontface", f),
              e.addListener("property", function(e) {
                var t = e.property.toString().toLowerCase();
                o[t] && (u[t] = 1)
        ...
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            e.addListener("property", function(e) {
              var r = e.property;
              r.hack === "_" &&
                t.report("Property with underscore prefix found.",
                         e.property.line, e.property.col, n)
            })
          }
        }),
        CSSLint.addRule({
          ...
          init: function(e, t) {
            ...
            e.addListener("startrule", function(e) {
              ...
              i.length && t.rollupWarn("You have " + i.join(", ") +
          ...
          init: function(e, t) {
            ...
            e.addListener("startrule", function(e) {
              ...
              for (o = 0; o < r.length; o++)
                i = r[o], s = i.parts[i.parts.length - 1],
          ...
          init: function(e, t) {
            ...
            function u() {
              ...
              for (i = 0, o = f.length; i < o; i++)
                u = f[i].needed, a = f[i].actual,
                r[u] ? r[u][0].pos < r[a][0].pos &&
                         t.report(
                           "Standard property '" + u +
                             "' should come after vendor-prefixed property '" +
                             a + "'.",
                           r[a][0].name.line, r[a][0].name.col, n)
                     : t.report("Missing standard property '" + u +
                                  "' to go along with '" + a + "'.",
                                r[a][0].name.line, r[a][0].name.col, n)
            }
            var n = this, r, i, s = {
            ...
            e.addListener("startrule", o), e.addListener("startfontface", o),
              ...
              e.addListener("endrule", u), e.addListener("endfontface", u),
              e.addListener("endpage", u), e.addListener("endpagemargin", u),
              e.addListener("endkeyframerule", u)
          }
        }),
        CSSLint.addRule({
            ...
            e.addListener("property", function(e) {
              ...
              while (i < s)
                (r[i].units || r[i].type === "percentage") &&
                  r[i].value === 0 && r[i].type !== "time" &&
                  t.report("Values of 0 shouldn't have units specified.",
                           r[i].line, r[i].col, n),
                  i++
            })
          }
              ...
              return r.length > 0 &&
                       (i.push('<file name="' + n + '">'),
                        CSSLint.Util.forEach(
                          ...
                          function(t) {
                            t.rollup ||
                              i.push('<error line="' + t.line + '" column="' +
                                     t.col + '" severity="' + t.type + '"' +
                                     ' message="' + e(t.message) +
                                     '" source="' + s(t.rule) + '"/>')
                          }),
                        i.push("</file>")),
            ...
            return n.length > 0 &&
                     (r.push('<file name="' + t + '">'),
                      CSSLint.Util.forEach(
                        ...
                        function(e) {
                          e.rollup
                            ? r.push('<issue severity="' + e.type +
                                     '" reason="' + i(e.message) +
                                     '" evidence="' + i(e.evidence) + '"/>')
                            : r.push('<issue line="' + e.line + '" char="' +
                                     e.col + '" severity="' + e.type + '"' +
                                     ' reason="' + i(e.message) +
                                     '" evidence="' + i(e.evidence) + '"/>')
                        }),
                      r.push("</file>")),
        ...
        CSSLint.addFormatter({
          ...
          formatResults: function(e, t) {
            var n = e.messages, r = [], i = { error: 0, failure: 0 },
                s = function(e) {
                  return !!e && "name" in e
                           ? "net.csslint." + e.name.replace(/\s/g, "")
                           : ""
                     ...
                     (n.forEach(function(e) {
                       ...
                       e.rollup ||
                         (r.push('<testcase time="0" name="' + s(e.rule) +
                                 '">'),
                          r.push("<" + t + ' message="' + o(e.message) +
                                 '"><![CDATA[' + e.line + ":" + e.col + ":" +
                                 o(e.evidence) + "]]></" + t + ">"),
                          r.push("</testcase>"), i[t] += 1)
                     }),
                      r.unshift('<testsuite time="0" tests="' + n.length +
                                '" skipped="0" errors="' + i.error +
                                '" failures="' + i.failure +
                                '" package="net.csslint" name="' + t + '">'),
                      r.push("</testsuite>")),
                   r.join("")
          }
        }),
  ...
  ace.define("ace/mode/css_worker", [], function(e, t, n) {
    ...
    var
      r = e("../lib/oop"),
      i = e("../lib/lang"), s = e("../worker/mirror").Mirror,
        ...
        this.sender.emit("annotate", n.messages.map(function(e) {
          return {
            row: e.line - 1, column: e.col - 1, text: e.message,
              type: t[e.rule.id] ? "info" : e.type, rule: e.rule.name
          }
        }))
      }
    }.call(u.prototype)
