ace.define(
  "ace/keyboard/vim",
  [
    "require", "exports", "module", "ace/range", "ace/lib/event_emitter",
    "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search",
    "ace/lib/useragent", "ace/search_highlight",
  ...
  function(e, t, n) {
    ...
    function x(e) {
      e.setOption("disableInput", !0),
        ...
        e.on("cursorActivity", Gn), tt(e),
        v.on(e.getInputField(), "paste", M(e))
    }
    function T(e) {
      e.setOption("disableInput", !1), e.off("cursorActivity", Gn),
        v.off(e.getInputField(), "paste", M(e)), e.state.vim = null
    }
    function N(e, t) {
    ...
    function et() {
      this.latestRegister = undefined, this.isPlaying = !1,
      this.isRecording = !1, this.replaySearchQueries = [],
    ...
    function rt() {
      nt = {
        ...
        lastCharacterSearch:
          { increment: 0, forward: !0, selectedCharacter: "" },
    ...
    function ot() {
      this.prefixRepeat = [], this.motionRepeat = [], this.operator = null,
      this.operatorArgs = null, this.motion = null, this.motionArgs = null,
      this.keyBuffer = [], this.registerName = null
    }
    function ut(e, t) {
      e.state.vim.inputState = new ot, v.signal(e, "vim-command-done", t)
    }
    function at(e, t, n) {
      this.clear(), this.keyBuffer = [e || ""], this.insertModeChanges = [],
                    this.searchQueries = [], this.linewise = !!t,
                    this.blockwise = !!n
    }
    function ft(e, t) {
    ...
    function lt(e) {
      this.registers = e, this.unnamedRegister = e['"'] = new at,
      e["."] = new at, e[":"] = new at, e["/"] = new at
    }
    function ct() {
    ...
    function St(e, t, n) {
      return typeof t == "object" && (n = t.ch, t = t.line),
             E(e.line + t, e.ch + n)
    }
    function xt(e, t) {
      return {
        line: t.line - e.line, ch: t.line - e.line
      }
    }
    function Tt(e, t, n, r) {
      var i, s = [], o = [];
      for (var u = 0; u < t.length; u++) {
        ...
        if (n == "insert" && a.context != "insert" ||
            a.context && a.context != n || r.operator && a.type == "action" ||
            !(i = Nt(e, a.keys)))
          continue;
        i == "partial" && s.push(a), i == "full" && o.push(a)
      }
      return {
        partial: s.length && s, full: o.length && o
      }
    }
    function Nt(e, t) {
      if (t.slice(-11) == "<character>") {
        var n = t.length - 11, r = e.slice(0, n), i = t.slice(0, n);
        return r == i && e.length > n ? "full"
                                      : i.indexOf(r) == 0 ? "partial" : !1
      }
    ...
    function Mt(e, t) {
      return arguments.length > 2 &&
               (t = Mt.apply(undefined,
                             Array.prototype.slice.call(arguments, 1))),
             Ot(e, t) ? e : t
    }
    function _t(e, t) {
      return arguments.length > 2 &&
               (t = _t.apply(undefined,
                             Array.prototype.slice.call(arguments, 1))),
             Ot(e, t) ? t : e
    }
    function Dt(e, t, n) {
    ...
    function Ft(e, t) {
      var n = [], r = e.listSelections(), i = Lt(e.clipPos(t)), s = !At(t, i),
          o = e.getCursor("head"), u = qt(r, o), a = At(r[u].head, r[u].anchor),
          f = r.length - 1, l = f - u > u ? f : 0, c = r[l].anchor,
          h = Math.min(c.line, i.line), p = Math.max(c.line, i.line), d = c.ch,
          v = i.ch, m = r[l].head.ch - d, g = v - d;
      m > 0 && g <= 0
        ? (d++, s || v--)
        : m < 0 && g >= 0 ? (d--, a || v++) : m < 0 && g == -1 && (d--, v++);
      for (var y = h; y <= p; y++) {
    ...
    function Rt(e, t) {
      var n = t.lastSelection, r = function() {
        var t = e.listSelections(), n = t[0], r = t[t.length - 1],
        ...
        if (i) {
          ...
          var h = n.anchorMark.find(), p = n.headMark.find(),
              d = p.line - h.line, v = p.ch - h.ch;
    ...
    function zt(e, t, n) {
      ...
      return Ot(n, t) && (o = n, n = t, t = o),
             Ot(i, s) ? (i = Mt(t, i), s = _t(s, n))
                      : (s = Mt(t, s), i = _t(i, n), i = St(i, 0, -1),
                         i.ch == -1 && i.line != e.firstLine() &&
    ...
    function Xt(e, t, n, r) {
      ...
      if (n == "block") {
        var f = Math.min(s.line, i.line), l = Math.min(s.ch, i.ch),
            c = Math.max(s.line, i.line), h = Math.max(s.ch, i.ch) + 1,
            p = c - f + 1, d = i.line == f ? 0 : p - 1, v = [];
        for (var m = 0; m < p; m++)
    ...
    function $t(e, t) {
      var n = e.state.vim;
      t !== !1 && e.setCursor(wt(e, n.sel.head)), Ut(e, n),
        n.visualMode = !1, n.visualLine = !1, n.visualBlock = !1,
        v.signal(e, "vim-mode-change", { mode: "normal" }),
    ...
    function Gt(e, t, n, r, i) {
      ...
      return {
        start: E(s.line, l), end: E(s.line, f)
      }
    }
    function Yt(e, t, n) {
    ...
    function nn(e, t, n, r) {
      var i = Lt(e.getCursor()), s = n ? 1 : -1, o = n ? e.lineCount() : -1,
          u = i.ch, a = i.line, f = e.getLine(a), l = {
            lineText: f,
            nextCh: f.charAt(u),
            lastCh: null,
            index: u,
        ...
        while (o != l) {
          ...
          for (var d = 0; d < f.length && !p; ++d)
            if (f[d](u.charAt(o))) {
              ...
              return {
                from: Math.min(c, h + 1), to: Math.max(c, h), line: s
              }
            }
          p || (o += a)
        }
    ...
    function sn(e, t, n, r, i, s) {
      ...
      for (var f = 0; f < n; f++) {
        ...
        if (!l) {
          ...
          u.push(r ? { line: e.lastLine(), from: c, to: c }
                   : { line: 0, from: 0, to: 0 });
          break
        }
    ...
    function fn(e, t, n, r, i) {
      var s;
      return r ? (s = t.indexOf(n, e + 1), s != -1 && !i && (s -= 1))
    ...
    function ln(e, t, n, r, i) {
      ...
      function p(t) {
        ...
        n && t + r > n.start.row && t + r < n.end.row &&
    ...
    function hn(e, t, n, r) {
      var i = Lt(t), s = e.getLine(i.line), o = s.split(""), u, a, f, l,
          c = o.indexOf(n);
    ...
    function wn(e) {
      ...
      for (var s = -1; s < e.length; s++) {
        var o = e.charAt(s) || "", u = e.charAt(s + 1) || "",
            a = u && t.indexOf(u) != -1;
        r ? ((o !== "\\" || !a) && i.push(o), r = !1)
          : o === "\\" ? (r = !0, u && n.indexOf(u) != -1 && (a = !0),
                          (!a || u === "\\") && i.push(o))
                       : (i.push(o), a && u !== "\\" && i.push("\\"))
      }
      return i.join("")
    ...
    function Hn(e) {
      var t = dn(e);
      e.removeOverlay(dn(e).getOverlay()), t.setOverlay(null),
    ...
    function jn(e) {
      ...
      return {
        top: t.getFirstFullyVisibleRow(), bottom: t.getLastFullyVisibleRow()
      }
    }
    function Fn(e, t, n) {
      var r = t.marks[n];
    ...
    function Un(e, t, n, r, i, s, o, u, a) {
      ...
      function p() {
        while (s.findNext() && Bn(s.from(), r, i)) {
          ...
          e.scrollIntoView(s.from(), 30), e.setSelection(s.from(), s.to()),
            l = s.from(), f = !1;
          return
        }
        f = !0
    ...
    function zn(e) {
      var t = e.state.vim, n = nt.macroModeState,
          r = nt.registerController.getRegister("."), i = n.isPlaying,
          s = n.lastInsertModeChanges;
      i || (e.off("change", Qn), v.off(e.getInputField(), "keydown", tr)),
        !i && t.insertModeRepeat > 1 &&
        ...
        e.setOption("keyMap", "vim"), e.setOption("disableInput", !0),
        e.toggleOverwrite(!1), r.setText(s.changes.join("")),
        v.signal(e, "vim-mode-change", { mode: "normal" }),
        n.isRecording && Jn(n)
    }
    function Wn(e) {
    ...
    function Vn(e, t, n, r) {
      ...
      for (var u = 0; u < s.length; u++) {
        ...
        while (a) {
          f = /<\w+-.+?>|<\w+>|./.exec(a), l = f[0],
          a = a.substring(f.index + l.length), v.Vim.handleKey(e, l, "macro");
          if (t.insertMode) {
            var c = i.insertModeChanges[o++].changes;
            nt.macroModeState.lastInsertModeChanges.changes = c, rr(e, c, 1),
            zn(e)
          }
        }
      }
    ...
    function Gn(e) {
      ...
      if (t.insertMode) {
        ...
        r.expectCursorActivityForChange ? r.expectCursorActivityForChange = !1
                                        : r.maybeReset = !0
      } else
        e.curOp.isVimOp || Zn(e, t);
      t.visualMode && Yn(e)
    }
    function Yn(e) {
    ...
    function Zn(e, t) {
      ...
      t.visualMode && !e.somethingSelected()
        ? $t(e, !1)
        : !t.visualMode && !t.insertMode && e.somethingSelected() &&
            (t.visualMode = !0, t.visualLine = !1,
             v.signal(e, "vim-mode-change", { mode: "visual" }));
      if (t.visualMode) {
        var i = Ot(r, n) ? 0 : -1, s = Ot(r, n) ? -1 : 0;
        r = St(r, 0, i), n = St(n, 0, s), t.sel = { anchor: n, head: r },
    ...
    function tr(e) {
      function i() {
        return n.maybeReset && (n.changes = [], n.maybeReset = !1),
               n.changes.push(new er(r)), !0
      }
    ...
    function sr(e, t, n) {
      t.length > 1 && t[0] == "n" && (t = t.replace("numpad", "")),
        t = ir[t] || t;
      var r = "";
      return n.ctrlKey && (r += "C-"), n.altKey && (r += "A-"),
             (r || t.length > 1) && n.shiftKey && (r += "S-"), r += t,
             r.length > 1 && (r = "<" + r + ">"), r
    }
    function ur(e) {
    ...
    function ar(e, t, n) {
      var r = !1, i = S.maybeInitVimState_(e),
      ...
      if (t == "<Esc>" && !i.insertMode && !i.visualMode &&
        ...
        e.operation(function() {
          e.ace.forEachSelection(function() {
            ...
            var s = e.getCursor("head"), u = e.getCursor("anchor"),
                a = Ot(s, u) ? 0 : -1, f = Ot(s, u) ? -1 : 0;
            s = St(s, 0, a), u = St(u, 0, f), e.state.vim.sel.head = s,
            e.state.vim.sel.anchor = u, r = or(e, t, n),
            i.$desiredColumn =
    ...
    var i = e("../range").Range, s = e("../lib/event_emitter").EventEmitter,
        o = e("../lib/dom"), u = e("../lib/oop"), a = e("../lib/keys"),
        f = e("../lib/event"), l = e("../search").Search,
        c = e("../lib/useragent"), h = e("../search_highlight").SearchHighlight,
        p = e("../commands/multi_select_commands"),
        d = e("../mode/text").Mode.prototype.tokenRe;
    e("../multi_select");
    var v = function(e) {
      this.ace = e, this.state = {}, this.marks = {}, this.$uid = 0,
    ...
    v.on = f.addListener, v.off = f.removeListener, v.isWordChar = function(e) {
      ...
      u.implement(v.prototype, s), this.destroy = function() {
        ...
        n.changeHandlers ||
          ...
          n.lastChange ? n.lastChange.next = n.lastChange = t
        ...
        this.curOp.force = t;
        var i = e();
        return this.ace.curOp && this.ace.curOp.command.name == "vim" &&
                 (this.state.dialog &&
                    (this.ace.curOp.command.scrollIntoView = !1),
                  this.ace.endOperation(),
                  !r.cursorActivity && !r.lastChange && n &&
                    (this.ace.prevOp = n)),
               (t || !this.ace.curOp) && this.curOp &&
        ...
        var t = this.ace.selection,
            n = e == "anchor" ? t.isEmpty() ? t.lead : t.anchor
                              : e == "head" || !e ? t.lead : t.getRange()[e];
        return g(n)
        ...
        return !t.length || this.ace.inVirtualSelectionMode
                 ...
                 : t.map(function(e) {
                     return {
                       anchor:
                         this.clipPos(g(e.cursor == e.end ? e.start : e.end)),
        ...
        var n = this.ace.multiSelect, r = e.map(function(e) {
          var t = m(e.anchor), n = m(e.head),
              r = i.comparePoints(t, n) < 0 ? new i.fromPoints(t, n)
        ...
        r.moveTo(e.line, e.ch), r.selectTo(t.line, t.ch),
      ...
      var e = function(e, t, n, r) {
        this.cm = e, this.id = t, this.row = n, this.column = r,
      ...
      e.prototype.clear = function() {
        ...
        if (n == "line") {
          ...
          r != null && (o.column = r), o.row += t,
            o.row = Math.min(Math.max(0, o.row),
        ...
        if (t == "div" || !t) {
          ...
          return {
            left: n.column, top: n.row
          }
        }
        if (t == "local") {
          var r = this.ace.renderer,
              n = this.ace.session.documentToScreenPosition(e.line, e.ch),
              i = r.layerConfig.lineHeight, s = r.layerConfig.characterWidth,
              o = i * n.row;
          return {
            left: n.column * s, top: o, bottom: o + i
          }
        }
        ...
        if (e) {
          ...
          n.scrollCursorIntoView(m(e),
                                 n.lineHeight * 2 / n.$size.scrollerHeight, r)
        }
      ...
      this.setOption = function(e, n) {
        ...
        if (!this.$searchHighlight || !this.$searchHighlight.session) {
          ...
          t.id = n.id, t.session = this.ace.session,
          t.destroy =
            function(e) {
            t.session.off("change", t.updateOnChange),
              t.session.off("changeEditor", t.destroy),
              t.session.removeMarker(t.id), t.session = null
          },
          t.updateOnChange =
            function(e) {
            var n = e.start.row;
            n == e.end.row ? t.cache[n] = undefined
        ...
        this.$searchHighlight && this.$searchHighlight.session &&
          this.$searchHighlight.destroy()
      }, this.getScrollInfo = function() {
        var e = this.ace.renderer, t = e.layerConfig;
        return {
          left: e.scrollLeft, top: e.scrollTop, height: t.maxHeight,
            width: t.width, clientHeight: t.height, clientWidth: t.width
        }
        ...
        t === !0 ? this.ace.session.indentRows(e, e, "	")
        ...
        if (t == 1)
          var s = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e),
                                                       /paren|text/);
        else
          var s = this.ace.session.$findOpeningBracket(
            i.slice(-2, -1), { row: e.line, column: e.ch + 1 }, /paren|text/);
        return s && {
          pos: g(s)
        }
    ...
    function() {
      function e(e, t, n) {
        ...
        return i = r.appendChild(document.createElement("div")),
               n ? i.className = "ace_dialog ace_dialog-bottom"
                 : i.className = "ace_dialog ace_dialog-top",
               typeof t == "string" ? i.innerHTML = t : i.appendChild(t), i
      }
      function t(e, t) {
      ...
      v.defineExtension("openDialog", function(n, r, i) {
        function a(e) {
          if (typeof e == "string")
            ...
            u.state.dialog = null, o = !0, s.parentNode.removeChild(s),
            u.focus(), i.onClose && i.onClose(s)
          }
        }
        ...
        if (this.virtualSelectionMode()) return;
        t(this, a);
        var i = e(this, n, r && r.bottom), s = !1, o,
      ...
      b =
        [
          ...
          },
          {
            ...
            motionArgs:
              { forward: !1, explicitRepeat: !0, linewise: !0, toJumplist: !0 }
          },
          {
            keys: "G",
            type: "motion",
            motion: "moveToLineOrEdgeOfDocument",
            motionArgs:
              { forward: !0, explicitRepeat: !0, linewise: !0, toJumplist: !0 }
          },
          ...
          },
          {
            ...
            type: "search",
            searchArgs:
              { forward: !0, querySrc: "wordUnderCursor", toJumplist: !0 }
          },
          {
            keys: "g#",
            type: "search",
    ...
    v.defineOption("vimMode", !1, function(e, t, n) {
      t && e.getOption("keyMap") != "vim"
        ...
        : !t && n != v.Init && /^vim/.test(e.getOption("keyMap")) &&
    ...
    var Y = function() {
      ...
      return {
        cachedCursor: undefined, add: s, move: o
      }
    }, Z = function(e) {
      return e ? {
        changes: e.changes,
      ...
      enterMacroRecordMode: function(e, t) {
        ...
        n &&
          (n.clear(), this.latestRegister = t,
           e.openDialog && (this.onRecordingDone = e.openDialog(
                              "(recording)[" + t + "]", null, { bottom: !0 })),
           this.isRecording = !0)
      }
    };
    var nt, it, st = {
      ...
      defineEx: function(e, t, n) {
        if (!t)
          ...
          throw new Error('(Vim.defineEx) "' + t + '" is not a prefix of "' +
                          e + '", command not registered');
                 ...
                 : f = a(),
                   f === !1 ? undefined : f === !0 ? function() {
                     ...
                     return e.operation(function() {
                       e.curOp.isVimOp = !0;
                       try {
                         f.type == "keyToKey" ? o(f.toKeys)
                                              : ht.processCommand(e, r, f)
                       } catch (t) {
                         throw e.state.vim = undefined, tt(e),
                               v.Vim.suppressErrorLogging || console.log(t), t
                       }
                       return !0
                     })
                   }
    ...
    ot.prototype.pushRepeatDigit =
      function(e) {
      this.operator ? this.motionRepeat = this.motionRepeat.concat(e)
                    : this.prefixRepeat = this.prefixRepeat.concat(e)
    },
    ot.prototype.getRepeat =
      function() {
      var e = 0;
    ...
    at.prototype = {
      ...
      clear: function() {
        this.keyBuffer = [], this.insertModeChanges = [],
        this.searchQueries = [], this.linewise = !1
      },
      toString: function() {
    ...
    var
      ht = {
        ...
        processMotion: function(e, t, n) {
          ...
          t.inputState.motionArgs = Et(n.motionArgs), this.evalInput(e, t)
        },
        processOperator: function(e, t, n) {
          var r = t.inputState;
          if (r.operator) {
            if (r.operator == n.operator) {
              r.motion = "expandToLine", r.motionArgs = { linewise: !0 },
              this.evalInput(e, t);
              return
            }
            ut(e)
          }
          r.operator = n.operator, r.operatorArgs = Et(n.operatorArgs),
        ...
        processOperatorMotion: function(e, t, n) {
          ...
          i && r && i.visualLine && (t.visualLine = !0),
            this.processOperator(e, t, n), r || this.processMotion(e, t, n)
        },
        processAction: function(e, t, n) {
          var r = t.inputState, i = r.getRepeat(), s = !!i,
              o = Et(n.actionArgs) || {};
          r.selectedCharacter && (o.selectedCharacter = r.selectedCharacter),
            ...
            o.repeat = i || 1, o.repeatIsExplicit = s,
            o.registerName = r.registerName, ut(e), t.lastMotion = null,
            n.isEdit && this.recordLastEdit(t, r, n), yt[n.action](e, o, t)
        },
        processSearch: function(e, t, n) {
          ...
          function l(t, n, i) {
            ...
            s == "Up" || s == "Down"
              ? (o = s == "Up" ? !0 : !1,
                 ...
                 n = nt.searchHistoryController.nextMatch(n, o) || "", i(n),
                 a && t.target &&
                   (t.target.selectionEnd = t.target.selectionStart =
                      Math.min(a, t.target.value.length)))
              : s != "Left" && s != "Right" && s != "Ctrl" && s != "Alt" &&
                  s != "Shift" && nt.searchHistoryController.reset();
            var f;
            try {
              f = Mn(e, n, !0, !0)
            } catch (t) {
            }
            f ? e.scrollIntoView(Pn(e, !r, f), 30)
              : (Hn(e), e.scrollTo(u.left, u.top))
          }
          function c(t, n, r) {
            var i = v.keyName(t);
            i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" ||
                i == "Backspace" && n == ""
              ? (nt.searchHistoryController.pushInput(n),
                 nt.searchHistoryController.reset(), Mn(e, o), Hn(e),
                 e.scrollTo(u.left, u.top), v.e_stop(t), ut(e), r(), e.focus())
          ...
          case "prompt":
            ...
            if (h.isPlaying) {
              ...
              An(e,
                 { onClose: f, prefix: s, desc: Ln, onKeyUp: l, onKeyDown: c });
            break;
          case "wordUnderCursor":
            ...
            m &&i ? p = "\\b" + p + "\\b" : p = Bt(p),
                    ...
                    e.setCursor(d.start), a(p, !0, !1)
          }
        },
        processEx: function(e, t, n) {
          function r(t) {
            nt.exCommandHistoryController.pushInput(t),
              nt.exCommandHistoryController.reset(), Rn.processCommand(e, t)
          }
          function i(t, n, r) {
            ...
            if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" ||
              ...
              nt.exCommandHistoryController.pushInput(n),
                nt.exCommandHistoryController.reset(), v.e_stop(t), ut(e), r(),
                e.focus();
            i == "Up" || i == "Down"
              ? (v.e_stop(t), s = i == "Up" ? !0 : !1,
                 o = t.target ? t.target.selectionEnd : 0,
                 n = nt.exCommandHistoryController.nextMatch(n, s) || "", r(n),
                 o && t.target &&
                   (t.target.selectionEnd = t.target.selectionStart =
                      Math.min(o, t.target.value.length)))
              : i == "Ctrl-U"
                  ? (v.e_stop(t), r(""))
                  : i != "Left" && i != "Right" && i != "Ctrl" && i != "Alt" &&
                      i != "Shift" && nt.exCommandHistoryController.reset()
          }
          n.type == "keyToEx"
        ...
        evalInput: function(e, t) {
          var n = t.inputState, r = n.motion, i = n.motionArgs || {},
              s = n.operator, o = n.operatorArgs || {}, u = n.registerName,
              a = t.sel,
          ...
          if (r) {
            ...
            if (t.visualMode) {
              ...
              d && (d = wt(e, d, !0)), d = d || h, a.anchor = d, a.head = p,
                                       Wt(e), an(e, t, "<", Ot(d, p) ? d : p),
                                       an(e, t, ">", Ot(d, p) ? p : d)
            } else
          ...
          if (s) {
            if (o.lastSel) {
              d = h;
              var b = o.lastSel, w = Math.abs(b.head.line - b.anchor.line),
                  S = Math.abs(b.head.ch - b.anchor.ch);
              b.visualLine ? p = E(h.line + w, h.ch)
                           : b.visualBlock ? p = E(h.line + w, h.ch + S)
                                           : b.head.line == b.anchor.line
                                               ? p = E(h.line, h.ch + S)
                                               : p = E(h.line + w, h.ch),
                             t.visualMode = !0, t.visualLine = b.visualLine,
                             t.visualBlock = b.visualBlock,
                             a = t.sel = { anchor: d, head: p }, Wt(e)
            } else
            ...
            var x, T, N, C, k;
            if (t.visualMode) {
              x = Mt(a.head, a.anchor), T = _t(a.head, a.anchor),
              ...
              N ? Kt(e, x, T) : i.forward && Jt(e, x, T), C = "char";
              var M = !i.inclusive || N;
              k = Xt(e, { anchor: x, head: T }, C, M)
            }
            e.setSelections(k.ranges, k.primary),
              t.lastMotion = null, o.repeat = v, o.registerName = u,
              o.linewise = N;
        ...
        recordLastEdit: function(e, t, n) {
          ...
          e.lastEditInputState = t, e.lastEditActionCommand = n,
      ...
      pt = {
        ...
        goToMark: function(e, t, n, r) {
          ...
          return i ? n.linewise ? { line: i.line, ch: Qt(e.getLine(i.line)) }
                                : i
                   : null
        },
        ...
        moveByLines: function(e, t, n, r) {
          ...
          var o = n.repeat + (n.repeatOffset || 0),
              u = n.forward ? i.line + o : i.line - o, a = e.firstLine(),
              f = e.lastLine();
          ...
          return l && (n.forward ? u > l.start.row && (u = l.end.row + 1)
                                 : u = l.start.row),
                 n.toFirstChar && (s = Qt(e.getLine(u)), r.lastHPos = s),
                 r.lastHSPos = e.charCoords(E(u, s), "div").left, E(u, s)
        },
        ...
        moveTillCharacter: function(e, t, n) {
          var r = n.repeat, i = on(e, r, n.forward, n.selectedCharacter),
              s = n.forward ? -1 : 1;
        ...
        moveToColumn: function(e, t, n, r) {
          var i = n.repeat;
          return r.lastHPos = i - 1, r.lastHSPos = e.charCoords(t, "div").left,
                 un(e, i)
        },
        ...
        textObjectManipulation: function(e, t, n, r) {
          ...
          return e.state.vim.visualMode ? zt(e, a.start, a.end)
                                        : [a.start, a.end]
        },
        repeatLastCharacterSearch: function(e, t, n) {
          var r = nt.lastCharacterSearch, i = n.repeat,
      ...
      mt = {
        change: function(e, t, n) {
          ...
          if (!s.visualMode) {
            ...
            if (a.motion == "moveByWords" && !V(i)) {
              var f = /\s+$/.exec(i);
              f && a.motionArgs && a.motionArgs.forward &&
          ...
          nt.registerController.pushText(t.registerName, "change", i,
                                         t.linewise, n.length > 1),
        ...
        "delete": function(e, t, n) {
          ...
          if (!s.visualBlock) {
            var o = n[0].anchor, u = n[0].head;
            t.linewise && u.line != e.firstLine() && o.line == e.lastLine() &&
              o.line == u.line - 1 &&
              (o.line == e.firstLine() ? o.ch = 0
                                       : o = E(o.line - 1, Pt(e, o.line - 1))),
              i = e.getRange(o, u), e.replaceRange("", o, u), r = o,
          ...
          nt.registerController.pushText(t.registerName, "delete", i,
                                         t.linewise, s.visualBlock);
          var f = s.insertMode;
          return wt(e, r, f)
        },
        indent: function(e, t, n) {
          var r = e.state.vim, i = n[0].anchor.line,
        ...
        yank: function(e, t, n, r) {
          var i = e.state.vim, s = e.getSelection(),
              o = i.visualMode
                    ...
                    : r;
          return nt.registerController.pushText(t.registerName, "yank", s,
                                                t.linewise, i.visualBlock),
                 o
        }
      },
      yt = {
        jumpListWalk: function(e, t, n) {
          ...
          var r = t.repeat, i = t.forward, s = nt.jumpList,
              o = s.move(e, i ? r : -r), u = o ? o.find() : undefined;
          u = u ? u : e.getCursor(), e.setCursor(u),
          e.ace.curOp.command.scrollIntoView = "center-animate"
        },
        scroll: function(e, t, n) {
          if (n.visualMode) return;
          var r = t.repeat || 1, i = e.defaultTextHeight(),
              s = e.getScrollInfo().top, o = i * r,
              u = t.forward ? s + o : s - o, a = Lt(e.getCursor()),
              f = e.charCoords(a, "local");
          if (t.forward)
            u > f.top ? (a.line += (u - f.top) / i, a.line = Math.ceil(a.line),
                         e.setCursor(a), f = e.charCoords(a, "local"),
                         e.scrollTo(null, f.top))
                      : e.scrollTo(null, u);
          else {
            var l = u + e.getScrollInfo().clientHeight;
            l < f.bottom
              ? (a.line -= (f.bottom - l) / i, a.line = Math.floor(a.line),
                 e.setCursor(a), f = e.charCoords(a, "local"),
        ...
        scrollToCursor: function(e, t) {
          var n = e.getCursor().line, r = e.charCoords(E(n, 0), "local"),
              i = e.getScrollInfo().clientHeight, s = r.top, o = r.bottom - s;
          switch (t.position) {
          case "center":
            s = s - i / 2 + o;
            break;
        ...
        enterInsertMode: function(e, t, n) {
          ...
          var r = t ? t.insertAt : null, i = n.sel,
              s = t.head || e.getCursor("head"), o = e.listSelections().length;
          if (r == "eol")
            ...
            n.visualBlock
              ? (s = E(Math.min(i.head.line, i.anchor.line),
                       Math.min(i.head.ch, i.anchor.ch)),
                 o = Math.abs(i.head.line - i.anchor.line) + 1)
              : i.head.line < i.anchor.line ? s = i.head
                                            : s = E(i.anchor.line, 0);
            ...
            n.visualBlock
              ? (s = E(Math.min(i.head.line, i.anchor.line),
                 ...
                 o = Math.abs(i.head.line - i.anchor.line) + 1)
              : i.head.line >= i.anchor.line ? s = St(i.head, 0, 1)
                                             : s = E(i.anchor.line, 0);
                ...
                ? (n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise,
                   v.signal(e, "vim-mode-change", {
                     ...
                     subMode: n.visualLine ? "linewise"
                                           : n.visualBlock ? "blockwise" : ""
                   }),
                   Wt(e))
                : $t(e)
            : (n.visualMode = !0, n.visualLine = !!t.linewise,
               n.visualBlock = !!t.blockwise,
               s = wt(e, E(i.line, i.ch + r - 1), !0),
               n.sel = { anchor: i, head: s }, v.signal(e, "vim-mode-change", {
                 mode: "visual",
                 subMode: n.visualLine ? "linewise"
                                       : n.visualBlock ? "blockwise" : ""
               }),
        ...
        reselectLastSelection: function(e, t, n) {
          ...
          if (r) {
            ...
            if (!i || !s) return;
            n.sel = { anchor: i, head: s }, n.visualMode = !0,
            n.visualLine = r.visualLine, n.visualBlock = r.visualBlock, Wt(e),
            an(e, n, "<", Mt(i, s)), an(e, n, ">", _t(i, s)),
            v.signal(e, "vim-mode-change", {
              mode: "visual",
              subMode: n.visualLine ? "linewise"
                                    : n.visualBlock ? "blockwise" : ""
        ...
        newLineAndEnterInsertMode: function(e, t, n) {
          ...
          if (r.line === e.firstLine() && !t.after)
            ...
            r.line = t.after ? r.line : r.line - 1, r.ch = Pt(e, r.line),
            e.setCursor(r);
            var i = v.commands.newlineAndIndentContinueComment ||
        ...
        paste: function(e, t, n) {
          ...
          if (t.matchIndent) {
            var o = e.getOption("tabSize"),
                ...
                a = e.getLine(e.getCursor().line), f = u(a.match(/^\s*/)[0]),
                l = s.replace(/\n$/, ""), c = s !== l,
          ...
          if (n.visualMode) {
            n.lastPastedText = s;
            var y, b = Rt(e, n), w = b[0], S = b[1], x = e.getSelection(),
                   T = e.listSelections(),
            ...
            n.lastSelection && (y = n.lastSelection.headMark.find()),
              ...
              d ? (e.replaceSelections(N), S = E(w.line + s.length - 1, w.ch),
                   e.setCursor(w), Ft(e, S), e.replaceSelections(s), m = w)
                : n.visualBlock
                    ? (e.replaceSelections(N), e.setCursor(w),
                       e.replaceRange(s, w, w), m = w)
            ...
            e.setCursor(r), Ft(e, E(r.line + s.length - 1, r.ch)),
              e.replaceSelections(s), m = r
          } else
            e.replaceRange(s, r),
              p &&t.after
        ...
        replace: function(e, t, n) {
          var r = t.selectedCharacter, i = e.getCursor(), s, o,
              u = e.listSelections();
          if (n.visualMode)
            i = e.getCursor("start"), o = e.getCursor("end");
          else {
            var a = e.getLine(i.line);
            s = i.ch + t.repeat, s > a.length && (s = a.length),
            o = E(i.line, s)
          }
          if (r == "\n")
        ...
        incrementNumberToken: function(e, t) {
          var n = e.getCursor(), r = e.getLine(n.line),
              i = /(-?)(?:(0x)([\da-f]+)|(0b|0|)(\d+))/gi, s, o, u, a;
          ...
          a = p.toString(h);
          var d =
            f ? (new Array(l.length - a.length + 1 + s[1].length)).join("0")
              : "";
        ...
        repeatLastEdit: function(e, t, n) {
          ...
          if (!r) return;
          var i = t.repeat;
          i &&t.repeatIsExplicit ? n.lastEditInputState.repeatOverride = i
    ...
    var En = { "\\n": "\n", "\\r": "\r", "\\t": "	" }, xn = {
      ...
      "\\t": "	"
        ...
        Ln = "(Javascript regexp)", In = function() {
    ...
    In.prototype = {
      ...
      _processCommand: function(e, t, n) {
        var r = e.state.vim, i = nt.registerController.getRegister(":"),
            s = i.toString();
        r.visualMode && $t(e);
        ...
        if (!u.commandName)
          ...
          if (f) {
            l = f.name, f.excludeFromCommandHistory && i.setText(s),
    ...
    var qn = {
      ...
      set: function(e, t) {
        ...
        o === undefined && s.substring(0, 2) == "no" &&
          (s = s.substring(2), o = !1);
      ...
      registers: function(e, t) {
        var n = t.args, r = nt.registerController.registers,
            i = "----------Registers----------<br><br>";
        if (!n)
          for (var s in r) {
            var o = r[s].toString();
      ...
      sort: function(e, t) {
        ...
        function S(e, t) {
          ...
          return o ? (o = parseInt((o[1] + o[2]).toLowerCase(), m),
                      u = parseInt((u[1] + u[2]).toLowerCase(), m), o - u)
                   : e < t ? -1 : 1
        }
        function x(e, t) {
          if (n) {
          ...
          return r && (e[0] = e[0].toLowerCase(), t[0] = t[0].toLowerCase()),
                 e[0] < t[0] ? -1 : 1
        }
        var n, r, i, s, o, a = u();
        if (a) {
        ...
        if (s || o)
          for (var b = 0; b < p.length; b++) {
            ...
            w && w[0] != "" ? g.push(w)
                            : !o && d.exec(p[b]) ? g.push(p[b]) : y.push(p[b])
          }
        else
          y = p;
        g.sort(o ? x : S);
      ...
      global: function(e, t) {
        ...
        var r = t.line !== undefined ? t.line : e.firstLine(),
            i = t.lineEnd || t.line || e.lastLine(), s = mn(n), o = n, u;
      ...
      substitute: function(e, t) {
        ...
        var n = t.argString, r = n ? yn(n, n[0]) : [], i, s = "", o, u, a,
            f = !1, l = !1;
        if (r.length)
          i = r[0], s = r[1],
          i && i[i.length - 1] === "$" &&
        ...
        o && (u = o[0], a = parseInt(o[1]),
              u && (u.indexOf("c") != -1 && (f = !0, u.replace("c", "")),
    ...
    K("insertModeEscKeysTimeout", 200, "number"), v.keyMap["vim-insert"] = {
      ...
      "Ctrl-P": "autocomplete",
      Enter: function(e) {
        var t = v.commands.newlineAndIndentContinueComment ||
                v.commands.newlineAndIndent;
        t(e)
      },
      fallthrough: ["default"],
    ...
    t.handler = {
      ...
      drawCursor: function(e, t, n, r, s) {
        var u = this.state.vim || {}, a = n.characterWidth, f = n.lineHeight,
            l = t.top, c = t.left;
        if (!u.insertMode) {
          var h = r.cursor ? i.comparePoints(r.cursor, r.start) <= 0
                           : s.selection.isBackwards() || s.selection.isEmpty();
          !h && c > a && (c -= a)
        }
        !u.insertMode && u.status && (f /= 2, l += f), o.translate(e, c, l),
      ...
      handleKeyboard: function(e, t, n, r, i) {
        ...
        if (n == "esc" && !u.insertMode && !u.visualMode &&
        ...
        if (t == -1 || t & 1 || t === 0 && n.length > 1) {
          ...
          var p = ar(o, h, "user");
          u = fr(o),
          p &&u.status != null ? u.status += h
                               : u.status == null && (u.status = ""),
          o._signal("changeStatus");
          if (!p && (t != -1 || l)) return;
          return {
            command: "null", passEvent: !p
          }
        }
      },
      attach: function(e) {
        function n() {
          ...
          t.ace.renderer.setStyle("normal-mode", !n),
            ...
            e.renderer.$keepTextAreaAtCursor = n, e.renderer.$blockCursor = !n
        }
        e.state || (e.state = {});
        var t = new v(e);
        e.state.cm = t, e.$vimModeHandler = this, v.keyMap.vim.attach(t),
        fr(t).status = null, t.on("vim-command-done", function() {
          if (t.virtualSelectionMode()) return;
          fr(t).status = null, t.ace._signal("changeStatus"),
      ...
      detach: function(e) {
        var t = e.state.cm;
        v.keyMap.vim.detach(t), t.destroy(),
          e.state.cm = null, e.$vimModeHandler = null,
          e.renderer.$cursorLayer.drawCursor = null,
          e.renderer.setStyle("normal-mode", !1),
          e.textInput.setCommandMode(!1), e.renderer.$keepTextAreaAtCursor = !0
      },
      getStatusText: function(e) {
        var t = e.state.cm, n = fr(t);
        if (n.insertMode) return "INSERT";
        var r = "";
        return n.visualMode && (r += "VISUAL", n.visualLine && (r += " LINE"),
                                n.visualBlock && (r += " BLOCK")),
               n.status && (r += (r ? " " : "") + n.status), r
      }
    },
    S.defineOption({
      name: "wrap",
    ...
    yt.aceCommand =
      function(e, t, n) {
      e.vimCmd = t, e.ace.inVirtualSelectionMode
    ...
    yt.fold =
      ...
      e.ace.execCommand(
        ["toggleFoldWidget", "toggleFoldWidget", "foldOther",
         "unfoldall"][(t.all ? 2 : 0) + (t.open ? 1 : 0)])
    },
    t.handler.defaultKeymap = b, t.handler.actions = yt, t.Vim = S,
    S.map("Y", "yy", "normal")
  });
(function() {
