ace.define(
          ...
          start: [
            ...
            },
            {
              ...
              push: [
                ...
                { include: "operators" }, { defaultToken: "text" }
              ]
            },
            {
            ...
            { token: "paren.rpar", regex: "[\\])}]" }, { include: "constants" },
  ...
  ace.define(
    ...
    [
      ...
      "ace/mode/terraform_highlight_rules", "ace/mode/behaviour/cstyle",
    ...
    function(e, t, n) {
      ...
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          f = function() {
            i.call(this), this.HighlightRules = s, this.$outdent = new a,
