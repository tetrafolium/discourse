ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
      "ace/mode/text_highlight_rules", "ace/mode/javascript_highlight_rules",
      "ace/mode/css_highlight_rules", "ace/mode/markdown_highlight_rules",
      "ace/mode/html_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      function N() {
        ...
        this.$rules = {
          start: [
            ...
            C.syntax(/var\b/, "js-statement", "attr"), C.tag(), k(b, "[[({>]"),
            k(w, "[\\])};]", "start"), { caseInsensitive: !0 }
          ]
        };
        var e = this;
        t("interpolation", /\]/, w + "." + g), t("statement", /\)|}|;/),
          t("block", /\}/), n(), r(), i(), this.normalizeRules()
      }
      function k(e, t, n) {
        var r, i, s;
        return arguments.length === 4
                 ? (r = n, i = arguments[3])
                 : typeof n == "string" ? i = n : r = n,
                                          typeof e == "function" &&
                                            (s = e, e = "empty"),
        {
      ...
      var r = e("../lib/oop"), i = e("../lib/lang"),
          ...
          c = "support.function.markup.bold", h = "keyword",
          p = "constant.language", d = "keyword.control.markup.italic",
          v = "support.variable.class", m = "keyword.operator",
          g = "markup.italic", y = "markup.bold", b = "paren.lparen",
          w = "paren.rparen", E, S, x, T;
      (function() {
      ...
      var C = {
        string: function(e, t) {
          var n = k("string.start", e,
                    [
                      ...
                      k("string.end", e, "pop"), { defaultToken: "string" }
                    ],
                    t);
          if (e.length === 1) {
        ...
        tagHead: function(e) {
          return k(v, e, [
            k(v, /[\w\-_]+/), k(b + "." + g, /~\[/, C.interpolation()), C.goUp()
          ])
        },
        tag: function() {
          return {
                ...
                function(e) {
                  return void 0 !== S[e]
                           ...
                           : void 0 !== x[e]
                               ...
                               : void 0 !== E[e]
                                   ? "support.function"
                                   : void 0 !== T[e.toLowerCase()] ? l : c
                },
              regex: /([@\w\-_:+]+)|((^|\s)(?=\s*(\.|#)))/, push: [
                C.tagHead(/\./), C.tagHead(/#/), C.expression(), C.attribute(),
                k(b, /[;>{]/, "pop")
              ]
          }
        },
        syntax: function(e, t, n) {
          return {
            token: p, regex: e, push: {
              attr: [t + "-start", k(m, /;/, "start")],
              multiline:
                [
                  C.tagHead(/\./), C.tagHead(/#/), C.attribute(),
                  C.expression(), k(b, /[>\{]/), k(m, /;/, "start"),
                  k(b, /'''|"""/, [t + "-start"])
                ],
              block:
                [
                  C.tagHead(/\./), C.tagHead(/#/), C.attribute(),
                  C.expression(), k(b, /\{/, [t + "-start"])
                ]
            }[n]
          }
        },
        attribute: function() {
          return k(
            ...
            /[\w_-]+/, [
              k(m, /\s*=\s*/,
                [C.string('"'), C.string("'"), C.word(), C.goUp()]),
              C.goUp()
            ])
        },
        expression: function() {
