ace.define("ace/mode/doc_comment_highlight_rules",
           ...
           function(e, t, n) {
             ...
             r.inherits(s, i), s.getTagRule = function(e) {
               ...
               return {
                 token: "comment.doc", regex: "\\/\\*(?=\\*)", next: e
               }
      ...
      function a() {
        var e = o.replace("\\d", "\\d\\-"), t = {
          onMatch: function(e, t, n) {
            ...
            if (r == 1)
              t != this.nextState ? n.unshift(this.next, this.nextState, 0)
                                  : n.unshift(this.next),
                n[2]++;
            ...
            return [
              {
                type: "meta.tag.punctuation." + (r == 1 ? "" : "end-") +
                        "tag-open.xml",
                value: e.slice(0, r)
              },
        ...
        this.$rules.jsx =
          [n, t, { include: "reference" }, { defaultToken: "string" }],
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var
        r = e("../lib/oop"),
        i = e("./text_highlight_rules").TextHighlightRules, s = function(e) {
          ...
          this.$rules = {
            start: [
              ...
              {
                token:
                  ["punctuation.instruction.xml", "keyword.instruction.xml"],
                regex: "(<\\?)(" + t + ")",
            ...
            int_subset: [
              ...
              {
                token:
                  ["punctuation.markup-decl.xml", "keyword.markup-decl.xml"],
                regex: "(<\\!)(" + t + ")",
                push: [
                  { token: "text", regex: "\\s+" }, {
      ...
      (function() {
        ...
        r.inherits(s, i), t.XmlHighlightRules = s
    }),
  ace.define(
      ...
      var r = e("../lib/oop"), i = e("../lib/lang"),
          ...
          f = function() {
            u.call(this), this.addRules({
              ...
              this.embedTagRules((new o({ jsx: !1 })).getRules(), "js-",
                                 "script"),
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var
        r = e("../lib/oop"),
        i = e("./php_highlight_rules").PhpHighlightRules, s = function() {
          i.call(this);
          var e = {
            start: [
            ...
            parenthesis: [{
              ...
              push: [
                ...
                { include: "lang" }, { include: "parenthesis" },
            ...
            directives: [
              {
                token:
                  ["directive.declaration.blade", "keyword.directives.blade"],
                regex:
            ...
            variables: [
              ...
              {
                token:
                  ["keyword.operator.blade", "constant.other.property.blade"],
                regex: "(->)([a-zA-Z_][a-zA-Z0-9_]*)\\b"
              },
              {
                token: [
  ...
  ace.define("ace/mode/php_completions", ["require", "exports", "module"],
             function(e, t, n) {
               "use strict";
               function s(e, t) {
               ...
               var
                 r = {
                   ...
                   bzerrno:
                     ["int bzerrno(resource bz)", "Returns the error number"],
                   bzerror:
                     [
                   ...
                   chroot:
                     ["bool chroot(string directory)", "Change root directory"],
                   chunk_split:
                     [
                   ...
                   dba_close:
                     ["void dba_close(resource handle)", "Closes database"],
                   dba_delete:
                     [
                   ...
                   dom_node_has_attributes:
                     [
                       "boolean dom_node_has_attributes();", "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#core-ID-NodeHasAttrs Since: DOM Level 2"
                     ],
                   ...
                   fclose:
                     ["bool fclose(resource fp)", "Close an open file pointer"],
                   feof:
                     [
                   ...
                   filegroup:
                     ["int filegroup(string filename)", "Get file group"],
                   fileinode:
                     ["int fileinode(string filename)", "Get file inode"],
                   filemtime:
                     [
                   ...
                   fstat:
                     ["array fstat(resource fp)", "Stat() on a filehandle"],
                   ftell:
                     [
                   ...
                   getmyuid:
                     ["int getmyuid(void)", "Get PHP script owner's UID"],
                   getopt:
                     [
                   ...
                   gmp_neg:
                     ["resource gmp_neg(resource a)", "Negates a number"],
                   gmp_nextprime:
                     [
                   ...
                   hash_hmac:
                     [
                       "string hash_hmac(string algo, string data, string key[, bool raw_output = false])", "Generate a hash of a given input string with a key using HMAC Returns lowercase hexits by default"
                     ],
                   hash_hmac_file:
                     [
                   ...
                   ibase_errcode:
                     ["int ibase_errcode(void)", "Return error code"],
                   ibase_errmsg:
                   ...
                   imageconvolution:
                     [
                       "resource imageconvolution(resource src_im, array matrix3x3, double div, double offset)", "Apply a 3x3 convolution matrix, using coefficient div and offset"
                     ],
                   imagecopy:
                     [
                   ...
                   mysql_list_tables:
                     [
                       "resource mysql_list_tables(string database_name [, int link_identifier])", "List tables in a MySQL database"
                     ],
                   mysql_num_fields:
                     [
                   ...
                   normalizer_is_normalize:
                     [
                       "bool normalizer_is_normalize( string $input [, string $form = FORM_C] )", "* Test if a string is in a given normalization form."
                     ],
                   ...
                   oci_lob_close:
                     ["bool oci_lob_close()", "Closes lob descriptor"],
                   oci_lob_copy:
                     [
                   ...
                   oci_lob_eof:
                     ["bool oci_lob_eof()", "Checks if EOF is reached"],
                   oci_lob_erase:
                     [
                   ...
                   oci_lob_load:
                     ["string oci_lob_load()", "Loads a large object"],
                   oci_lob_read:
                     [
                   ...
                   oci_lob_tell:
                     ["int oci_lob_tell()", "Tells LOB pointer position"],
                   oci_lob_truncate:
                     [
                   ...
                   odbc_tables:
                     [
                       "resource odbc_tables(resource connection_id [, string qualifier [, string owner [, string name [, string table_types]]]])", "Call the SQLTables function"
                     ],
                   opendir:
                     [
                   ...
                   rand:
                     [
                       "int rand([int min, int max])", "Returns a random number"
                     ],
                   range:
                     [
                   ...
                   session_id:
                     [
                       "string session_id([string newid])", "Return the current session id. If newid is given, the session id is replaced with newid"
                     ],
                   ...
                   shmop_size:
                     ["int shmop_size (int shmid)", "returns the shm size"],
                   shmop_write:
                     [
                   ...
                   srand:
                     [
                       "void srand([int seed])", "Seeds random number generator"
                     ],
                   sscanf:
                     [
                   ...
                   stream_filter_remove:
                     [
                       "bool stream_filter_remove(resource stream_filter)", "Flushes any data in the filter's internal buffer, removes it from the chain, and frees the resource"
                     ],
                   stream_get_contents:
                     [
                   ...
                   umask:
                     ["int umask([int mask])", "Return or change the umask"],
                   uniqid:
                     [
                   ...
                   zip_close:
                     ["void zip_close(resource zip)", "Close a Zip archive"],
                   zip_entry_close:
                     [
               ...
               (function() {
                 this.getCompletions = function(e, t, n, r) {
                   ...
                   return s.map(function(e) {
                     return {
                       caption: e, snippet: e + "($0)", meta: "php function",
                         score: 1e6, docHTML: r[e][1]
                     }
                   })
                   ...
                   return s.map(function(e) {
                     return {
                       caption: e, value: e, meta: "php variable", score: 1e6
                     }
                   })
                   ...
                   if (!i[o]) return [];
                   var u = [];
                   return i[o].type === "array" && i[o].value &&
                            (u = Object.keys(i[o].value)),
                          u.map(function(e) {
                            return {
                              caption: e, value: e, meta: "php array key",
                                score: 1e6
                            }
                          })
                 }
             ...
             function(e, t, n) {
               ...
               r.inherits(l, i), function() {
                 ...
                 this.getNextLineIndent = function(e, t, n) {
                   ...
                   var t = new u(["ace"], "ace/mode/javascript_worker",
                                 "JavaScriptWorker");
  ...
  ace.define(
    "ace/mode/css_completions", ["require", "exports", "module"],
    function(e, t, n) {
      "use strict";
      var r = {
        background: { "#$0": 1 },
      ...
      (function() {
        this.completionsDefined = !1, this.defineCompletions = function() {
          ...
          return s.map(function(e) {
            return {
              caption: e, snippet: e + ": $0;", meta: "property", score: 1e6
            }
          })
          ...
          return o in r && typeof r[o] == "object" && (u = Object.keys(r[o])),
                 u.map(function(e) {
                   return {
                     caption: e, snippet: e, meta: "property value", score: 1e6
                   }
                 })
        }
      }).call(i.prototype),
            ...
            this.inherit(s),
              this.add("colon", "insertion", function(e, t, n, r, i) {
                if (i === ":" && n.selection.isEmpty()) {
                  var s = n.getCursorPosition(), u = new o(r, s.row, s.column),
                      a = u.getCurrentToken();
                ...
                if (!i.isMultiLine() && s === ":") {
                  var u = n.getCursorPosition(), a = new o(r, u.row, u.column),
                      f = a.getCurrentToken();
                ...
                if (i === "!" && n.selection.isEmpty()) {
                  ...
                  if (/^\s*(;|}|$)/.test(o.substring(s.column))) return {
                      text: "!important", selection: [10, 10]
                    }
                }
              })
          };
  ...
  ace.define("ace/mode/css",
             [
               ...
               "ace/mode/css_highlight_rules",
               "ace/mode/matching_brace_outdent", "ace/worker/worker_client",
               "ace/mode/css_completions", "ace/mode/behaviour/css",
             ...
             function(e, t, n) {
               ...
               var r = e("../lib/oop"), i = e("./text").Mode,
                   ...
                   l = e("./folding/cstyle").FoldMode, c = function() {
                     this.HighlightRules = s, this.$outdent = new o,
                     this.$behaviour = new f, this.$completer = new a,
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      r.inherits(a, o);
      var f = function() {
        this.tagName = "", this.closing = !1, this.selfClosing = !1,
        this.start = { row: 0, column: 0 }, this.end = { row: 0, column: 0 }
      };
      (function() {
        this.getFoldWidget = function(e, t, n) {
          var r = this._getFirstTagInLine(e, n);
          return r ? r.closing || !r.tagName && r.selfClosing
                       ? t == "markbeginend" ? "end" : ""
                       : !r.tagName || r.selfClosing ||
                             this.voidElements.hasOwnProperty(
                               r.tagName.toLowerCase())
                           ? ""
                           : this._findEndTagInLine(e, n, r.tagName,
                                                    r.end.column)
                               ? ""
                               : "start"
          ...
          for (var i = 0; i < n.length; i++) {
            ...
            if (l(s, "tag-open")) {
              ...
              r.closing = l(s, "end-tag-open"), s = n[++i];
              if (!s) return null;
          ...
          var r = this._getFirstTagInLine(e, n);
          if (!r)
            return this.getCommentFoldWidget(e, n) &&
      ...
      var r = e("../token_iterator").TokenIterator,
          i =
            [
              ...
              "id",         "inert",     "itemid",          "itemprop",
              "itemref",    "itemscope", "itemtype",        "lang",
              "spellcheck", "style",     "tabindex",        "title",
              "translate"
            ],
          s =
            [
              "onabort",          "onblur",           "oncancel",
              "oncanplay",        "oncanplaythrough", "onchange",
              "onclick",          "onclose",          "oncontextmenu",
              "oncuechange",      "ondblclick",       "ondrag",
          ...
          o = i.concat(s), u = {
            ...
            strong: {},
            style:
              { type: 1, media: { all: 1, screen: 1, print: 1 }, scoped: 1 },
            sub: {},
            sup: {},
            svg: {},
            table: { summary: 1 },
      ...
      (function() {
        this.getCompletions = function(e, t, n, r) {
          ...
          return i in u && (s = s.concat(Object.keys(u[i]))),
                 s.map(function(e) {
                   return {
                     caption: e, snippet: e + '="$0"', meta: "attribute",
                       score: 1e6
                   }
                 })
          ...
          if (!i) return [];
          var o = [];
          return i in u && s in u[i] && typeof u[i][s] == "object" &&
                   (o = Object.keys(u[i][s])),
                 o.map(function(e) {
                   return {
                     caption: e, snippet: e, meta: "attribute value", score: 1e6
                   }
                 })
          ...
          return i.map(function(e) {
            return {
              caption: e, snippet: e, meta: "html entity", score: 1e6
            }
          })
        }
      }).call(h.prototype),
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
      "ace/mode/text", "ace/mode/javascript", "ace/mode/css",
      "ace/mode/html_highlight_rules", "ace/mode/behaviour/xml",
      "ace/mode/folding/html", "ace/mode/html_completions",
      "ace/worker/worker_client"
    ],
    function(e, t, n) {
      "use strict";
      var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./text").Mode,
          o = e("./javascript").Mode, u = e("./css").Mode,
          ...
          p =
            [
              ...
              "keygen", "link", "meta", "menuitem", "param", "source", "track",
              "wbr"
            ],
          d =
            [
          ...
          v = function(e) {
            ...
            this.HighlightRules = a, this.$behaviour = new f,
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/php_highlight_rules", "ace/mode/php_highlight_rules",
      "ace/mode/matching_brace_outdent", "ace/range",
      "ace/worker/worker_client", "ace/mode/php_completions",
    ...
    function(e, t, n) {
      ...
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          d = e("./html").Mode, v = e("./javascript").Mode, m = e("./css").Mode,
          g = function(e) {
            this.HighlightRules = o, this.$outdent = new u,
            this.$behaviour = new c, this.$completer = new l,
  ...
  ace.define("ace/mode/php_laravel_blade",
             [
               "require", "exports", "module", "ace/lib/oop",
               "ace/mode/php_laravel_blade_highlight_rules", "ace/mode/php",
             ...
             function(e, t, n) {
               ...
               var r = e("../lib/oop"),
                   ...
                   s = e("./php").Mode, o = e("./javascript").Mode,
                   u = e("./css").Mode, a = e("./html").Mode, f = function() {
                     s.call(this), this.HighlightRules = i,
