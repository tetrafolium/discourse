ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      function s(e) {
        return {
          token: e.token + ".start", regex: e.start, push: [
  ...
  ace.define(
    ...
    [
      ...
      "ace/mode/visualforce_highlight_rules", "ace/mode/behaviour/xml",
      "ace/mode/folding/html"
    ],
    function(e, t, n) {
      "use strict";
      function a() {
        i.call(this), this.HighlightRules = s, this.foldingRules = new u,
      ...
      r.inherits(a, i), a.prototype.emmetConfig = { profile: "xhtml" },
                        t.Mode = a
    });
(function() {
