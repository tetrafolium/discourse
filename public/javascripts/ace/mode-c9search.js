ace.define(
  ...
  function(e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"),
        s = e("./text_highlight_rules").TextHighlightRules, u = function() {
          this.$rules = {
            start: [
              {
                tokenNames: [
                ...
                onMatch: function(e, t, n) {
                  var r = this.splitRegex.exec(e), i = this.tokenNames, s = [
                    { type: i[0], value: r[1] }, { type: i[1], value: r[2] }
                  ];
                  r[3] &&
                    (r[3] == " " ? s[1] = { type: i[1], value: r[2] + " " }
              ...
              },
              {
                ...
                onMatch: function(e, t, n) {
                  ...
                  u && (/regex/.test(s) || (u = i.escapeRegExp(u)),
  ...
  ace.define("ace/mode/c9search",
             ...
             function(e, t, n) {
               ...
               var r = e("../lib/oop"), i = e("./text").Mode,
                   ...
                   u = e("./folding/c9search").FoldMode, a = function() {
