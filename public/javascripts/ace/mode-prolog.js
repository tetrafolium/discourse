ace.define(
  ...
  function(e, t, n) {
    ...
    var
      ...
      i = e("./text_highlight_rules").TextHighlightRules, s = function() {
        this.$rules = {
          start: [
            { include: "#comment" }, { include: "#basic_fact" },
            { include: "#rule" }, { include: "#directive" },
            { include: "#fact" }
          ],
          "#atom": [
            {
          ...
          "#basic_elem": [
            ...
            { include: "#builtins" }, { include: "#list" },
            { include: "#atom" }, { include: "#variable" }
          ],
          "#basic_fact": [{
            token: [
  ...
  ace.define("ace/mode/prolog",
             [
               ...
               "ace/mode/prolog_highlight_rules", "ace/mode/folding/cstyle"
             ],
             function(e, t, n) {
               "use strict";
