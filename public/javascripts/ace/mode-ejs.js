ace.define(
  ...
  function(e, t, n) {
    ...
    var
      r = e("../lib/oop"),
      i = e("../lib/lang"), s = e("./text_highlight_rules").TextHighlightRules,
      o = t.supportType =
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop",
      "ace/mode/html_highlight_rules", "ace/mode/javascript_highlight_rules",
      "ace/lib/oop", "ace/mode/html", "ace/mode/javascript", "ace/mode/css",
      "ace/mode/ruby"
    ],
    function(e, t, n) {
      "use strict";
      ...
      var r = e("../lib/oop"), u = e("./html").Mode, a = e("./javascript").Mode,
          f = e("./css").Mode, l = e("./ruby").Mode, c = function() {
            u.call(this),
