ace.define(
    ...
    r.inherits(s, i), function() {
      this.pushRule = function(e) {
        return {
          ...
          , set next(t) {
            if (Array.isArray(e.next)) {
              var n = e.next[e.next.length - 1], r = n.length - 1,
                  i = t.length - 1;
              if (i > r)
                while (r >= 0 && i >= 0) {
          ...
          var
            ...
            r = this.createKeywordMapper({
              ...
              keyword: e
                                         ...
                                         "identifier"),
            i = "[uU]?", s = "[rR]", o = "[fF]", u = "(?:[rR][fF]|[fF][rR])",
            a = "(?:(?:[1-9]\\d*)|(?:0))", f = "(?:0[oO]?[0-7]+)",
            l = "(?:0[xX][\\dA-Fa-f]+)", c = "(?:0[bB][01]+)",
            h = "(?:" + a + "|" + f + "|" + l + "|" + c + ")",
            p = "(?:[eE][+-]?\\d+)", d = "(?:\\.\\d+)", v = "(?:\\d+)",
            m = "(?:(?:" + v + "?" + d + ")|(?:" + v + "\\.))",
            g = "(?:(?:" + m + "|" + v + ")" + p + ")",
  ...
  ace.define(
    ...
    [
      ...
      "ace/mode/csound_preprocessor_highlight_rules",
      "ace/mode/csound_score_highlight_rules", "ace/mode/lua_highlight_rules",
      "ace/mode/python_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      var
        ...
        a = e("./python_highlight_rules").PythonHighlightRules, f = function() {
          ...
          var e =
              ...
              t = [
                "array",     "bformdec",  "bformenc",  "copy2ftab", "copy2ttab",
                "hrtfer",    "ktableseg", "lentab",    "maxtab",    "mintab",
                "pop",       "pop_f",     "push",      "push_f",    "scalet",
                ...
                "tabmap",    "tabmap_i",  "tabslice",  "tb0",       "tb0_init",
                "tb1",       "tb10",      "tb10_init", "tb11",      "tb11_init",
                "tb12",      "tb12_init", "tb13",      "tb13_init", "tb14",
                "tb14_init", "tb15",      "tb15_init", "tb1_init",  "tb2",
                "tb2_init",  "tb3",       "tb3_init",  "tb4",       "tb4_init",
                "tb5",       "tb5_init",  "tb6",       "tb6_init",  "tb7",
                "tb7_init",  "tb8",       "tb8_init",  "tb9",       "tb9_init",
                "vbap16",    "vbap4",     "vbap4move", "vbap8",     "vbap8move",
                "xyin"
              ];
          e = r.arrayToMap(e), t = r.arrayToMap(t),
          ...
          n.splice(1, 0, {
            ...
            n.push(
              ...
              this.pushRule({
                ...
                regex: /\btimout\b/,
                next: [
                  "goto before label", "goto before argument",
              ...
              this.pushRule({
                ...
                next: [
                  "goto before label", "goto before argument",
                  "goto before argument", "goto before argument"
                ]
              }),
              this.pushRule({
              ...
              { token: "support.variable.csound", regex: /\bp\d+\b/}, {
                ...
                onMatch: function(n, r, i, s) {
                  ...
                  return e.hasOwnProperty(u)?a="support.function.csound":t.hasOwnProperty(u)&&(a="invalid.deprecated.csound"),a?o[2]?[{type:a,value:u},{type:"punctuation.type-annotation.csound",value:o[2]},{type:"type-annotation.storage.type.csound",value:o[3]}]:a:"text.csound"
                }
              }),
            ...
            this.addRules({
              ...
              "goto before argument":
                [this.popRule({ token: "text.csound", regex: /,/}), n],
              "goto before label": [
                { token: "text.csound", regex: /\s+/}, this.comments,
                this.popRule(
                  { token: "entity.name.label.csound", regex: /\w+/}),
          ...
          this.embedRules(o, "csound-score-", i),
            this.embedRules(a, "python-", i), this.embedRules(u, "lua-", i),
            this.normalizeRules()
        };
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop",
      "ace/mode/csound_orchestra_highlight_rules",
      "ace/mode/csound_score_highlight_rules", "ace/mode/html_highlight_rules",
      "ace/mode/text_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
  ...
  ace.define(
    ...
    function(e, t, n) {
      ...
      var r = e("../lib/oop"), i = e("./text").Mode,
          s =
            e("./csound_document_highlight_rules").CsoundDocumentHighlightRules,
          o = function() {
