  ...
  ace.define("ace/lib/oop", [], function(e, t, n) {
    ...
    (function(e, n, r) {
      ...
      function m(e) {
        if (mt) {
          var t = vt.pop();
          t.complete(), n.locations && (e.loc = t.loc),
      ...
      function x(e) {
        ...
        throw "undefined" != typeof e.line
          ? (r = e.range[0] - e.lineStart,
             ...
             n.line = e.line, n.index = e.range[0], n.column = r)
          : (r = C - D + 1, n = new SyntaxError(E("[%1:%2] %3", _, r, t)),
             n.index = C, n.line = _, n.column = r),
          n
      }
      function T(e, t) {
      ...
      function B() {
        ...
        while (tt(t.charCodeAt(++C)))
          ;
        return e = t.slice(M, C),
               nt(e) ? n = u
                     : "true" === e || "false" === e
                         ? (n = c, e = "true" === e)
                         : "nil" === e ? (n = h, e = null) : n = a,
        {
      ...
      function R() {
        var e = t.charAt(C), n = t.charAt(C + 1),
            r = "0" === e && "xX".indexOf(n || null) >= 0 ? U() : z();
        return {
          type: f, value: r, line: _, lineStart: D, range: [M, C]
        }
      }
      function U() {
      ...
      function nt(e) {
        ...
        case 5:
          return "break" === e || "local" === e || "until" === e ||
                 "while" === e;
        case 6:
      ...
      function rt(e) {
        return l === e.type ? "#-~".indexOf(e.value) >= 0
                            : u === e.type ? "not" === e.value : !1
      }
      function it(e) {
        switch (e.type) {
        case "CallExpression":
      ...
      function Mt() {
        ...
        mt && (r = vt[vt.length - 1], vt.push(r)),
          t = qt(), K("then"), n = St(), e.push(m(v.ifClause(t, n))),
          mt && (r = gt());
        while (J("elseif"))
          wt(r), t = qt(), K("then"), n = St(), e.push(m(v.elseifClause(t, n))),
                 mt && (r = gt());
        return J("else") && (mt && (r = new yt(L), vt.push(r)), n = St(),
      ...
      function jt() {
        ...
        while (J("."))
          wt(r), t = Ht(), n.scope && pt(t, !1),
                 e = m(v.memberExpression(e, ".", t));
        return J(":") && (wt(r), t = Ht(), n.scope && pt(t, !1),
                          e = m(v.memberExpression(e, ":", t))),
               e
      }
      function Ft() {
        ...
        for (;;) {
          ...
          if (l === k.type && J("["))
            ...
            t = qt(), J("=") ? (n = qt(), e.push(m(v.tableKeyString(t, n))))
      ...
      function Ut(e) {
        ...
        for (;;) {
          ...
          ("^" === t || ".." === t) && s--, $();
          var o = Ut(s);
          null == o && T("<expression>", k), mt && vt.push(r),
        ...
        for (;;)
          if (l === k.type) switch (k.value) {
            case "[":
              ...
              break;
            case ".":
              wt(r), $(), u = Ht(), n.scope && pt(u, i),
                          e = m(v.memberExpression(e, ".", u));
              break;
            case ":":
              wt(r), $(), u = Ht(), n.scope && pt(u, i),
                          e = m(v.memberExpression(e, ":", u)), wt(r),
                          e = Wt(e);
              break;
            case "(":
            case "{":
      ...
      function Vt(s, o) {
        return "undefined" == typeof o && "object" == typeof s &&
                 (o = s, s = undefined),
               o || (o = {}), t = s || "", n = S(i, o), C = 0, _ = 1, D = 0,
                              r = t.length, ot = [[]], ut = 0, at = [], vt = [],
      ...
      function Jt(e) {
        "undefined" != typeof e && $t(e), r = t.length,
                                          mt = n.locations || n.ranges, A = P();
        var i = Et();
      ...
      var t, n, r, i = e.defaultOptions = {
        ...
        ranges: !1
                   ...
                   s = 1, o = 2, u = 4, a = 8, f = 16, l = 32, c = 64, h = 128,
                   p = 256;
      e.tokenTypes = {
        EOF: s,
        StringLiteral: o,
        ...
        malformedNumber: "malformed number near '%1'"
          ...
          v = e.ast = {
            ...
            gotoStatement: function(e) {
              return {
                type: "GotoStatement", label: e
              }
            },
            returnStatement: function(e) {
              return {
                type: "ReturnStatement", arguments: e
              }
            },
            ifStatement: function(e) {
              return {
                type: "IfStatement", clauses: e
              }
            },
            ifClause: function(e, t) {
              return {
                type: "IfClause", condition: e, body: t
              }
            },
            elseifClause: function(e, t) {
              return {
                type: "ElseifClause", condition: e, body: t
              }
            },
            elseClause: function(e) {
              return {
                type: "ElseClause", body: e
              }
            },
            whileStatement: function(e, t) {
              return {
                type: "WhileStatement", condition: e, body: t
              }
            },
            doStatement: function(e) {
              return {
                type: "DoStatement", body: e
              }
            },
            repeatStatement: function(e, t) {
              return {
                type: "RepeatStatement", condition: e, body: t
              }
            },
            localStatement: function(e, t) {
              return {
                type: "LocalStatement", variables: e, init: t
              }
            },
            assignmentStatement: function(e, t) {
              return {
                type: "AssignmentStatement", variables: e, init: t
              }
            },
            callStatement: function(e) {
              return {
                type: "CallStatement", expression: e
              }
            },
            functionStatement: function(e, t, n, r) {
              return {
                type: "FunctionDeclaration", identifier: e, isLocal: n,
                  parameters: t, body: r
              }
            },
            forNumericStatement: function(e, t, n, r, i) {
              return {
                type: "ForNumericStatement", variable: e, start: t, end: n,
                  step: r, body: i
              }
            },
            forGenericStatement: function(e, t, n) {
              return {
                type: "ForGenericStatement", variables: e, iterators: t, body: n
              }
            },
            chunk: function(e) {
              return {
            ...
            tableKey: function(e, t) {
              return {
                type: "TableKey", key: e, value: t
              }
            },
            tableKeyString: function(e, t) {
              return {
                type: "TableKeyString", key: e, value: t
              }
            },
            tableValue: function(e) {
              return {
                type: "TableValue", value: e
              }
            },
            tableConstructorExpression: function(e) {
              return {
                type: "TableConstructorExpression", fields: e
              }
            },
            binaryExpression: function(e, t, n) {
              var r = "and" === e || "or" === e ? "LogicalExpression"
                                                : "BinaryExpression";
              return {
                type: r, operator: e, left: t, right: n
              }
            },
            unaryExpression: function(e, t) {
              return {
                type: "UnaryExpression", operator: e, argument: t
              }
            },
            memberExpression: function(e, t, n) {
              return {
                type: "MemberExpression", indexer: t, identifier: n, base: e
              }
            },
            indexExpression: function(e, t) {
              return {
                type: "IndexExpression", base: e, index: t
              }
            },
            callExpression: function(e, t) {
              return {
                type: "CallExpression", base: e, arguments: t
              }
            },
            tableCallExpression: function(e, t) {
              return {
                type: "TableCallExpression", base: e, arguments: t
              }
            },
            stringCallExpression: function(e, t) {
              return {
                type: "StringCallExpression", base: e, argument: t
              }
            },
            comment: function(e, t) {
              return {
                type: "Comment", value: e, raw: t
              }
            }
          },
          g = Array.prototype.slice, y = Object.prototype.toString,
          b = function(t, n) {
      ...
      yt.prototype.complete = function() {
        n.locations && (this.loc.end.line = L.line,
    ...
    var r = e("../lib/oop"), i = e("../worker/mirror").Mirror,
        s = e("../mode/lua/luaparse"), o = t.Worker = function(e) {
