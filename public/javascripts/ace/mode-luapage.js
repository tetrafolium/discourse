ace.define("ace/mode/doc_comment_highlight_rules",
    ...
    function(e, t, n) {
      ...
      r.inherits(u, i), function() {
        ...
        this.getFoldWidget = function(e, t, n) {
          ...
          if (i)
            return i[1] ? this.luaBlock(e, n, i.index + 1)
                        : i[2] ? e.getCommentFoldRange(n, i.index + 1)
          ...
          if (i)
            return i[0] === "end" &&
                     ...
                     : i[0][0] === "]" ? e.getCommentFoldRange(n, i.index + 1)
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/lua_highlight_rules", "ace/mode/folding/lua", "ace/range",
      "ace/worker/worker_client"
    ],
    function(e, t, n) {
      "use strict";
      var r = e("../lib/oop"), i = e("./text").Mode,
          ...
          o = e("./folding/lua").FoldMode, u = e("../range").Range,
          a = e("../worker/worker_client").WorkerClient, f = function() {
      ...
      r.inherits(f, i), function() {
        ...
        this.getNextLineIndent = function(e, t, r) {
          var i = this.$getIndent(t), s = 0,
              o = this.getTokenizer().getLineTokens(t, e), u = o.tokens;
          ...
          var i = t.getLine(r - 1), s = this.$getIndent(i).length,
              ...
              a = t.getTabString().length, f = s + a * n(o),
  ...
  ace.define("ace/mode/luapage",
             [
               ...
               "ace/mode/lua", "ace/mode/luapage_highlight_rules"
             ],
             function(e, t, n) {
               "use strict";
