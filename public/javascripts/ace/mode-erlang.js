ace.define(
      ...
      i = e("./text_highlight_rules").TextHighlightRules, s = function() {
        this.$rules = {
          start: [
            ...
            { include: "#record-directive" }, { include: "#define-directive" },
            { include: "#macro-directive" }, { include: "#directive" },
          ...
          "#define-directive": [
            ...
            },
            {
              ...
              push: [
                ...
                {
                  token: [
                    "text", "punctuation.section.directive.begin.erlang",
                    "text", "keyword.control.directive.define.erlang", "text",
          ...
          "#everything-else": [
            ...
            { include: "#function-call" }, { include: "#tuple" },
            { include: "#list" }, { include: "#binary" },
            { include: "#parenthesized-expression" }, { include: "#character" },
            { include: "#number" }, { include: "#atom" },
          ...
          "#variable": [{
            token:
              ["variable.other.erlang", "variable.language.omitted.erlang"],
  ...
  ace.define("ace/mode/erlang",
             [
               ...
               "ace/mode/erlang_highlight_rules", "ace/mode/folding/cstyle"
             ],
             function(e, t, n) {
               "use strict";
               ...
               r.inherits(u, i), function() {
                 this.lineCommentStart = "%", this.blockComment = null,
