ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop",
      "ace/mode/doc_comment_highlight_rules", "ace/mode/c_cpp_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      var
        ...
        u = function() {
          ...
          this.$rules = {
            start: [
              ...
              {
                token:
                  ["punctuation.definition.storage.type.objc", "punctuation"],
                regex: "(@selector)(\\s*\\()",
                next: "selectors"
              },
              {
          ...
          for (var u in r)
            this.$rules[u] ? this.$rules[u].push &&
  ...
  ace.define("ace/mode/objectivec",
             [
               ...
               "ace/mode/objectivec_highlight_rules", "ace/mode/folding/cstyle"
             ],
             function(e, t, n) {
               "use strict";
               var r = e("../lib/oop"), i = e("./text").Mode,
                   s =
                     e("./objectivec_highlight_rules").ObjectiveCHighlightRules,
