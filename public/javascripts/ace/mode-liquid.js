ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour",
      "ace/mode/behaviour/xml", "ace/token_iterator", "ace/lib/lang"
    ],
    function(e, t, n) {
      "use strict";
      function a(e, t) {
      ...
      var r = e("../../lib/oop"), i = e("../behaviour").Behaviour,
          ...
          o = e("../../token_iterator").TokenIterator, u = e("../../lib/lang"),
          f = function() {
            s.call(this),
              this.add(
                "autoBraceTagClosing", "insertion", function(e, t, n, r, i) {
                  if (i == "}") {
                    var s = n.getSelectionRange().start,
                        u = new o(r, s.row, s.column),
                        f = u.getCurrentToken() || u.stepBackward();
                    if (!f ||
                        !(f.value.trim() === "%" || a(f, "tag-name") ||
                          a(f, "tag-whitespace") || a(f, "attribute-name") ||
                          a(f, "attribute-equals") || a(f, "attribute-value")))
                      return;
      ...
      var
        ...
        s = e("./html_highlight_rules").HtmlHighlightRules, o = function() {
          ...
          var
            ...
            r = "forloop|tablerowloop", i = "assign",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
      "ace/mode/html", "ace/mode/html_completions", "ace/mode/behaviour/liquid",
      "ace/mode/liquid_highlight_rules", "ace/mode/matching_brace_outdent"
    ],
    function(e, t, n) {
      var r = e("../lib/oop"), i = e("./text").Mode, s = e("./html").Mode,
          ...
          l = function() {
            ...
            this.$behaviour = new u, this.$completer = new o
          };
      r.inherits(l, i), function() {
        this.blockComment = { start: "<!--", end: "-->" },
