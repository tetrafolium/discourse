ace.define("ace/mode/doc_comment_highlight_rules",
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop",
      "ace/mode/javascript_highlight_rules", "ace/mode/html_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      var
        ...
        s = e("./html_highlight_rules").HtmlHighlightRules, o = function() {
          ...
          e.forEach(
            ...
            this),
            this.embedTagRules((new i({ jsx: !1 })).getRules(), "cfjs-",
                               "cfscript"),
            this.normalizeRules()
        };
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
      "ace/mode/html", "ace/mode/coldfusion_highlight_rules"
    ],
    function(e, t, n) {
      "use strict";
      var
        r = e("../lib/oop"),
        i = e("../lib/lang"), s = e("./html").Mode,
