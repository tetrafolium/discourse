...
!function(e) {
  ...
  ace.define("ace/lib/oop", [], function(e, t, n) {
      ...
      for (;;) {
        ...
        case "/":
          ...
          A.tagName != L &&
            i.fatalError(
              "end tag name: " + L +
              " does not match the current start tagName: " + A.tagName),
      ...
      for (;;) {
        ...
        case '"':
          if (m === f) {
            ...
            d = e.slice(t, v).replace(/&#?\w+;/g, r), n.add(s, d, t),
        ...
        case ">":
          ...
          case a:
            m === a && (d = s),
              m == l ? (i.warning('attribute "' + d + '" missed quot(")!!'),
                        n.add(s, d.replace(/&#?\w+;/g, r), t))
                     : (i.warning('attribute "' + d + '" missed value!! "' + d +
                                  '" instead!!'),
                        n.add(d, d, t));
            break;
          case f:
        ...
        default:
          if (g <= " ") switch (m) {
            ...
            switch (m) {
            case a:
              i.warning('attribute "' + s + '" missed value!! "' + s +
                        '" instead!!'),
                n.add(s, s, t), t = v, m = u;
              break;
            case c:
    ...
    function y(e, t, n) {
      var r = e.tagName, i = null, s = n[n.length - 1].currentNSMap,
          o = e.length;
      while (o--) {
        var u = e[o], a = u.qName, f = u.value, l = a.indexOf(":");
        if (l > 0)
          var c = u.prefix = a.slice(0, l), h = a.slice(l + 1),
              p = c === "xmlns" && h;
        else
          h = a, c = null, p = a === "xmlns" && "";
        u.localName = h,
        p !== !1 &&
          (i == null && (i = {}, E(s, s = {})), s[p] = i[p] = f,
           u.uri = "http://www.w3.org/2000/xmlns/", t.startPrefixMapping(p, f))
      }
      var o = e.length;
      while (o--) {
        u = e[o];
        var c = u.prefix;
        c && (c === "xml" && (u.uri = "http://www.w3.org/XML/1998/namespace"),
              c !== "xmlns" && (u.uri = s[c]))
      }
      var l = r.indexOf(":");
      l > 0 ? (c = e.prefix = r.slice(0, l), h = e.localName = r.slice(l + 1))
    ...
    function b(e, t, n, r, i) {
      if (/^(?:script|textarea)$/i.test(n)) {
        ...
        if (/[&<]/.test(o))
          return /^script$/i.test(n) ? (i.characters(o, 0, o.length), s)
                                     : (o = o.replace(/&#?\w+;/g, r),
    ...
    function S(e, t, n, r) {
      ...
      case "-":
        if (e.charAt(t + 3) === "-") {
          var s = e.indexOf("-->", t + 4);
          return s > t ? (n.comment(e, t + 4, s - t - 4), s + 3)
      ...
      default:
        if (e.substr(t + 3, 6) == "CDATA[") {
          var s = e.indexOf("]]>", t + 9);
          return n.startCDATA(), n.characters(e, t + 9, s - t - 9),
                 n.endCDATA(), s + 3
        }
        var o = C(e, t), u = o.length;
        if (u > 1 && /!doctype/i.test(o[0][0])) {
          var a = o[1][0], f = u > 3 && /^public$/i.test(o[2][0]) && o[3][0],
              l = u > 4 && o[4][0], c = o[u - 1];
          return n.startDTD(a, f && f.replace(/^(['"])(.*?)\1$/, "$2"),
                            l && l.replace(/^(['"])(.*?)\1$/, "$2")),
    ...
    var
      ...
      i = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) +
                     "\u00b7\u0300-\u036f\\ux203F-\u2040]"),
      s = new RegExp("^" + r.source + i.source + "*(?::" + r.source + i.source +
                     "*)?$"),
      o = 0, u = 1, a = 2, f = 3, l = 4, c = 5, h = 6, p = 7;
    return d.prototype = {
      parse: function(e, t, n) {
        var r = this.domBuilder;
        r.startDocument(), E(t, t = {}), v(e, t, n, r, this.errorHandler),
          r.endDocument()
      }
    },
           T.prototype = {
    ...
    function B(e, t) {
      if (t instanceof Error)
        ...
        n = this, Error.call(this, w[e]), this.message = w[e],
    ...
    function Z(e, t, n) {
      ...
      i.previousSibling = o, s.nextSibling = n,
      o ? o.nextSibling = i : e.firstChild = i,
      n == null ? e.lastChild = s : n.previousSibling = s;
      do
        i.parentNode = e;
      while (i !== s && (i = i.nextSibling));
      return G(e.ownerDocument || e, e),
             t.nodeType == g && (t.firstChild = t.lastChild = null), t
    }
    function et(e, t) {
      var n = t.parentNode;
      if (n) {
      ...
      var r = e.lastChild;
      return t.parentNode = e, t.previousSibling = r, t.nextSibling = null,
             r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t,
             G(e.ownerDocument, e, t), t
    }
    function tt() {
      this._nsMap = {}
    }
    ...
    function dt(e, t) {
      switch (e.nodeType) {
      case u:
        var n = e.attributes, r = n.length, i = e.firstChild, o = e.tagName,
            h = s === e.namespaceURI;
        t.push("<", o);
        for (var y = 0; y < r; y++)
          dt(n.item(y), t);
    ...
    var s = "http://www.w3.org/1999/xhtml", o = {}, u = o.ELEMENT_NODE = 1,
        a = o.ATTRIBUTE_NODE = 2, f = o.TEXT_NODE = 3,
        l = o.CDATA_SECTION_NODE = 4, c = o.ENTITY_REFERENCE_NODE = 5,
        h = o.ENTITY_NODE = 6, p = o.PROCESSING_INSTRUCTION_NODE = 7,
        d = o.COMMENT_NODE = 8, v = o.DOCUMENT_NODE = 9,
        m = o.DOCUMENT_TYPE_NODE = 10, g = o.DOCUMENT_FRAGMENT_NODE = 11,
        y = o.NOTATION_NODE = 12, b = {}, w = {},
    ...
    i(F, j), q.prototype = {
      ...
      setNamedItemNS: function(e) {
        ...
        return n = this.getNamedItemNS(e.namespaceURI, e.localName),
               U(this._ownerElement, this, e, n), n
      },
    ...
    W.prototype = {
      ...
      createDocument: function(e, t, n) {
        var r = new J;
        r.implementation = this, r.childNodes = new j, r.doctype = n,
        n && r.appendChild(n);
        if (t) {
    ...
    r(o, X), r(o, X.prototype), J.prototype = {
      ...
      insertBefore: function(e, t) {
        ...
        return this.documentElement == null && e.nodeType == 1 &&
                 (this.documentElement = e),
               Z(this, e, t), e.ownerDocument = this, e
      },
      removeChild: function(e) {
      ...
      createElement: function(e) {
        var t = new tt;
        t.ownerDocument = this, t.nodeName = e, t.tagName = e,
        t.childNodes = new j;
      ...
      createProcessingInstruction: function(e, t) {
        var n = new ht;
        return n.ownerDocument = this, n.tagName = n.target = e,
               n.nodeValue = n.data = t, n
      },
      createAttribute: function(e) {
        var t = new nt;
        return t.ownerDocument = this, t.name = e, t.nodeName = e,
               t.localName = e, t.specified = !0, t
      },
      ...
      createElementNS: function(e, t) {
        ...
        return n.childNodes = new j, n.ownerDocument = this, n.nodeName = t,
               n.tagName = t, n.namespaceURI = e,
               r.length == 2 ? (n.prefix = r[0], n.localName = r[1])
                             : n.localName = t,
               i._ownerElement = n, n
      },
      createAttributeNS: function(e, t) {
        var n = new nt, r = t.split(":");
        return n.ownerDocument = this, n.nodeName = t, n.name = t,
               n.namespaceURI = e, n.specified = !0,
               r.length == 2 ? (n.prefix = r[0], n.localName = r[1])
                             : n.localName = t,
               n
      }
    ...
    i(tt, X), nt.prototype.nodeType = a, i(nt, X), rt.prototype = {
      data: "",
      substringData: function(e, t) {
        return this.data.substring(e, e + t)
      },
      appendData: function(e) {
        e = this.data + e, this.nodeValue = this.data = e,
    ...
    i(rt, X), it.prototype = {
      ...
      splitText: function(e) {
        ...
        t = t.substring(0, e), this.data = this.nodeValue = t,
    ...
    i(it, rt), st.prototype = { nodeName: "#comment", nodeType: d }, i(st, rt),
    ot.prototype = { nodeName: "#cdata-section", nodeType: l }, i(ot, rt),
    ut.prototype.nodeType = m, i(ut, X), at.prototype.nodeType = y, i(at, X),
    ft.prototype.nodeType = h, i(ft, X), lt.prototype.nodeType = c, i(lt, X),
    ct.prototype.nodeName = "#document-fragment", ct.prototype.nodeType = g,
    i(ct, X), ht.prototype.nodeType = p, i(ht, X),
    ...
    function o(e, t, n) {
      ...
      return n = n || {}, s("warning", "warn"), s("error", "warn", "warning"),
             s("fatalError", "warn", "warning", "error"), r
    }
    function u() {
      this.cdata = !1
    }
    ...
    function c(e, t) {
      e.currentElement ? e.currentElement.appendChild(t)
    ...
    return s.prototype
             .parseFromString =
             function(e, t) {
      var n = this.options, i = new r, s = n.domBuilder || new u,
          a = n.errorHandler, f = n.locator, l = n.xmlns || {},
          c = { lt: "<", gt: ">", amp: "&", quot: '"', apos: "'" };
      return f && s.setDocumentLocator(f),
             i.errorHandler = o(a, s, f), i.domBuilder = n.domBuilder || s,
             /\/x?html?$/.test(t) && (c.nbsp = "\u00a0", c.copy = "\u00a9",
  ...
  u.prototype = {
    ...
    startElement: function(e, t, n, r) {
      ...
      for (var u = 0; u < o; u++) {
        var e = r.getURI(u), f = r.getValue(u), n = r.getQName(u),
            l = i.createAttributeNS(e, n);
        l.getOffset && a(l.getOffset(1), l), l.value = l.nodeValue = f,
  ...
  "endDTD,startEntity,endEntity,attributeDecl,elementDecl,externalEntityDecl,internalEntityDecl,resolveEntity,getExternalSubset,notationDecl,unparsedEntityDecl"
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"),
        s = e("../worker/mirror").Mirror, o = e("./xml/dom-parser").DOMParser,
