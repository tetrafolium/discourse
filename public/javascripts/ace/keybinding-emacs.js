ace.define(
  "ace/occur",
  [
    "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search",
    "ace/edit_session", "ace/search_highlight", "ace/lib/dom"
  ],
  function(e, t, n) {
    "use strict";
    function a() {}
    ...
    r.inherits(a, s), function() {
      this.enter = function(e, t) {
        ...
        return this.displayOriginalContent(e), r && e.moveCursorToPosition(r),
               !0
        ...
        var n = this.matchingLines(e.session, t), r = n.map(function(e) {
          return e.content
            ...
            i = new o(r.join("\n"));
        i.$occur = this, i.$occurMatchingLines = n, e.setSession(i),
        ...
        this.highlight(i, t.re), i._emit("changeBackMarker")
  ...
  ace.define("ace/commands/occur_commands",
             [
               "require", "exports", "module", "ace/config", "ace/occur",
               "ace/keyboard/hash_handler", "ace/lib/oop"
             ],
             function(e, t, n) {
               function f() {}
  ...
  ace.define(
    ...
    [
      ...
      "ace/keyboard/hash_handler", "ace/commands/occur_commands"
    ],
    function(e, t, n) {
      function u(e) {
        this.$iSearch = e
      }
      var r = e("../config"), i = e("../lib/oop"),
      ...
      t.iSearchStartCommands =
        [
          ...
          },
          {
            ...
            exec: function(e, t) {
              e.execCommand(
                "iSearch", { jumpToFirstMatch: !0, useCurrentOrPrevSearch: !0 })
            },
            readOnly: !0
          },
          {
      ...
      t.iSearchCommands =
        [
          ...
          },
          {
            name: "searchBackward",
            bindKey:
              { win: "Ctrl-R|Ctrl-Shift-K", mac: "Ctrl-R|Command-Shift-G" },
            exec: function(e, t) {
          ...
          },
          {
            ...
            bindKey: "Ctrl-space",
            exec: function(e) {
              var t = e.$editor, n = t.session.$isearchHighlight,
          ...
          return e.readOnly = !0, e.isIncrementalSearchCommand = !0,
                 e.scrollIntoView = "animate-cursor", e
        }),
        ...
        this.attach = function(e) {
          ...
          s.call(this, t.iSearchCommands, e.commands.platform),
            this.$commandExecHandler =
              e.commands.addEventListener("exec", function(t) {
                ...
                return e.renderer.scrollCursorIntoView(null, .5),
                       e.renderer.animateScrolling(r), i
              })
  ...
  ace.define(
    ...
    [
      "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search",
      "ace/search_highlight", "ace/commands/incremental_search_commands",
      "ace/lib/dom", "ace/commands/command_manager", "ace/editor", "ace/config"
    ],
    function(e, t, n) {
      "use strict";
      function f() {
      ...
      function c(e) {
        ...
        return {
          expression: t.slice(n + 1, r), flags: t.slice(r + 1)
        }
      }
      function h(e, t) {
        try {
      ...
      r.inherits(f, s), function() {
        this.activate = function(e, t) {
          ...
          this.$options.needle = "", this.$options.backwards = t,
          ...
          this.selectionFix(e), this.statusMessage(!0)
          ...
          var r = this.$editor.session, s = this.find(r),
              o = this.$editor.emacsMark ? !!this.$editor.emacsMark()
          ...
          return s && (n.backwards && (s = i.fromPoints(s.end, s.start)),
                       ...
                       e && (this.$currentPos = s.end), this.highlight(n.re)),
                 this.statusMessage(s), s
          ...
          return this.highlightAndFindWithNeedle(!1, function(e) {
            ...
            var t = c(e);
            return t.expression =
                     t.expression.substring(0, t.expression.length - 1),
                   p(t)
          })
        }, this.next = function(e) {
          return e = e || {}, this.$options.backwards = !!e.backwards,
          ...
          n += t.backwards ? "reverse-" : "", n += "isearch: " + t.needle,
            n += e ? "" : " (not found)", this.message(n)
  ...
  ace.define(
    ...
    [
      ...
      "ace/commands/incremental_search_commands", "ace/keyboard/hash_handler",
      "ace/lib/keys"
    ],
    function(e, t, n) {
      "use strict";
      ...
      t.handler = new s, t.handler.isEmacs = !0,
        ...
        o ||
          ...
          e.pushEmacsMark =
            ...
            n && this.session.$emacsMarkRing.push(n),
              !e || t ? this.setEmacsMark(e)
                      : this.session.$emacsMarkRing.push(e)
          },
          e.popEmacsMark =
            function() {
            var e = this.emacsMark();
            return e ? (this.setEmacsMark(null), e)
          ...
          e.emacsMarkForSelection =
            function(e) {
            var t = this.selection,
                n =
                  this.multiSelect ? this.multiSelect.getAllRanges().length : 1,
                r = t.index || 0, i = this.session.$emacsMarkRing,
                s = i.length - (n - r), o = i[s] || t.anchor;
            return e && i.splice(s, 1,
                                 "row" in e && "column" in e ? e : undefined),
                   o
          },
          e.on("click", l), e.on("changeSession", f),
          e.renderer.$blockCursor = !0, e.setStyle("emacs-mode"),
          e.commands.addCommands(d), t.handler.platform = e.commands.platform,
          e.$emacsModeHandler = this, e.addEventListener("copy", this.onCopy),
          e.addEventListener("paste", this.onPaste)
      }, t.handler.detach = function(e) {
        e.renderer.$blockCursor = !1, e.session.$selectLongWords = u,
        e.session.$useEmacsStyleLineStart = a,
        e.removeEventListener("click", l),
        e.removeEventListener("changeSession", f), e.unsetStyle("emacs-mode"),
      ...
      p.forEach(function(e) {
        ...
        t.handler
          ...
          n.$handlesEmacsOnCopy = !0, t.handler.commands.killRingSave.exec(n),
 ...
 t.handler.handleKeyboard =
   ...
   if (o == "c-" || e.count) {
     ...
     if (typeof u == "number" && !isNaN(u))
       return e.count = Math.max(e.count, 0) || 0, e.count = 10 * e.count + u, {
         command: "null"
       }
   }
 ...
 t.emacsKeys = {
   ...
   "Home|C-a":
     { command: "goorselect", args: ["gotolinestart", "selecttolinestart"] },
   "End|C-e":
 ...
 t.handler.bindKeys(t.emacsKeys), t.handler.addCommands({
   recenterTopBottom: function(e) {
     ...
     Math.abs(n.top - i) < 2
       ? i = n.top - r
       : Math.abs(n.top - i - r * .5) < 2 ? i = n.top : i = n.top - r * .5,
   ...
   setMark: {
     exec: function(e, t) {
       ...
       var n = e.emacsMark(), r = e.selection.getAllRanges(),
           i = r.map(function(e) {
             return {
               row: e.start.row, column: e.start.column
             }
           }),
 ...
 t.handler.addCommands(i.iSearchStartCommands);
      ...
      d.yank.isYank = !0, d.yankRotate.isYank = !0, t.killRing = {
        ...
        get: function(e) {
          return e = e || 1,
                 this.$data.slice(this.$data.length - e, this.$data.length)
                   .reverse()
                   .join("\n")
        },
        pop: function() {
