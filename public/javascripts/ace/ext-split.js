ace.define(
  ...
  [
    ...
    "ace/lib/event_emitter", "ace/editor", "ace/virtual_renderer",
    "ace/edit_session"
  ],
  function(e, t, n) {
    "use strict";
    var r = e("./lib/oop"), i = e("./lib/lang"),
        s = e("./lib/event_emitter").EventEmitter, o = e("./editor").Editor,
        u = e("./virtual_renderer").VirtualRenderer,
        a = e("./edit_session").EditSession, f = function(e, t, n) {
          this.BELOW = 1, this.BESIDE = 0, this.$container = e, this.$theme = t,
          this.$splits = 0, this.$editorCSS = "", this.$editors = [],
          this.$orientation = this.BESIDE, this.setSplits(n || 1),
      ...
      r.implement(this, s), this.$createEditor = function() {
        ...
        if (e > this.$splits) {
          while (this.$splits < this.$editors.length && this.$splits < e)
            ...
            t.setFontSize(this.$fontSize), this.$splits++;
          while (this.$splits < e)
            this.$createEditor(), this.$splits++
        } else
          while (this.$splits > e)
            t = this.$editors[this.$splits - 1],
            this.$container.removeChild(t.container), this.$splits--;
        this.resize()
        ...
        return t.setUndoManager(n), t.setTabSize(e.getTabSize()),
               ...
               t.setWrapLimitRange(e.$wrapLimitRange.min,
        ...
        if (this.$orientation == this.BESIDE) {
          ...
          for (var i = 0; i < this.$splits; i++)
            n = this.$editors[i], n.container.style.width = r + "px",
            n.container.style.top = "0px",
            n.container.style.left = i * r + "px",
            n.container.style.height = t + "px", n.resize()
        } else {
          var s = t / this.$splits;
          for (var i = 0; i < this.$splits; i++)
            n = this.$editors[i], n.container.style.width = e + "px",
            n.container.style.top = i * s + "px",
            n.container.style.left = "0px", n.container.style.height = s + "px",
            n.resize()
        }
      }
    }).call(f.prototype),
  ...
  ace.define("ace/ext/split", ["require", "exports", "module", "ace/split"],
             function(e, t, n) {
               "use strict";
               n.exports = e("../split")
             });
