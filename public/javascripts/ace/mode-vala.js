ace.define(
      ...
      i = e("./text_highlight_rules").TextHighlightRules, s = function() {
        this.$rules = {
          start: [
            {
              token: [
                "meta.using.vala", "keyword.other.using.vala",
                "meta.using.vala", "storage.modifier.using.vala",
                "meta.using.vala", "punctuation.terminator.vala"
              ],
              regex: "^(\\s*)(using)\\b(?:(\\s*)([^ ;$]+)(\\s*)((?:;)?))?"
            },
            { include: "#code" }
          ...
          "#class-body": [
            ...
            { include: "#enums" }, { include: "#methods" },
            { include: "#annotations" }, { include: "#storage-modifiers" },
            { include: "#code" }
          ],
          "#code": [
            { include: "#comments" }, { include: "#class" }, {
  ...
  ace.define("ace/mode/vala",
             [
               ...
               "ace/tokenizer", "ace/mode/vala_highlight_rules",
             ...
             function(e, t, n) {
               ...
               var r = e("../lib/oop"), i = e("./text").Mode,
                   ...
                   c = function() {
                     this.HighlightRules = o, this.$outdent = new l,
