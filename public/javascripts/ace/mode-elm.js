ace.define(
        ...
        var e = this.createKeywordMapper({
          keyword:
            "as|case|class|data|default|deriving|do|else|export|foreign|hiding|jsevent|if|import|in|infix|infixl|infixr|instance|let|module|newtype|of|open|then|type|where|_|port|\u03bb"
                                         ...
                                         "identifier"),
            t = /\\(\d+|['"\\&trnbvf])/, n = /[a-z_]/.source,
            r = /[A-Z]/.source, i = /[a-z_A-Z0-9']/.source;
        this.$rules = {
          start: [
            ...
            { token: "operator.punctuation", regex: /[,;`]/}, {
              regex: r + i + "+\\.?",
              token: function(e) {
                return e[e.length - 1] == "." ? "entity.name.function"
                                              : "constant.language"
              }
            },
            {
            ...
            { token: e, regex: "[\\w\\xff-\\u218e\\u2455-\\uffff]+\\b" }, {
              ...
              onMatch: function(e, t, n) {
                return this.next =
                         e.length == 2 ? "blockComment" : "docComment",
                       this.token
              }
            },
            {
  ...
  ace.define("ace/mode/elm",
             [
               ...
               "ace/mode/elm_highlight_rules", "ace/mode/folding/cstyle"
             ],
             function(e, t, n) {
               "use strict";
