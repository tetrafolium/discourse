ace.define(
  ...
  [
    ...
    "ace/config", "ace/lib/dom", "ace/lib/lang"
  ],
  function(e, t, n) {
    "use strict";
    function f(e) {
    ...
    f.prototype.cloneNode = function() {
      ...
      return this.textContent && e.push(this.textContent),
             this.type != "fragment" && e.push("</", this.type, ">"), e.join("")
    };
    var l = {
    ...
    var h = function(e, t, n) {
      ...
      if (e.firstElementChild) {
        ...
        o = e.textContent, t.trim && (o = o.trim());
      h.render(o, i, s, t.firstLineNumber, !t.showGutter, function(t) {
        ...
        for (var i = 0; i < a.length; i += 2) {
          var s = t.session.doc.indexToPosition(a[i]), o = a[i + 1],
              f = r.children[s.row];
          f && f.appendChild(o)
        }
        n && n()
    ...
    h.render = function(e, t, n, i, s, u) {
      ...
      var l;
      return t && typeof t == "object" && !t.getTokenizer &&
               (l = t, t = l.path),
             typeof t == "string" && (a++, o.loadModule(["mode", t],
                                                        function(e) {
                                                          if (!f[t] || l)
                                                            f[t] =
                                                              new e.Mode(l);
      ...
      for (var d = 0; d < f; d++) {
        ...
        if (!o) {
          ...
          m.className = "ace_gutter ace_gutter-cell", m.textContent = "",
          v.appendChild(m)
        }
