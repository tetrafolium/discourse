...
Array.prototype.forEach ||
  ...
  Array.prototype.reduceRight || (Array.prototype.reduceRight = function(t) {
    var n = F(this), r = g && a(this) == "[object String]" ? this.split("") : n,
        i = r.length >>> 0;
    if (a(t) != "[object Function]")
      throw new TypeError(t + " is not a function");
    if (!i && arguments.length == 1)
...
"use strict";
e("./regexp"), e("./es5-shim"),
  typeof Element != "undefined" && !Element.prototype.remove &&
...
t.isWin = r == "win",
  ...
  t.isIOS && (t.isMac = !0), t.isMobile = t.isIPad || t.isAndroid
             }),
...
t.buildDom =
  ...
  return l == 2 && Object.keys(f).forEach(function(e) {
    ...
    e === "class"
      ...
      : typeof t == "function" || e == "value"
          ? a[e] = t
          : e === "ref" ? n && (n[t] = a) : t != null && a.setAttribute(e, t)
  }),
         t && t.appendChild(a), a
},
  t.getDocumentHead =
  ...
  t.createElement =
    function(e, t) {
    return document.createElementNS ? document.createElementNS(t || i, e)
  ...
  t.importCssString =
    ...
    u.appendChild(o.createTextNode(n)), r && (u.id = r),
      s == o && (s = t.getDocumentHead(o)), s.insertBefore(u, s.firstChild)
  },
  ...
  t.HAS_CSS_ANIMATION = !1, t.HAS_CSS_TRANSFORMS = !1,
  t.HI_DPI = r.isWin
...
if (typeof document != "undefined") {
  ...
  t.HI_DPI && s.style.transform !== undefined && (t.HAS_CSS_TRANSFORMS = !0),
    !r.isEdge && typeof s.style.animationName != "undefined" &&
...
var r = e("./oop"), i = function() {
  ...
  return r.mixin(e, e.MODIFIER_KEYS), r.mixin(e, e.PRINTABLE_KEYS),
         ...
         e.enter = e["return"], e.escape = e.esc, e.del = e["delete"],
         e[173] = "-", function() {
...
function a(e, t, n) {
  ...
  if (!i.isMac && s) {
    t.getModifierState &&
      (t.getModifierState("OS") || t.getModifierState("Win")) && (a |= 8);
    if (s.altGr) {
      if ((3 & a) == 3) return;
      s.altGr = 0
    }
...
t.addListener = function(e, t, n) {
  ...
  function i(e) {
    n && n(e), r && r(e), t.removeListener(document, "mousemove", n, !0),
  ...
  t.addListener(e, "touchstart", function(e) {
    ...
    var s = t[0];
    e.wheelX = r - s.clientX, e.wheelY = i - s.clientY, r = s.clientX,
    i = s.clientY, n(e)
  })
...
var u = !i.isMac || !i.isOpera || "KeyboardEvent" in window ? function(e) {
  ...
  return 0 | (e.metaKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.shiftKey ? 4 : 0) |
         (e.ctrlKey ? 8 : 0)
};
t.getModifierString = function(e) {
  ...
  if (i.isOldGecko || i.isOpera && !("KeyboardEvent" in window)) {
    ...
    r(e, "keydown", function(e) {
      ...
      u && (e.ctrlKey || e.altKey || e.shiftKey || e.metaKey) &&
...
t.$idleBlocked = !1,
  ...
  t.blockIdle =
    ...
    t.$idleBlockId && clearTimeout(t.$idleBlockId),
      t.$idleBlocked = !0, t.$idleBlockId = setTimeout(function() {
                             t.$idleBlocked = !1
                           }, e || 100)
  },
  t.nextFrame =
...
this.isEqual = function(e) {
  ...
  return this.end.row == e && this.end.column == t
           ? 1
           : this.start.row == e && this.start.column == t ? -1
                                                           : this.compare(e, t)
...
var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"),
    o = e("../lib/lang"), u = i.isChrome<18, a = i.isIE, f = i.isChrome>63,
    l = 400, c = e("../lib/keys"), h = c.KEY_MODS, p = i.isIOS,
    d = p ? /\s/ : /\n/, v = function(e, t) {
      function W() {
        x = !0, n.blur(), n.focus(), x = !1
      }
      function V(e) {
        e.keyCode == 27 && n.value.length < n.selectionStart &&
          (g || (T = n.value), N = C = -1, A()),
          X()
      }
      function J() {
      ...
      n.className = "ace_text-input", n.setAttribute("wrap", "off"),
      n.setAttribute("autocorrect", "off"),
      n.setAttribute("autocapitalize", "off"), n.setAttribute("spellcheck", !1),
      ...
      r.addListener(n, "blur", function(e) {
        ...
        if (t) {
          ...
          while (s && s.nodeType == 1)
            i.push(s), s.setAttribute("ace_nocontext", !0),
              !s.parentElement &&s.getRootNode ? s = s.getRootNode().host
                                               : s = s.parentElement
        }
      ...
      var A = p ? function(e) {
        ...
        if (!k && !D) return;
        g = !0;
        var e = t.selection, r = e.getRange(), i = e.cursor.row,
            s = r.start.column, o = r.end.column, u = t.session.getLine(i);
        if (r.start.row != i) {
          var a = t.session.getLine(i - 1);
          s = r.start.row < i - 1 ? 0 : s, o += a.length + 1, u = a + "\n" + u
        } else if (r.end.row != i) {
          var f = t.session.getLine(i + 1);
          o = r.end.row > i + 1 ? f.length : o, o += u.length + 1,
          u = u + "\n" + f
        }
        u.length > l &&
      ...
      k && t.onFocus();
      var O = function(e) {
        return e.selectionStart === 0 && e.selectionEnd >= T.length &&
               e.value === T && T && e.selectionEnd !== C
      }, M = function(e) {
        if (g) return;
      ...
      var D = !1, P = function(e, r) {
        ...
        var i = n.selectionStart, s = n.selectionEnd, o = N, u = T.length - C,
            a = e, f = e.length - i, l = e.length - s, c = 0;
        while (o > 0 && T[c] == e[c])
          c++, o--;
        a = a.slice(c), c = 1;
        while (u > 0 && T.length - c > N - 1 &&
        ...
        B(e, s) ? (p && (A(s), v = s,
                ...
                : (v = !0, n.value = s, n.select(), setTimeout(function() {
      ...
      r.addCommandKeyListener(n, t.onCommandKey.bind(t)),
        r.addListener(n, "select", M), r.addListener(n, "input", H),
        r.addListener(n, "cut", F), r.addListener(n, "copy", I),
      ...
      var R = function(e) {
        ...
        g.markerRange = r, g.selectionStart = N, t.onCompositionStart(g),
        g.useTextareaForIME
          ? (n.value = "", T = "", N = 0, C = 0)
        ...
        if (g.useTextareaForIME)
          ...
          var e = n.value;
          P(e), g.markerRange &&
                  (g.context && (g.markerRange.start.column = g.selectionStart =
      ...
      r.addListener(n, "compositionstart", R),
        r.addListener(n, "compositionupdate", U), r.addListener(n, "keyup", V),
        r.addListener(n, "keydown", X), r.addListener(n, "compositionend", z),
        this.getElement = function() {
          ...
          D = !0, A(), t._emit("nativecontextmenu", { target: t, domEvent: e }),
          this.moveToMouse(e, !0)
        }, this.moveToMouse = function(e, o) {
          b || (b = n.style.cssText),
            n.style.cssText = (o ? "z-index:100000;" : "") +
                              (i.isIE ? "opacity:0.1;" : "") +
                              "text-indent: -" +
                              (N + C) * t.renderer.characterWidth * .5 + "px;";
          ...
          t.renderer.$keepTextAreaAtCursor &&
            (t.renderer.$keepTextAreaAtCursor = null),
            clearTimeout($), i.isWin && r.capture(t.container, h, J)
      ...
      r.addListener(n, "mouseup", K),
        ...
        r.addListener(n, "contextmenu", K), p && Q(e, t, n)
    };
t.TextInput = v
             }),
...
this.onMouseDown =
  ...
  return this.captureMouse(e), this.startSelect(n, e.domEvent._clicks > 1),
         e.preventDefault()
},
  this.startSelect =
    function(e, t) {
    ...
    this.mousedownEvent.getShiftKey() ? n.selection.selectToPosition(e)
                                      : t || n.selection.moveToPosition(e),
      t || this.select(),
      n.renderer.scroller.setCapture && n.renderer.scroller.setCapture(),
      n.setStyle("ace_selecting"), this.setState("select")
  },
  this.select =
    function() {
    var e, t = this.editor,
  ...
  this.focusWait = function() {
    ...
    i ? (i.isEmpty() && (i.start.column--, i.end.column++),
         this.setState("select"))
      : (i = n.selection.getWordRange(t.row, t.column),
         this.setState("selectByWords")),
      this.$clickSelection = i, this.select()
    ...
    e.getShiftKey() && e.wheelY && !e.wheelX &&
    ...
    var n = this.$lastScroll, r = e.domEvent.timeStamp, i = r - n.t,
        o = i ? e.wheelX / i : n.vx, u = i ? e.wheelY / i : n.vy;
    ...
    if (f)
      ...
      var l = Math.abs(o) <= 1.5 * Math.abs(n.vx) &&
...
this.$init = function() {
  return this.$element = i.createElement("div"),
         ...
         this.$parentNode.appendChild(this.$element), this.$element
}, this.getElement = function() {
...
function u(e) {
  function l() {
    ...
    if (f == s) return;
    f = s.text.join("<br/>"), i.setHtml(f), i.show(),
    t._signal("showGutterTooltip", i), t.on("mousewheel", c);
  ...
  function c() {
    o && (o = clearTimeout(o)),
      f && (i.hide(), f = null, t._signal("hideGutterTooltip", i),
...
i.inherits(a, o), function() {
  this.setPosition = function(e, t) {
    ...
    e += 15, t += 15, e + i > n && (e -= e + i - n), t + s > r && (t -= 20 + s),
...
function f(e) {
  ...
  function N(e, n) {
    ...
    h || v && !m ? E ? r - E >= o && t.renderer.scrollCursorIntoView(c) : E = r
                 : E = null
  }
  function C() {
    var e = g;
  ...
  function k() {
    ...
    t.clearSelection(),
    t.isFocused() && t.renderer.$cursorLayer.setBlinking(!1), clearInterval(v),
    C(), v = setInterval(C, 20), y = 0, i.addListener(document, "mousemove", O)
  }
  function L() {
    clearInterval(v), t.session.removeMarker(h),
      h = null, t.selection.fromOrientedRange(m),
      t.isFocused() && !w &&
        t.renderer.$cursorLayer.setBlinking(!t.getReadOnly()),
      m = null, g = null, y = 0, E = null, S = null,
  ...
  this.onDragStart =
    ...
    s.isOpera && t.container.removeChild(n), i.clearData(),
  ...
  this.onDragEnter =
    ...
    return p = e.clientX, d = e.clientY, h || k(), y++,
           e.dataTransfer.dropEffect = b = _(e), i.preventDefault(e)
  },
  this.onDragOver =
    function(e) {
    if (t.getReadOnly() || !M(e.dataTransfer)) return;
    return p = e.clientX, d = e.clientY, h || (k(), y++),
           A !== null && (A = null), e.dataTransfer.dropEffect = b = _(e),
           i.preventDefault(e)
  },
  this.onDragLeave =
    function(e) {
  ...
  this.onDrop =
    ...
    if (w) switch (b) {
      case "move":
        m.contains(g.row, g.column) ? m = { start: g, end: g }
                                    : m = t.moveText(m, g);
        break;
      case "copy":
        m = t.moveText(m, g, !0)
...
this.dragWait = function() {
  ...
  e.draggable = !1, this.startSelect(this.mousedownEvent.getDocumentPosition()),
  this.selectEnd()
  ...
  t.draggable = !0, e.renderer.$cursorLayer.setBlinking(!1),
...
r._emit = r._dispatchEvent = function(e, t) {
  ...
  t.type || (t.type = e), t.stopPropagation || (t.stopPropagation = i),
    t.preventDefault || (t.preventDefault = s), n = n.slice();
...
function u(e, t) {
  var n = new Error(e);
  n.data = t, typeof console == "object" && console.error && console.error(n),
  setTimeout(function() {
    throw n
  })
}
...
r.implement(this, i), this.defineOptions = function(e, t, n) {
  ...
  r[t] &&
    (r.forwardTo ? this.setDefaultValue(r.forwardTo, t, n) : r[t].value = n)
  ...
  ace.define("ace/config",
             [
               ...
               "ace/lib/net", "ace/lib/app_config"
             ],
             function(e, t, n) {
"no use strict";
function l(r) {
  ...
  s && (i.base = i.base || s, i.packaged = !0),
    i.basePath = i.base, i.workerPath = i.workerPath || i.base,
    i.modePath = i.modePath || i.base, i.themePath = i.themePath || i.base,
    delete i.base;
  for (var w in i)
...
var f = function() {
  !a.basePath && !a.workerPath && !a.modePath && !a.themePath &&
...
var r = e("../lib/event"), i = e("../lib/useragent"),
    ...
    l = function(e) {
      ...
      var n = function(t) {
        var n = !document.hasFocus || !document.hasFocus() ||
                !e.isFocused() && document.activeElement ==
      ...
      r.addListener(f, "mousedown",
        ...
        r.addListener(f, "dblclick",
                      this.onMouseEvent.bind(this, "gutterdblclick")),
        r.addListener(f, "mousemove",
                      this.onMouseEvent.bind(this, "guttermousemove")),
        r.addListener(u, "mousedown", n), r.addListener(f, "mousedown", n),
        i.isIE && e.renderer.scrollBarV &&
...
this.onMouseEvent = function(e, t) {
  ...
  var o = this, a = function(e) {
    ...
    o.mouseEvent = new u(e, o.editor), o.$mouseMoved = !0
  }, f = function(e) {
    n.off("beforeEndOperation", c), clearInterval(h), l(),
      o[o.state + "End"] && o[o.state + "End"](e),
      o.state = "",
      s.$keepTextAreaAtCursor == null &&
        (s.$keepTextAreaAtCursor = !0, s.$moveTextAreaToCursor()),
      o.isMousePressed = !1, o.$onCaptureMouseMove = o.releaseMouse = null,
      e && o.onMouseEvent("mouseup", e), n.endOperation()
  }, l = function() {
  ...
  var c = function(e) {
    ...
    n.curOp.command.name && n.curOp.selectionChanged &&
      (o[o.state + "End"] && o[o.state + "End"](), o.state = "",
       o.releaseMouse())
  };
...
var r = e("../lib/keys"), i = e("../lib/event"), s = function(e) {
  this.$editor = e, this.$data = { editor: e }, this.$handlers = [],
  ...
  for (var a = this.$handlers.length; a--;) {
    ...
    s.command == "null" ? o = !0
                        : o = u.exec(s.command, this.$editor, s.args, r),
                          o && r && e != -1 && s.passEvent != 1 &&
                            s.command.passEvent != 1 && i.stopEvent(r);
    if (o) break
  }
  return !o && e == -1 &&
           (s = { command: "insertstring" },
            o = u.exec("insertstring", this.$editor, t)),
         o && this.$editor._signal &&
...
"use strict";
function F(e, t, n, r) {
  var i = s ? d : p, c = null, h = null, v = null, m = 0, g = null, y = null,
      b = -1, w = null, E = null, T = [];
  if (!r)
    for (w = 0, r = []; w < n; w++)
      r[w] = R(e[w]);
  o = s, u = !1, a = !1, f = !1, l = !1;
  for (E = 0; E < n; E++) {
    c = m, T[E] = h = q(e, r, T, E), m = i[c][h], g = m & 240, m &= 15,
    t[E] = v = i[m][5];
    if (g > 0)
      if (g == 16) {
        for (w = b; w < E; w++)
...
function q(e, t, n, r) {
  ...
  case N:
    return E;
  case C:
    if (r < 1 || r + 1 >= t.length || (o = n[r - 1]) != b && o != w ||
        (c = t[r + 1]) != b && c != w)
      return E;
...
var r = ["\u0621", "\u0641"], i = ["\u063a", "\u064a"], s = 0, o = 0, u = !1,
    a = !1, f = !1, l = !1, c = !1, h = !1,
    p =
      [
        [0, 3, 0, 1, 0, 0, 0], [0, 3, 0, 1, 2, 2, 0], [0, 3, 0, 17, 2, 0, 1],
        [0, 3, 5, 5, 4, 1, 0], [0, 3, 21, 21, 4, 0, 1], [0, 3, 5, 5, 4, 2, 0]
      ],
    d =
      [
    ...
    v = 0, m = 1, g = 0, y = 1, b = 2, w = 3, E = 4, S = 5, x = 6, T = 7, N = 8,
    C = 9, k = 10, L = 11, A = 12, O = 13, M = 14, _ = 15, D = 16, P = 17,
    H = 18,
    B =
      [
        H, H, H, H, H, H, H, H, H, x, S, x, N, S, H, H, H, H, H, H, H, H, H, H,
        H, H, H, H, S, S, S, x, N, E, E, L, L, L, E, E, E, E, E, k, C, k, C, C,
        b, b, b, b, b, b, b, b, b, b, C, E, E, E, E, E, E, g, g, g, g, g, g, g,
        g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, E, E, E, E, E,
        E, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g, g,
        g, g, g, E, E, E, E, H, H, H, H, H, H, S, H, H, H, H, H, H, H, H, H, H,
        H, H, H, H, H, H, H, H, H, H, H, H, H, H, H, H, C, E, L, L, L, L, E, E,
        E, E, g, E, E, H, E, E, L, L, b, b, E, g, E, E, E, b, g, E, E, E, E, E
      ],
    j = [
      N, N, N, N, N, N, N, N, N, N, N, H, H, H, g, y, E, E, E, E, E, E, E, E,
      E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, N, S, O, M, _, D, P, C,
      L, L, L, L, L, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, C, E, E, E,
      E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, E, N
    ];
t.L = g, t.R = y, t.EN = b, t.ON_R = 3, t.AN = 4, t.R_H = 5, t.B = 6, t.RLE = 7,
         t.DOT = "\u00b7", t.doBidiReorder = function(e, n, r) {
           if (e.length < 2) return {};
           var i = e.split(""), o = new Array(i.length),
               u = new Array(i.length), a = [];
           ...
           for (var f = 0; f < o.length; f++)
             u[f] = a[o[f]];
           return {
             logicalFromVisual: o, bidiLevels: u
           }
  ...
  ace.define(
    ...
    function(e, t, n) {
"use strict";
var r = e("./lib/bidiutil"), i = e("./lib/lang"),
    s = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/, o = function(e) {
      this.session = e, this.bidiMap = {}, this.currentRow = null,
      this.bidiUtil = r, this.charWidths = [], this.EOL = "\u00ac",
      this.showInvisibles = !0, this.isRtlDir = !1, this.line = "",
      this.wrapIndent = 0, this.EOF = "\u00b6", this.RLE = "\u202b",
      this.contentWidth = 0, this.fontMetrics = null, this.rtlLineOffset = 0,
      this.wrapOffset = 0, this.isMoveLeftOperation = !1,
      this.seenBidi = s.test(e.getValue())
    };
(function() {
this.isBidiRow = function(e, t, n) {
  return this.seenBidi ? (e !== this.currentRow &&
                            (this.currentRow = e, this.updateRowLine(t, n),
                             this.updateBidiMap()),
                          this.bidiMap.bidiLevels)
                       : !1
}, this.onChange = function(e) {
  this.seenBidi ? this.currentRow = null
  ...
  this.wrapIndent = 0, this.line = this.session.getLine(e),
    ...
    o && (t === undefined && (t = this.getSplitIndex()),
          t > 0 && o.length
            ? (this.wrapIndent = o.indent,
               ...
               this.line = t < o.length ? this.line.substring(o[t - 1], o[t])
  ...
  this.charWidths[r.B] = this.charWidths[r.RLE] = 0, this.currentRow = null
  ...
  return e != undefined ? this.session.getLine(e).charAt(0) == this.RLE
                        : this.isRtlDir
  ...
  var t = 0, e = Math.max(e, 0), n = 0, r = 0, i = this.bidiMap.bidiLevels,
...
var r = e("./lib/oop"), i = e("./lib/lang"),
    ...
    u = function(e) {
      ...
      this.anchor = this.doc.createAnchor(0, 0), this.$silent = !1;
      var t = this;
      this.cursor.on("change", function(e) {
        t.$cursorChanged = !0, t.$silent || t._emit("changeCursor"),
...
r.implement(this, s), this.isEmpty = function() {
  ...
  this.$silent = !0, this.$cursorChanged = this.$anchorChanged = !1,
  this.anchor.setPosition(e, t), this.cursor.setPosition(n, r),
  this.$isEmpty = !o.comparePoints(this.anchor, this.cursor), this.$silent = !1,
  ...
  return i ? (n = i.start.row, r = i.end.row)
           : r = n,
             t === !0 ? new o(n, 0, r, this.session.getLine(r).length)
                      : new o(n, 0, r + 1, 0)
  ...
  var n =
        this.session.documentToScreenPosition(this.lead.row, this.lead.column),
      r;
  t === 0 &&
    (e !== 0 &&
     ...
     this.$desiredColumn ? n.column = this.$desiredColumn
                         : this.$desiredColumn = n.column);
  var i = this.session.screenToDocumentPosition(n.row + e, n.column, r);
  e !== 0 && t === 0 && i.row === this.lead.row &&
    i.column === this.lead.column && this.session.lineWidgets &&
    this.session.lineWidgets[i.row] && (i.row > 0 || e > 0) && i.row++,
  ...
  /[\uDC00-\uDFFF]/.test(i.charAt(t)) && i.charAt(t - 1) &&
    ...
    this.lead.setPosition(e, t), this.$keepDesiredColumnOnChange = !1,
...
var r = e("./config"), i = 2e3, s = function(e) {
  ...
  for (var t in this.states) {
    var n = this.states[t], r = [], i = 0,
        s = this.matchMappings[t] = { defaultToken: "text" }, o = "g", u = [];
        ...
        ? f.token.length == 1 || c == 1
            ...
            : c - 1 != f.token.length
                ? (this.reportError(
                   ...
                   f.token = f.token[0])
                : (f.tokenArray = f.token, f.token = null,
                   f.onMatch = this.$arrayTokens)
        : typeof f.token == "function" && !f.onMatch &&
...
this.$setMaxTokenCount = function(e) {
  ...
  if (e.indexOf("(?=") != -1) {
    ...
    e.replace(
      ...
      function(e, t, s, o, u, a) {
        return r ? r = u != "]"
                 : u ? r = !0
                     : o ? (n == i.stack && (i.end = a + 1, i.stack = -1), n--)
                         : s &&
  ...
  while (a = u.exec(e)) {
    ...
    for (var y = 0; y < a.length - 2; y++) {
      ...
      d = s[o[y]], d.onMatch ? p = d.onMatch(v, r, n, e) : p = d.token,
      d.next && (typeof d.next == "string" ? r = d.next : r = d.next(r, n),
                 s = this.states[r],
                 s || (this.reportError("state doesn't exist", r), r = "start",
                       s = this.states[r]),
                 o = this.matchMappings[r], l = m, u = this.regExps[r],
                 u.lastIndex = m),
...
this.addRules = function(e, t) {
  ...
  for (var n in e) {
    ...
    for (var i = 0; i < r.length; i++) {
      var s = r[i];
      if (s.next || s.onMatch)
        typeof s.next == "string" && s.next.indexOf(t) !== 0 &&
          (s.next = t + s.next),
          s.nextState && s.nextState.indexOf(t) !== 0 &&
  ...
  function i(s) {
    ...
    for (var u = 0; u < o.length; u++) {
      ...
      if (l && Array.isArray(l)) {
        var c = a.stateName;
        c || (c = a.token, typeof c != "string" && (c = c[0] || ""),
              r[c] && (c += n++)),
          r[c] = l, a.next = c, i(c)
      } else
        l == "pop" && (a.next = t);
      ...
      if (a.rules)
        for (var h in a.rules)
          r[h] ? r[h].push && r[h].push.apply(r[h], a.rules[h])
               : r[h] = a.rules[h];
      ...
      a.keywordMap &&
        (a.token = this.createKeywordMapper(
           a.keywordMap, a.defaultToken || "text", a.caseInsensitive),
...
this.stepBackward = function() {
  ...
  ace.define("ace/mode/behaviour/cstyle",
             [
               ...
               "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"
             ],
             function(e, t, n) {
"use strict";
var
  r = e("../../lib/oop"),
  i = e("../behaviour").Behaviour, s = e("../../token_iterator").TokenIterator,
  o = e("../../lib/lang"), u = ["text", "paren.rparen", "punctuation.operator"],
  a = ["text", "paren.rparen", "punctuation.operator", "comment"], f, l = {},
  c = { '"': '"', "'": "'" }, h = function(e) {
    var t = -1;
    e.multiSelect &&
    ...
    this.add("braces", "insertion", function(t, n, r, i, s) {
      ...
      if (s == "{") {
        ...
        if (d.isSaneInsertion(r, i))
          return /[\]\}\)]/.test(a[u.column]) || r.inMultiSelectMode ||
                     e && e.braces
        ...
        if (v == "}") {
          var m =
            i.$findOpeningBracket("}", { column: u.column + 1, row: u.row });
        ...
        if (s == "\n" || s == "\r\n") {
          ...
          if (v === "}") {
            var y =
              i.findMatchingBracket({ row: u.row, column: u.column + 1 }, "}");
            if (!y) return null;
      ...
      if (i == "(") {
        ...
        if (f == ")") {
          var l =
            r.$findOpeningBracket(")", { column: u.column + 1, row: u.row });
...
d.isSaneInsertion = function(e, t) {
  ...
  this.isAutoInsertedClosing(r, i, f.autoInsertedLineEnd[0]) ||
    ...
    f.autoInsertedRow = r.row, f.autoInsertedLineEnd = n + i.substr(r.column),
  ...
  this.isMaybeInsertedClosing(r, i) || (f.maybeInsertedBrackets = 0),
    ...
    f.maybeInsertedLineEnd = i.substr(r.column), f.maybeInsertedBrackets++
}, d.isAutoInsertedClosing = function(e, t, n) {
  return f.autoInsertedBrackets > 0 && e.row === f.autoInsertedRow &&
         n === f.autoInsertedLineEnd[0] &&
         t.substr(e.column) === f.autoInsertedLineEnd
}, d.isMaybeInsertedClosing = function(e, t) {
  return f.maybeInsertedBrackets > 0 && e.row === f.maybeInsertedRow &&
...
t.wordChars = String.fromCharCode.apply(null, s)
  ...
  ace.define("ace/mode/text",
             [
               "require", "exports", "module", "ace/config", "ace/tokenizer",
               "ace/mode/text_highlight_rules", "ace/mode/behaviour/cstyle",
               "ace/unicode", "ace/lib/lang", "ace/token_iterator", "ace/range"
             ],
             function(e, t, n) {
"use strict";
var r = e("../config"), i = e("../tokenizer").Tokenizer,
    s = e("./text_highlight_rules").TextHighlightRules,
    o = e("./behaviour/cstyle").CstyleBehaviour, u = e("../unicode"),
    a = e("../lib/lang"), f = e("../token_iterator").TokenIterator,
  ...
  this.toggleCommentLines = function(e, t, n, r) {
    ...
    if (!this.lineCommentStart) {
      ...
      var m = function(e, t) {
        ...
        if (!s || /\S/.test(e))
          b(e, u, u) ? i.insertInLine({ row: t, column: u }, y)
                     : i.insertInLine({ row: t, column: u }, c)
      }, g = function(e, t) {
        return p.test(e)
      }, b = function(e, t, n) {
    ...
    w(function(e, t) {
      var n = e.search(/\S/);
      n !== -1 ? (n < u && (u = n), o && !g(e, t) && (o = !1))
               : E > e.length && (E = e.length)
    }),
      u == Infinity && (u = E, s = !1, o = !1),
      l && u % f != 0 && (u = Math.floor(u / f) * f), w(o ? m : v)
    ...
    if (o && /comment/.test(o.type)) {
      ...
      h = i.start.length, c = n.start.row, t.insert(n.end, i.end),
      t.insert(n.start, i.start);
    a.start.row == c && (a.start.column += h),
      a.end.row == c && (a.end.column += h), t.selection.fromOrientedRange(a)
    ...
    for (var t in e)
      if (e[t]) {
        ...
        s || (r.$modes[i] = s = new n), r.$modes[t] || (r.$modes[t] = s),
          this.$embeds.push(t), this.$modes[t] = s
      }
    var o = [
...
function i(e, t) {
  return t.row >= 0 && t.row < e.length && t.column >= 0 &&
         t.column <= e[t.row].length
}
function s(e, t) {
  t.action != "insert" && t.action != "remove" &&
...
t.applyDelta = function(e, t, n) {
  ...
  case "insert":
    ...
    if (o.length === 1)
      ...
      e.splice.apply(e, u), e[r] = s.substring(0, i) + e[r],
                            e[r + t.lines.length - 1] += s.substring(i)
    }
    break;
  case "remove":
    var a = t.end.column, f = t.end.row;
    r === f ? e[r] = s.substring(0, i) + s.substring(a)
...
r.implement(this, i), this.getPosition = function() {
  ...
  return e >= this.document.getLength()
           ...
           : e < 0 ? (n.row = 0, n.column = 0)
                   : (n.row = e,
                      n.column = Math.min(this.document.getLine(n.row).length,
                                          Math.max(0, t))),
         t < 0 && (n.column = 0), n
}
}).call(s.prototype)
  ...
  ace.define("ace/document",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/apply_delta",
...
var r = e("./lib/oop"), i = e("./apply_delta").applyDelta,
    ...
    u = e("./anchor").Anchor, a = function(e) {
      ...
      e.length === 0
        ? this.$lines = [""]
        : Array.isArray(e) ? this.insertMergedLines({ row: 0, column: 0 }, e)
...
r.implement(this, s),
  ...
  "aaa".split(/a/).length === 0 ? this.$split =
                                    function(e) {
    return e.replace(/\r\n|\r/g, "\n").split("\n")
  }
                                : this.$split =
  ...
  this.$autoNewLine = "", this.$newLineMode = "auto",
  this.setNewLineMode = function(e) {
    ...
    return this.applyDelta({ start: n, end: r, action: "insert", lines: [t] },
                           !0),
           this.clonePos(r)
  }, this.clippedPos = function(e, t) {
    var n = this.getLength();
    e === undefined ? e = n
                    : e < 0 ? e = 0 : e >= n && (e = n - 1, t = undefined);
    ...
    var n = t == this.getLength() - 1 && e > 0, r = t < this.getLength() - 1,
        i = n ? e - 1 : e, s = n ? this.getLine(i).length : 0,
        u = r ? t + 1 : t, a = r ? 0 : this.getLine(u).length,
    ...
    if (n ? e.lines.length <= 1 && !e.lines[0]
    ...
    e.lines = n.slice(o), e.start.row = i + o, e.start.column = s,
    this.applyDelta(e, !0)
    ...
    for (var i = t || 0, s = n.length; i < s; i++) {
      e -= n[i].length + r;
      if (e < 0) return {
          row: i, column: e + n[i].length + r
        }
    }
    return {
      row: s - 1, column: e + n[s - 1].length + r
    }
...
r.implement(this, i), this.setTokenizer = function(e) {
  ...
  if (n === 0)
    ...
    var r = Array(n + 1);
    r.unshift(t, 1), this.lines.splice.apply(this.lines, r),
  ...
  if (e.action == "insert") {
    ...
    for (; o < u; o++) {
      ...
      if (a.end.row == r && a.end.column >= t.column) {
        ...
        a.end.column == t.column && l > 0 &&
          o<u - 1 && a.end.column>a.start.column &&
          a.end.column == s[o + 1].start.column && (a.end.column -= l),
...
s.inherits(o, i), function() {
  this.toString = function() {
    ...
    if (!this.range.containsRange(e))
      throw new Error("A fold can't intersect already existing fold" + e.range +
                      this.range);
    a(e, this.start);
...
function u() {
  ...
  this.addFold =
    ...
    if (u < f || u == f && a <= l - 2) {
      ...
      return r || (v = this.$addFoldLine(new i(this.$foldData, o))),
             ...
             this.$modified = !0,
             this._signal("changeFold", { data: o, action: "add" }), o
    }
  ...
  this.removeFold =
    ...
    this.$updating || (this.$useWrapMode ? this.$updateWrapData(n, r)
  ...
  this.getFoldDisplayLine =
    function(e, t, n, r, i) {
    r == null && (r = e.start.row), i == null && (i = 0),
      t == null && (t = e.end.row), n == null && (n = this.getLine(t).length);
    var s = this.doc, o = "";
  ...
  this.getCommentFoldRange =
    ...
    if (s && /^comment|string/.test(u)) {
      ...
      f.start.column = i.getCurrentTokenColumn() + 2, i = new o(this, e, t);
      if (n != -1) {
        var l = -1;
        do {
          s = i.stepForward();
      ...
      return f.end.row = i.getCurrentTokenRow(),
             f.end.column = i.getCurrentTokenColumn() + s.value.length - 2, f
    }
  },
  this.foldAll =
    function(e, t, n) {
  ...
  this.$foldStyle = "markbegin", this.setFoldStyle = function(e) {
    ...
    this.$foldMode = e, this.off("change", this.$updateFoldWidgets),
    ...
    if (!r) {
      ...
      i && /ace_fold-widget/.test(i.className) &&
    ...
    var t = e.data;
    t.first != t.last && this.foldWidgets.length > t.first &&
...
t.BracketMatch = s
  ...
  ace.define("ace/edit_session",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/lib/lang",
               "ace/bidihandler", "ace/config", "ace/lib/event_emitter",
             ...
             function(e, t, n) {
"use strict";
var r = e("./lib/oop"), i = e("./lib/lang"), s = e("./bidihandler").BidiHandler,
    o = e("./config"), u = e("./lib/event_emitter").EventEmitter,
    ...
    p = e("./search_highlight").SearchHighlight, d = function(e, t) {
      ...
      this.$foldData = [], this.id = "session" + ++d.$uid,
      ...
      this.setDocument(e),
        this.selection = new a(this), this.$bidiHandler = new s(this),
...
d.$uid = 0,
  function() {
    ...
    this.onChange =
      function(e) {
      this.$modified = !0, this.$bidiHandler.onChange(e),
      ...
      !this.$fromUndo && this.$undoManager &&
        (t && t.length &&
         ...
         this.mergeUndoDeltas = !0, this.$informUndoManager.schedule()),
    ...
    this.addGutterDecoration =
      ...
      this.$decorations[e] || (this.$decorations[e] = ""),
        this.$decorations[e] += " " + t, this._signal("changeBreakpoint", {})
    },
    ...
    this.addMarker =
      ...
      return r ? (this.$frontMarkers[i] = s, this._signal("changeFrontMarker"))
    ...
    this.addDynamicMarker =
      ...
      return e.id = n, e.inFront = !!t,
             t ? (this.$frontMarkers[n] = e, this._signal("changeFrontMarker"))
    ...
    this.$modes = o.$modes, this.$mode = null, this.$modeId = null,
    this.setMode =
      function(e, t) {
    ...
    this.$onChangeMode =
      ...
      this.bgTokenizer.setDocument(this.getDocument()),
        ...
        t || (e.attachToSession && e.attachToSession(this),
              ...
              this.$setFolding(e.foldingRules), this.bgTokenizer.start(0),
    ...
    this.$getUndoSelection =
      ...
      for (var o = 0; o < e.length; o++) {
        ...
        if (!u.start) continue;
        if (!r) {
          n(u) ? (r = l.fromPoints(u.start, u.end), s = !0)
               : (r = l.fromPoints(u.start, u.start), s = !1);
          continue
        }
        n(u)
          ? (i = u.start, r.compare(i.row, i.column) == -1 && r.setStart(i),
             i = u.end, r.compare(i.row, i.column) == 1 && r.setEnd(i), s = !0)
          : (i = u.start,
    ...
    this.$wrapLimit = 80, this.$useWrapMode = !1,
    ...
    this.setUseWrapMode = function(e) {
      ...
      if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t)
        this.$wrapLimitRange = { min: e, max: t }, this.$modified = !0,
      ...
      return r != this.$wrapLimit && r > 1
               ? (this.$wrapLimit = r, this.$modified = !0,
                  this.$useWrapMode &&
      ...
      var r = this.doc.getAllLines(), i = this.getTabSize(), o = this.$wrapData,
          u = this.$wrapLimit, a, f, l = e;
    ...
    this.$computeWrapSplits = function(e, r, i) {
      ...
      while (u <= e) {
        ...
        if (u + a > e || i >= p) break;
        u += a, i++,
          i > v && (i = d.end.row + 1, d = this.getNextFoldLine(i, d),
                    v = d ? d.start.row : Infinity),
      ...
      if (this.$useWrapMode) {
        ...
        y && (o = y[g], g > 0 && y.length &&
                          (m = y.indent, s = y[g - 1] || y[y.length - 1],
                           r = r.substring(s)))
      }
      return n !== undefined && this.$bidiHandler.isBidiRow(u + g, i, g) &&
      ...
      this.$getStringScreenWidth = function(t, n, r) {
        ...
        for (s = 0; s < t.length; s++) {
          i = t.charAt(s), i === "	" ? r += this.getScreenTabSize(r)
  ...
  o.defineOptions(d.prototype, "session", {
    ...
    wrapMethod: {
      set: function(e) {
        ...
        e != this.$wrapAsCode &&
          (this.$wrapAsCode = e, this.$useWrapMode && (this.$useWrapMode = !1,
...
this.set = function(e) {
  ...
  return n.forEach(function(e, n, i, o) {
    return r = new s(e, n, i, o), n == o && t.start && t.start.start &&
                                      t.skipCurrent != 0 && r.isEqual(t.start)
                                    ? (r = null, !1)
                                    : !0
  }),
         r
  ...
  var n = t.range,
      i = n ? e.getLines(n.start.row, n.end.row) : e.doc.getAllLines(), o = [],
      u = t.re;
  if (t.$isMultiLine) {
...
"use strict";
function o(e, t) {
  this.platform = t || (i.isMac ? "mac" : "win"), this.commands = {},
  this.commandKeyBinding = {}, this.addCommands(e), this.$singleCommand = !0
}
function u(e, t) {
...
u.prototype = o.prototype, function() {
  function e(e) {
    return typeof e == "object" && e.bindKey && e.bindKey.position ||
           (e.isDefault ? -100 : 0)
  }
  this.addCommand = function(e) {
    ...
    if (!n)
      ...
      Array.isArray(i[t]) ? (s = i[t].indexOf(n)) != -1 && i[t].splice(s, 1)
                          : i[t] = [i[t]],
...
var r = e("../lib/oop"), i = e("../keyboard/hash_handler").MultiHashHandler,
    s = e("../lib/event_emitter").EventEmitter, o = function(e, t) {
      i.call(this, t, e), this.byName = this.commands,
...
r.inherits(o, i), function() {
  r.implement(this, s), this.exec = function(e, t, n) {
    ...
    return i.returnValue = this._emit("exec", i), this._signal("afterExec", i),
           i.returnValue === !1 ? !1 : !0
...
t.commands = [
  ...
  },
  {
    name: "unfold",
    bindKey:
      o("Alt-Shift-L|Ctrl-Shift-F1", "Command-Alt-Shift-L|Command-Shift-F1"),
    exec: function(e) {
  ...
  {
    name: "backspace",
    bindKey: o("Shift-Backspace|Backspace",
  ...
  },
  {
    ...
    exec: function(e) {
      var t = e.selection.getRange();
      t.start.column = t.end.column = 0, t.end.row++,
  ...
  },
  {
    ...
    exec: function(e) {
      var t = e.selection.isBackwards(),
          n = t ? e.selection.getSelectionLead()
                : e.selection.getSelectionAnchor(),
          i = t ? e.selection.getSelectionAnchor()
  ...
  },
  {
    ...
    exec: function(e) {
      var t = e.session.doc.getLength() - 1,
          n = e.session.doc.getLine(t).length, r = e.selection.rangeList.ranges,
          i = [];
      r.length < 1 && (r = [e.selection.getRange()]);
      for (var o = 0; o < r.length; o++)
        o == r.length - 1 && (r[o].end.row !== t || r[o].end.column !== n) &&
          i.push(new s(r[o].end.row, r[o].end.column, t, n)),
          o === 0 ? (r[o].start.row !== 0 || r[o].start.column !== 0) &&
                      i.push(new s(0, 0, r[o].start.row, r[o].start.column))
                  : i.push(new s(r[o - 1].end.row, r[o - 1].end.column,
                                 r[o].start.row, r[o].start.column));
...
var r = e("./lib/oop"), i = e("./lib/dom"), s = e("./lib/lang"),
    ...
    y = e("./token_iterator").TokenIterator, b = e("./clipboard"),
    w = function(e, t, n) {
      var r = e.getContainerElement();
      this.container = r, this.renderer = e, this.id = "editor" + ++w.$uid,
      this.commands = new v(o.isMac ? "mac" : "win", m),
      typeof document == "object" &&
        (this.textInput = new u(e.getTextAreaContainer(), this),
         this.renderer.textarea = this.textInput.getElement(),
         this.$mouseHandler = new a(this), new f(this)),
      this.keyBinding = new l(this), this.$search = (new h).set({ wrap: !0 }),
      this.$historyTracker = this.$historyTracker.bind(this),
      this.commands.on("exec", this.$historyTracker),
      this.$initOperationListeners(),
      this._$emitInputEvent = s.delayedCall(function() {
        this._signal("input", {}), this.session && this.session.bgTokenizer &&
      ...
      this.setSession(t || n && n.session || new c("")), g.resetOptions(this),
...
w.$uid = 0, function() {
  ...
  this.startOperation =
    ...
    e || (this.previousCommand = null, e = {}), this.$opResetTimer.schedule(),
  ...
  this.endOperation =
    ...
    if (this.curOp) {
      ...
      this.curOp.selectionAfter = s, this.$lastSel = this.selection.toJSON(),
      this.session.getUndoManager().addSelection(s), this.prevOp = this.curOp,
      this.curOp = null
    }
  },
  ...
  this.$historyTracker =
    ...
    this.$mergeUndoDeltas != "always" &&
      Date.now() - this.sequenceStartTime > 2e3 && (r = !1),
      r ? this.session.mergeUndoDeltas = !0
  ...
  this.setSession =
    ...
    e ? (this.$onDocumentChange = this.onDocumentChange.bind(this),
         e.on("change", this.$onDocumentChange), this.renderer.setSession(e),
         ...
         this.onChangeMode(), this.onCursorChange(), this.onScrollTopChange(),
  ...
  this.$highlightTags =
    ...
    this.$highlightTagPending = !0, setTimeout(function() {
      ...
      var t = e.session;
      if (!t || !t.bgTokenizer) return;
      var n = e.getCursorPosition(), r = new y(e.session, n.row, n.column),
          i = r.getCurrentToken();
      ...
      if (u.value == "<") {
        do
          u = i, i = r.stepForward(),
          i && i.value === s && i.type.indexOf("tag-name") !== -1 &&
            (u.value === "<" ? o++ : u.value === "</" && o--);
        while (i && o >= 0)
      } else {
        do
          i = u, u = r.stepBackward(),
          i && i.value === s && i.type.indexOf("tag-name") !== -1 &&
            (u.value === "<" ? o++ : u.value === "</" && o--);
        while (u && o <= 0);
        r.stepForward()
      ...
      t.$tagHighlight && c != undefined && l.compareRange(c.range) !== 0 &&
        (t.removeMarker(t.$tagHighlight), t.$tagHighlight = null),
        t.$tagHighlight ||
  ...
  this.onFocus =
    ...
    this.renderer.visualizeFocus(), this._emit("focus", e)
  },
  this.onBlur =
    function(e) {
    if (!this.$isFocused) return;
    this.$isFocused = !1, this.renderer.hideCursor(),
    this.renderer.visualizeBlur(), this._emit("blur", e)
  },
  this.$cursorChange =
    function() {
  ...
  this.onDocumentChange =
    ...
    this.renderer.updateLines(e.start.row, n, t), this._signal("change", e),
  ...
  this.$updateHighlightActiveLine =
    ...
    if (this.$highlightActiveLine) {
      ...
      this.renderer.theme && this.renderer.theme.$selectionColorConflict &&
        !this.selection.isEmpty() && (t = !1),
        this.renderer.$maxLines && this.session.getLength() === 1 &&
          !(this.renderer.$minLines > 1) && (t = !1)
    }
  ...
  this.$getSelectionHighLightRegexp =
    ...
    var n = t.start.column, r = t.end.column, i = e.getLine(t.start.row),
        s = i.substring(n, r);
    if (s.length > 5e3 || !/[\w\d]/.test(s)) return;
    var o = this.$search.$assembleRegExp(
          { wholeWord: !0, caseSensitive: !0, needle: s }),
  ...
  this.getCopyText =
    function() {
    var e = this.getSelectedText(), t = this.session.doc.getNewLineCharacter(),
        n = !1;
  ...
  this.$handlePaste =
    ...
    if (!this.inMultiSelectMode || this.inVirtualSelectionMode)
      n ? r.insert({ row: this.selection.lead.row, column: 0 }, t)
        : this.insert(t);
    else if (n)
  ...
  this.insert =
    ...
    s && s.selection &&
      (s.selection.length == 2
         ...
         : this.selection.setSelectionRange(
             new p(i.row + s.selection[0], s.selection[1],
  ...
  this.sortLines =
    ...
    for (var r = e.first; r <= e.last; r++) {
      var s = t.getLine(r);
      i.start.row = r, i.end.row = r, i.end.column = s.length,
  ...
  this.modifyNumber =
    function(e) {
    var t = this.selection.getCursor().row,
        n = this.selection.getCursor().column, r = new p(t, n - 1, t, n),
  ...
  this.toggleWord = function() {
    ...
    n.match(/[A-Za-z0-9_]+/) && i.forEach(function(t, i) {
      a = u + t.length,
      o >= u && o <= a &&
        (n = t, f.selection.clearSelection(), f.moveCursorTo(e, u + r),
    ...
    for (var h = 0; h < l.length; h++) {
      var p = l[h];
      for (var d = 0; d <= 1; d++) {
        var v = +!d, m = n.match(new RegExp(
                       "^\\s?_?(" + s.escapeRegExp(p[d]) + ")\\s?$", "i"));
        if (m) {
          var g = n.match(new RegExp(
            "([_]|^|\\s)(" + s.escapeRegExp(m[1]) + ")($|\\s)", "g"));
          g &&
            (c = n.replace(new RegExp(s.escapeRegExp(p[d]), "i"), function(e) {
              ...
              return e.toUpperCase() == e
                       ...
                       : e.charAt(0).toUpperCase() == e.charAt(0) &&
                           (t = t.substr(0, 0) + p[v].charAt(0).toUpperCase() +
                                t.substr(1)),
                         t
            }), this.insert(c), c = "")
        }
    ...
    if (!i.inMultiSelectMode || this.inVirtualSelectionMode) {
      ...
      t && e == -1 && (r = 0), s.moveBy(r, 0), i.fromOrientedRange(s)
    } else {
      ...
      for (var l = 0; l < f; l++) {
        ...
        l--, u = this.session.$moveLines(h, p, t ? 0 : e),
             t && e == -1 && (c = l + 1);
        while (c <= l)
          o[c].moveBy(u, 0), c++;
        t || (u = 0), a += u
    ...
    var n = this.getCursorPosition(), r = new y(this.session, n.row, n.column),
    ...
    if (o === "bracket") {
      ...
      if (!h) {
        h = new p(r.getCurrentTokenRow(), r.getCurrentTokenColumn() + f - 1,
                  r.getCurrentTokenRow(), r.getCurrentTokenColumn() + f - 1),
        d = h.start;
      ...
      var v = s.value;
      h = new p(r.getCurrentTokenRow(), r.getCurrentTokenColumn() - 2,
                r.getCurrentTokenRow(), r.getCurrentTokenColumn() - 2);
      if (h.compare(n.row, n.column) === 0) {
        u = !1;
        do
          s = i, i = r.stepBackward(),
          i &&
            (i.type.indexOf("tag-close") !== -1 &&
               h.setEnd(r.getCurrentTokenRow(), r.getCurrentTokenColumn() + 1),
             s.value === v && s.type.indexOf("tag-name") !== -1 &&
               (i.value === "<" ? a[v]++ : i.value === "</" && a[v]--,
                a[v] === 0 && (u = !0)));
        while (i && !u)
      }
      s && s.type.indexOf("tag-name") &&
        (d = h.start,
         d.row == n.row && Math.abs(d.column - n.column) < 2 && (d = h.end))
    }
    d = h && h.cursor || d,
    d && (e ? h && t ? this.selection.setRange(h)
    ...
    return n ? (this.$tryReplace(n, e) && (r = 1),
                ...
                this.renderer.scrollSelectionIntoView(n.start, n.end), r)
             : r
    ...
    var s = this.on("changeSelection", function() {
      ...
      if (r && t && (n.isFocused() || n.searchBox && n.searchBox.isFocused())) {
        var e = n.renderer, s = e.$cursorLayer.$pixelPos, o = e.layerConfig,
            u = s.top - o.offset;
        s.top >=
            0 &&u +
              t.top<0 ? r = !0
                      : s.top < o.height &&s.top + t.top + o.lineHeight>window
                .innerHeight
          ? r = !1
          : r = null,
            r != null &&
              (i.style.top = u + "px", i.style.left = s.left + "px",
               i.style.height = o.lineHeight + "px", i.scrollIntoView(r)),
            r = t = null
      }
    });
    this.setAutoScrollEditorIntoView = function(e) {
...
var E = {
  getText: function(e, t) {
    return (Math.abs(e.selection.lead.row - t) ||
            t + 1 + (t < 9 ? "\u00b7" : "")) +
           ""
  },
  ...
  attach: function(e) {
    ...
    e.on("changeSelection", this.update), this.update(null, e)
  },
  detach: function(e) {
    e.renderer.$gutterLayer.$renderer == this &&
      (e.renderer.$gutterLayer.$renderer = null),
      e.off("changeSelection", this.update), this.update(null, e)
  }
};
t.Editor = w
             }),
  ace.define("ace/undomanager", ["require", "exports", "module", "ace/range"],
             function(e, t, n) {
"use strict";
function i(e, t) {
  for (var n = t; n--;) {
...
function a(e) {
  var t = e.action == "insert", n = e.start, r = e.end,
      i = (r.row - n.row) * (t ? 1 : -1),
...
function l(e) {
  return {
    start: f(e.start), end: f(e.end), action: e.action, lines: e.lines.slice()
  }
}
function c(e) {
  e = e || this;
  ...
  var t = "";
  e.action ? (t = e.action == "insert" ? "+" : "-", t += "[" + e.lines + "]")
...
function h(e) {
  return e.start.row + ":" + e.start.column + "=>" + e.end.row + ":" +
         e.end.column
}
function p(e, t) {
...
function d(e, t) {
  ...
  return e.selectionBefore = t.selectionBefore = e.selectionAfter =
           t.selectionAfter = null,
         [t, e]
}
function v(e, t) {
  var n = e.action == "insert", r = t.action == "insert";
    ...
    if (o(t.start, e.end) >= 0)
      ...
      if (!(o(t.end, e.start) <= 0)) {
        ...
        return o(e.start, t.start) < 0 && (i = e, e = y(e, t.start)),
               ...
               u && !i &&
                 (e.lines = u.lines, e.start = u.start, e.end = u.end, u = e),
...
function y(e, t) {
  ...
  e.end = f(t);
  var i = e.end.row - e.start.row, s = n.splice(i, n.length),
...
function b(e, t) {
  ...
  for (var n = e.length; n--;) {
    ...
    for (var i = 0; i < r.length; i++) {
      var s = r[i], o = v(s, t);
      t = o[0], o.length != 2 && (o[2] ? (r.splice(i + 1, 1, o[1], o[2]), i++)
                                       : o[1] || (r.splice(i, 1), i--))
    }
...
this.addSession =
  ...
  this.add =
    ...
    if (t === !1 || !this.lastDeltas)
      this.lastDeltas = [], this.$undoStack.push(this.lastDeltas),
  ...
  this.undo =
    ...
    var r = n.pop(), s = null;
    return r && r.length &&
             (s = e.undoChanges(r, t), this.$redoStack.push(r),
              this.$syncRev()),
           this.$fromUndo = !1, s
  },
  this.redo =
    ...
    if (this.$redoStackBaseRev != this.$rev) {
      ...
      w(this.$redoStack, n), this.$redoStackBaseRev = this.$rev,
                             this.$redoStack.forEach(function(e) {
                               e[0].id = ++this.$maxRev
                             }, this)
    }
    var r = this.$redoStack.pop(), i = null;
    return r && (i = e.redoChanges(r, t), this.$undoStack.push(r),
                 this.$syncRev()),
           this.$fromUndo = !1, i
  },
  this.$syncRev =
  ...
  this.reset =
    function() {
    this.lastDeltas = null, this.$lastDelta = null, this.$undoStack = [],
    this.$redoStack = [], this.$rev = 0, this.mark = 0,
    this.$redoStackBaseRev = this.$rev, this.selections = []
  },
  this.canUndo =
    function() {
  ...
  this.toJSON = function() {}, this.fromJSON = function() {},
  this.hasUndo = this.canUndo, this.hasRedo = this.canRedo,
  this.isClean = this.isAtBookmark, this.markClean = this.bookmark,
...
t.UndoManager = r
  ...
  ace.define("ace/layer/lines", ["require", "exports", "module", "ace/lib/dom"],
             function(e, t, n) {
"use strict";
var r = e("../lib/dom"), i = function(e, t) {
  this.element = e, this.canvasHeight = t || 5e5,
  this.element.style.height = this.canvasHeight * 2 + "px", this.cells = [],
  this.cellCache = [], this.$offsetCoefficient = 0
};
(function() {
this.moveContainer = function(e) {
  r.translate(this.element, 0,
  ...
  ace.define("ace/layer/gutter",
             [
               "require", "exports", "module", "ace/lib/dom", "ace/lib/oop",
               "ace/lib/lang", "ace/lib/event_emitter", "ace/layer/lines"
             ],
             function(e, t, n) {
"use strict";
function f(e) {
...
var r = e("../lib/dom"), i = e("../lib/oop"), s = e("../lib/lang"),
    o = e("../lib/event_emitter").EventEmitter, u = e("./lines").Lines,
    a = function(e) {
      ...
      this.$lines = new u(this.element), this.$lines.$offsetCoefficient = 1
    };
(function() {
i.implement(this, o),
  this.setSession =
  ...
  this.update =
    ...
    this.oldLastRow = r, this.config = e, this.$lines.moveContainer(e),
    this.$updateCursorRow();
    var i = t.getNextFoldLine(n), s = i ? i.start.row : Infinity, o = null,
        u = -1, a = n;
    for (;;) {
      a > s && (a = i.end.row + 1, i = t.getNextFoldLine(a, i),
      ...
      o ? o.row = a
        : (o = this.$lines.createCell(a, e, this.session, f),
           this.$lines.push(o)),
      this.$renderCell(o, e, i, a), a++
    }
    this._signal("afterRender"), this.$updateGutterWidth(e)
  },
  this.$updateGutterWidth =
    function(e) {
    var t = this.session, n = t.gutterRenderer || this.$renderer,
        r = t.$firstLineNumber,
  ...
  this.updateLineHighlight =
    ...
    this.$cursorCell && (this.$cursorCell.element.className =
  ...
  this.scrollLines =
    ...
    if (t.firstRow < e.firstRow)
      for (var i = this.session.getFoldedRowCount(t.firstRow, e.firstRow - 1);
           i > 0; i--)
        this.$lines.shift();
    if (r > n)
      for (var i = this.session.getFoldedRowCount(n + 1, r); i > 0; i--)
        this.$lines.pop();
    e.firstRow<t.firstRow && this.$lines.unshift(this.$renderLines(
                               e, e.firstRow, t.firstRow - 1)),
               n>r &&
      this.$lines.push(this.$renderLines(e, r + 1, n)),
      this.updateLineHighlight(), this._signal("afterRender"),
      this.$updateGutterWidth(e)
  },
  this.$renderLines =
    function(e, t, n) {
    var r = [], i = t, s = this.session.getNextFoldLine(i),
        o = s ? s.start.row : Infinity;
    for (;;) {
      i > o && (i = s.end.row + 1, s = this.session.getNextFoldLine(i, s),
                o = s ? s.start.row : Infinity);
      if (i > n) break;
  ...
  this.$renderCell =
    function(e, t, n, i) {
    var s = e.element, o = this.session, u = s.childNodes[0],
        a = s.childNodes[1], f = o.$firstLineNumber, l = o.$breakpoints,
        c = o.$decorations, h = o.gutterRenderer || this.$renderer,
    ...
    if (m) {
      ...
      m == "start" &&i == d &&i < n.end.row ? v += " ace_closed"
                                            : v += " ace_open",
    ...
    return y !== u.data && (u.data = y),
           r.setStyle(e.element.style, "height",
                      this.$lines.computeLineHeight(i, t, o) + "px"),
           r.setStyle(e.element.style, "top",
                      this.$lines.computeLineTop(i, t, o) + "px"),
           e.text = y, e
  },
  this.$fixedWidth = !1, this.$highlightGutterLine = !0, this.$renderer = "",
  this.setHighlightGutterLine =
    function(e) {
    this.$highlightGutterLine = e
  },
  this.$showLineNumbers = !0, this.$renderer = "",
...
this.$padding = 0, this.setPadding = function(e) {
  ...
  n ? this.i++
    : (n = document.createElement("div"), this.element.appendChild(n),
       this.i = -1),
    n.style.cssText = t, n.className = e
    ...
    if (r.renderer) {
      ...
      r.type == "fullLine"
        ...
        : r.type == "screenLine"
            ...
            : i.isMultiLine()
                ? r.type == "text" ? this.drawTextMarker(t, i, r.clazz, e)
                                   : this.drawMultiLineMarker(t, i, r.clazz, e)
                : this.drawSingleLineMarker(t, i,
                                            r.clazz + " ace_start" +
                                              " ace_br15",
                                            e)
  }
  ...
  var u = this.session, a = n.start.row, f = n.end.row, l = a, c = 0, h = 0,
      p = u.getScreenLastRowColumn(l), d = new r(l, n.start.column, l, h);
  for (; l <= f; l++)
    d.start.row = d.end.row = l,
    d.start.column = l == a ? n.start.column : u.getRowWrapIndent(l),
    d.end.column = p, c = h, h = p,
    p = l + 1 < f ? u.getScreenLastRowColumn(l + 1) : l == f ? 0 : n.end.column,
    this.drawSingleLineMarker(
      t, d,
      i + (l == a ? " ace_start" : "") + " ace_br" +
  ...
  this.elt(n + (c ? " ace_br" + c : ""), "height:" + o + "px;" +
                                           "right:0;" +
                                           "top:" + u + "px;" +
                                           "left:" + s + "px;" + (i || ""))
  ...
  ace.define("ace/layer/text",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/lib/dom",
               "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter"
             ],
             function(e, t, n) {
"use strict";
var r = e("../lib/oop"), i = e("../lib/dom"), s = e("../lib/lang"),
    o = e("./lines").Lines, u = e("../lib/event_emitter").EventEmitter,
    a = function(e) {
      this.dom = i, this.element = this.dom.createElement("div"),
...
(function() {
r.implement(this, u),
  this.EOF_CHAR = "\u00b6", this.EOL_CHAR_LF = "\u00ac",
  this.EOL_CHAR_CRLF = "\u00a4", this.EOL_CHAR = this.EOL_CHAR_LF,
  this.TAB_CHAR = "\u2014", this.SPACE_CHAR = "\u00b7", this.$padding = 0,
  ...
  this.onChangeTabSize = this.$computeTabString =
    ...
    for (var n = 1; n < e + 1; n++)
      if (this.showInvisibles) {
        ...
        r.textContent = s.stringRepeat(this.TAB_CHAR, n), t.push(r)
      } else
  ...
  this.updateLines =
    ...
    var f = !1, u = r, a = this.session.getNextFoldLine(u),
        l = a ? a.start.row : Infinity;
    for (;;) {
      u > l && (u = a.end.row + 1, a = this.session.getNextFoldLine(u, a),
                l = a ? a.start.row : Infinity);
      if (u > i) break;
      var c = s[o++];
      if (c) {
  ...
  this.scrollLines =
    ...
    if (t.lastRow > e.lastRow)
      for (var i = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow);
           i > 0; i--)
        this.$lines.pop();
    e.firstRow<t.firstRow && this.$lines.unshift(this.$renderLinesFragment(
                               e, e.firstRow, t.firstRow - 1)),
               e.lastRow>t.lastRow &&
  ...
  this.$renderToken = function(e, t, n, r) {
    ...
    while (f = u.exec(r)) {
      ...
      if (c) {
        ...
        y.textContent = s.stringRepeat(o.SPACE_CHAR, p.length), a.appendChild(y)
      } else if (d) {
        ...
        y.className = o.showInvisibles
                        ...
                        : "ace_cjk",
        y.textContent = o.showInvisibles ? o.SPACE_CHAR : "", a.appendChild(y)
      } else if (v) {
        t += 1;
        var y = i.createElement("span");
        y.style.width = o.config.characterWidth * 2 + "px",
        y.className = "ace_cjk", y.textContent = v, a.appendChild(y)
      }
    }
    ...
    if (!this.$textToken[n.type]) {
      ...
      n.type == "fold" &&
        ...
        y.className = w, y.appendChild(a), e.appendChild(y)
    } else
      e.appendChild(a);
    return t + r.length
    ...
    return t.className = "ace_line",
           t.style.height = this.config.lineHeight + "px", t
    ...
    for (var f = 0; f < t.length; f++) {
      ...
      if (r + c.length < o)
        ...
        while (r + c.length >= o)
          ...
          c = c.substring(o - r), r = o, a = this.$createLineElement(),
          e.appendChild(a),
          a.appendChild(this.dom.createTextNode(
            s.stringRepeat("\u00a0", n.indent), this.element)),
          i++, u = 0, o = n[i] || Number.MAX_VALUE;
    ...
    i.style.position = "absolute", i.style.right = "0",
    i.textContent = "<click to see more...>", e.appendChild(i)
    ...
    function i(e, t, n) {
      ...
      if (s != t) {
        ...
        o.length > n - t && (o = o.substring(0, n - t)),
          r.push({ type: e[i].type, value: o }), s = t + o.length, i += 1
      }
    ...
    return t.walk(function(e, t, o, u, a) {
      e != null ? r.push({ type: "fold", value: e })
...
this.$updateOpacity = function(e) {
  ...
  e != this.smoothBlinking &&
    (this.smoothBlinking = e,
     ...
     this.$updateCursors(!0), this.restartTimer())
  ...
  var n = this.session.documentToScreenPosition(e),
      r = this.$padding + (this.session.$bidiHandler.isBidiRow(n.row, e.row)
                             ? this.session.$bidiHandler.getPosLeft(n.column)
                             : n.column * this.config.characterWidth),
      i =
        (n.row - (t ? this.config.firstRowScreen : 0)) * this.config.lineHeight;
  return {
    left: r, top: i
  }
  ...
  for (var n = 0, s = t.length; n < s; n++) {
    ...
    this.drawCursor
      ...
      : this.isCursorInView(o, e)
          ? (r.setStyle(a, "display", "block"), r.translate(u, o.left, o.top),
...
var r = e("./lib/oop"), i = e("./lib/dom"), s = e("./lib/event"),
    o = e("./lib/event_emitter").EventEmitter, u = 32768, a = function(e) {
      ...
      this.setVisible(!1), this.skipEvent = !1,
...
var l = function(e, t) {
  a.call(this, e), this.scrollLeft = 0, this.height = t.$scrollbarWidth,
...
r.inherits(l, a),
  ...
  t.ScrollBar = f, t.ScrollBarV = f, t.ScrollBarH = l, t.VScrollBar = f,
  t.HScrollBar = l
             }),
...
var r = e("./lib/event"), i = function(e, t) {
  ...
  this.$recursionLimit = 2, this.window = t || window;
  var n = this;
...
this.schedule = function(e) {
  ...
  ace.define("ace/layer/font_metrics",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/lib/dom",
               "ace/lib/lang", "ace/lib/event", "ace/lib/useragent",
               "ace/lib/event_emitter"
             ],
             function(e, t, n) {
var r = e("../lib/oop"), i = e("../lib/dom"), s = e("../lib/lang"),
    o = e("../lib/event"), u = e("../lib/useragent"),
    a = e("../lib/event_emitter").EventEmitter, f = 256,
    l = typeof ResizeObserver == "function", c = 200,
    h = t.FontMetrics = function(e) {
      ...
      this.el.appendChild(this.$main), this.el.appendChild(this.$measureNode),
...
r.implement(this, a),
  ...
  this.$setMeasureNodeStyles = function(e, t) {
    e.width = e.height = "auto", e.left = e.top = "0px",
    e.visibility = "hidden", e.position = "absolute", e.whiteSpace = "pre",
    ...
    if (e && (this.$characterSize.width !== e.width ||
              this.$characterSize.height !== e.height)) {
      this.$measureNode.style.fontWeight = "bold";
      var t = this.$measureSizes();
      this.$measureNode.style.fontWeight = "", this.$characterSize = e,
    ...
    var e = function(e, t) {
      return [
        "div", { style: "position: absolute;top:" + e + "px;left:" + t + "px;" }
      ]
    };
    ...
    function r(e, t, n) {
      ...
      return [
        (-t[1] * n[0] + t[0] * n[1]) / r, (+e[1] * n[0] - e[0] * n[1]) / r
      ]
    }
    function i(e, t) {
    ...
    var a = u(this.els[0]), f = u(this.els[1]), l = u(this.els[2]),
        h = u(this.els[3]), p = r(i(h, f), i(h, l), i(s(f, l), s(h, a))),
        d = o(1 + p[0], i(f, a)), v = o(1 + p[1], i(l, a));
    if (t) {
      var m = t, g = p[0] * m[0] / c + p[1] * m[1] / c + 1,
          y = s(o(m[0], d), o(m[1], v));
  ...
  ace.define("ace/virtual_renderer",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/lib/dom",
               "ace/config", "ace/layer/gutter", "ace/layer/marker",
               "ace/layer/text", "ace/layer/cursor", "ace/scrollbar",
               "ace/scrollbar", "ace/renderloop", "ace/layer/font_metrics",
...
var
  r = e("./lib/oop"),
  i = e("./lib/dom"), s = e("./config"), o = e("./layer/gutter").Gutter,
  u = e("./layer/marker").Marker, a = e("./layer/text").Text,
  f = e("./layer/cursor").Cursor, l = e("./scrollbar").HScrollBar,
  c = e("./scrollbar").VScrollBar, h = e("./renderloop").RenderLoop,
...
var y = function(e, t) {
  ...
  i.HI_DPI && i.addCssClass(this.container, "ace_hidpi"), this.setTheme(t),
  ...
  this.canvas = r.element, this.$markerFront = new u(this.content),
  this.$cursorLayer = new f(this.content), this.$horizScroll = !1,
  this.$vScroll = !1,
  ...
  this.setPadding(4), s.resetOptions(this), s._emit("renderer", this)
};
(function() {
this.CHANGE_CURSOR = 1,
  ...
  this.updateCharacterSize = function() {
    ...
    this.session &&
      ...
      this.session = e,
      e && this.scrollMargin.top && e.getScrollTop() <= 0 &&
    ...
    e && (this.$gutterLayer.$padding = null),
      e ? this.$renderChanges(s | this.$changes, !0)
    ...
    r && (e || o.height != r) &&
      (o.height = r, s |= this.CHANGE_SIZE, o.scrollerHeight = o.height,
    ...
    if (n && (e || o.width != n)) {
      s |= this.CHANGE_SIZE,
        ...
        o.scrollerWidth =
          Math.max(0, n - t - this.scrollBarV.getWidth() - this.margin.h),
    ...
    t != this.gutterWidth && (this.$changes |= this.$updateCachedSize(
                                !0, t, this.$size.width, this.$size.height)),
      this.session.getUseWrapMode() && this.adjustWrapLimit()
        ? this.$loop.schedule(this.CHANGE_FULL)
        : this.$size.$dirty ? this.$loop.schedule(this.CHANGE_FULL)
    ...
    t.left = Math.round(this.characterWidth * this.$printMarginColumn +
                        this.$padding) +
             "px",
    ...
    o -= this.scrollLeft,
      ...
      i.setStyle(e, "height", u + "px"), i.setStyle(e, "width", a + "px"),
      i.translate(this.textarea, Math.min(o, this.$size.scrollerWidth - a),
    ...
    i.top = e | 0, i.bottom = t | 0, i.right = r | 0, i.left = n | 0,
    i.v = i.top + i.bottom, i.h = i.left + i.right,
    i.top && this.scrollTop <= 0 && this.session &&
    ...
    i.top = e | 0, i.bottom = t | 0, i.right = r | 0, i.left = n | 0,
    i.v = i.top + i.bottom, i.h = i.left + i.right,
    this.$updateCachedSize(!0, this.gutterWidth, this.$size.width,
                           this.$size.height),
    this.updateFull()
    ...
    this.scrollBarH.setScrollWidth(this.layerConfig.width + 2 * this.$padding +
                                   this.scrollMargin.h),
    ...
    if (e & this.CHANGE_FULL || e & this.CHANGE_SIZE || e & this.CHANGE_TEXT ||
        e & this.CHANGE_LINES || e & this.CHANGE_SCROLL ||
      ...
      if (n.firstRow != this.layerConfig.firstRow &&
        ...
        r > 0 && (this.scrollTop = r, e |= this.CHANGE_SCROLL,
                  e |= this.$computeLayerConfig() | this.$loop.clear())
      }
    ...
    if (e & this.CHANGE_FULL) {
      this.$textLayer.update(n),
        ...
        this.$markerBack.update(n), this.$markerFront.update(n),
    ...
    e&this.CHANGE_TEXT
      ...
      : e&this.CHANGE_LINES
          ...
          : e&this.CHANGE_TEXT || e&this.CHANGE_GUTTER
              ? this.$showGutter && this.$gutterLayer.update(n)
              : e&this.CHANGE_CURSOR && this.$highlightGutterLine &&
    ...
    this.$horizScroll && (n += this.scrollBarH.getHeight()),
      this.$maxPixelHeight && n > this.$maxPixelHeight &&
        (n = this.$maxPixelHeight);
    var r = n <= 2 * this.lineHeight, i = !r && e > t;
    if (n != this.desiredHeight || this.$size.height != this.desiredHeight ||
        i != this.$vScroll) {
      ...
      this.desiredHeight = n, this._signal("autosize")
    }
    ...
    var e = this.session, t = this.$size, n = t.height <= 2 * this.lineHeight,
        ...
        o = !n && (this.$hScrollBarAlwaysVisible ||
    ...
    this.session.setScrollTop(Math.max(
      -c.top, Math.min(this.scrollTop, i - t.scrollerHeight + c.bottom))),
      this.session.setScrollLeft(Math.max(
        -c.left, Math.min(this.scrollLeft,
                          s + 2 * this.$padding - t.scrollerWidth + c.right)));
    var h = !n && (this.$vScrollBarAlwaysVisible ||
                   t.scrollerHeight - i + l < 0 || this.scrollTop > c.top),
        p = a !== h;
    ...
    E && (m = E.start.row),
      y = e.documentToScreenRow(m, 0), b = e.getRowLength(m) * w,
    ...
    return this.layerConfig = {
      ...
      offset: d,
      gutterOffset:
        w ? Math.max(0, Math.ceil((d + t.height - t.scrollerHeight) / w)) : 0,
    ...
    var r = this.$cursorLayer.getPixelPosition(e), i = r.left, s = r.top,
        o = n && n.top || 0, u = n && n.bottom || 0,
        a =
          this.$scrollAnimation ? this.session.getScrollTop() : this.scrollTop;
    a + o > s
      ? (t && a + o > s + this.lineHeight &&
      ...
      : a + this.$size.scrollerHeight - u < s + this.lineHeight &&
          (t && a + this.$size.scrollerHeight - u < s - this.lineHeight &&
             (s += t * this.$size.scrollerHeight),
           this.session.setScrollTop(s + this.lineHeight + u -
                                     this.$size.scrollerHeight));
    var f = this.scrollLeft;
    f > i ? (i < this.$padding + 2 * this.layerConfig.characterWidth &&
               (i = -this.scrollMargin.left),
             this.session.setScrollLeft(i))
          : f + this.$size.scrollerWidth < i + this.characterWidth
              ? this.session.setScrollLeft(Math.round(i + this.characterWidth -
                                                      this.$size.scrollerWidth))
              : f <= this.$padding && i - f < this.characterWidth &&
    ...
    clearInterval(this.$timer), r.session.setScrollTop(s.shift()),
    ...
    this.$timer = setInterval(function() {
      s.length
        ...
        : n != null
            ...
            : (r.$timer = clearInterval(r.$timer), r.$scrollAnimation = null,
               t && t())
    }, 10)
    ...
    if (e < 0 && this.session.getScrollLeft() >= 1 - this.scrollMargin.left)
      return !0;
    if (e > 0 && this.session.getScrollLeft() + this.$size.scrollerWidth -
    ...
    return {
      row: o, column: u, side: s - u > 0 ? 1 : -1, offsetX: i
    }
    ...
    var n = this.scroller.getBoundingClientRect(),
        ...
        i = this.$padding + (this.session.$bidiHandler.isBidiRow(r.row, e)
    ...
    this.$useTextareaForIME
      ...
      : e.markerId = this.session.addMarker(e.markerRange,
    ...
    this.$composition.markerId &&
      ...
      this.$composition = null, this.$cursorLayer.element.style.display = ""
    ...
    if (r == null)
      ...
      for (var a = 0; a < o.length; a++) {
        ...
        u += f.value.length;
        if (r <= u) {
          var l = f.value.length - (u - r), c = f.value.slice(0, l),
              h = f.value.slice(l);
    ...
    function o(r) {
      ...
      if (!r || !r.cssClass)
        throw new Error("couldn't load module " + e +
...
this.$gutter.style.display = e ? "block" : "none",
  this.$loop.schedule(this.CHANGE_FULL), this.onGutterResize()
      },
      initialValue: !0
    },
    fadeFoldWidgets: {
...
return this.$themeId || this.theme
  ...
  ace.define("ace/worker/worker_client",
             [
               "require", "exports", "module", "ace/lib/oop", "ace/lib/net",
...
function u(e) {
  ...
  try {
    ...
    var r = window.BlobBuilder || window.WebKitBlobBuilder ||
...
var r = e("../lib/oop"), i = e("../lib/net"),
    ...
    f = function(t, n, r, i, s) {
      ...
      this.$worker = a(i), s && this.send("importScripts", s),
...
r.implement(this, s), this.onMessage = function(e) {
  ...
  this._signal("terminate", {}),
    this.deltaQueue = null, this.$worker.terminate(), this.$worker = null,
    this.$doc && this.$doc.off("change", this.changeListener), this.$doc = null
  ...
  this.deltaQueue ||
    ...
    e.action == "insert" ? this.deltaQueue.push(e.start, e.lines)
...
l.prototype = f.prototype, t.UIWorkerClient = l, t.WorkerClient = f,
                           t.createWorker = a
             }),
...
s.implement(this, i), this.setup = function() {
  ...
  this.$updating = !0;
  var n = e.action === "insert" ? t.end.column - t.start.column
  ...
  var e = this, t = this.session, n = function(n, i) {
    t.removeMarker(n.markerId),
      n.markerId = t.addMarker(
        new r(n.row, n.column, n.row, n.column + e.length), i, null, !1)
  };
...
function o(e) {
  ...
  if (S == "add") {
    ...
    var N, C = [], k = function() {
      ...
      l.removeSelectionMarkers(C), C = c.rectangularRangeBlock(E, w),
      l.$mouseHandler.$clickSelection && C.length == 1 && C[0].isEmpty() &&
        (C[0] = l.$mouseHandler.$clickSelection.clone()),
      C.forEach(l.addSelectionMarker, l), l.updateSelectionMarkers()
    };
    h && !a ? c.toSingleRange()
      ...
      o ? w = b.documentToScreenPosition(c.lead) : c.moveToPosition(p),
          E = { row: -1, column: -1 };
    var L = function(e) {
      k(), clearInterval(O), l.removeSelectionMarkers(C),
...
t.keyboardHandler = new r(t.multiSelectCommands)
  ...
  ace.define("ace/multi_select",
             [
               ...
               "ace/selection", "ace/mouse/multi_select_handler",
               "ace/lib/event", "ace/lib/lang",
               "ace/commands/multi_select_commands", "ace/search",
...
function m(e) {
  ...
  e.on("changeSession", e.$multiselectOnSessionChange), e.on("mousedown", o),
...
this.ranges = null, this.rangeList = null, this.addRange = function(e, t) {
  ...
  return this.$onAddRange(e), r.length && this.$onRemoveRange(r),
         this.rangeCount > 1 && !this.inMultiSelectMode &&
           (this._signal("multiSelect"), this.inMultiSelectMode = !0,
            this.session.$undoSelect = !1, this.rangeList.attach(this.session)),
  ...
  this._signal("removeRange", { ranges: e }),
    this.rangeCount === 0 && this.inMultiSelectMode &&
      (this.inMultiSelectMode = !1, this._signal("singleSelect"),
  ...
  if (s)
    ...
    var o = t.column, u = e.column, a = t.offsetX, f = e.offsetX;
  var l = e.row < t.row;
  if (l)
    var c = e.row, h = t.row;
  else
...
this.updateSelectionMarkers = function() {
  ...
  var r = n && n.keepOrder, i = n == 1 || n && n.$byLines, o = this.session,
      u = this.selection, a = u.rangeList, f = (r ? u : a).ranges, l;
  ...
  h.detach(), this.selection = o.selection = u,
              this.inVirtualSelectionMode = !1, u._eventRegistry = c,
  ...
  return this.onCursorChange(), this.onSelectionChange(),
         v && v.from == v.to && this.renderer.animateScrolling(v.from), l
  ...
  if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
    ...
    var r = t == this.multiSelect.anchor ? n.cursor == n.start ? n.end : n.start
                                         : n.cursor;
    r.row != t.row ||
  ...
  if (t.needle == undefined) {
    var r = this.selection.isEmpty() ? this.selection.getWordRange()
  ...
  if (s.isEmpty()) {
    ...
    s.cursor = e == -1 ? s.start : s.end, this.multiSelect.addRange(s);
    if (n) return
  }
  var o = r.getTextRange(s), u = h(r, o, e);
  u && (u.cursor = e == -1 ? u.start : u.end, this.session.unfold(u),
  ...
  if (!n.length || s.length == n.length - 1) {
    var o = this.selection.getRange(), u = o.start.row, f = o.end.row,
        l = u == f;
    if (l) {
    ...
    var d = 0, v = Infinity, m = n.map(function(t) {
      ...
      return i == -1 && (i = 0), n.column > d && (d = n.column),
             i < v && (v = i), i
    });
    n.forEach(function(t, n) {
      ...
      s > o ? e.insert(r, a.stringRepeat(" ", s - o))
        ...
        t.start.column = t.end.column = d, t.start.row = t.end.row = r.row,
        t.cursor = t.end
    }),
  ...
  function f(e) {
    return e[2] ? u(i) + e[2] + u(s - e[2].length + o) +
                    e[4].replace(/^([=:])\s+/, "$1 ")
                : e[0]
  }
  function l(e) {
    return e[2] ? u(i + s - e[2].length) + e[2] + u(o) +
                    e[4].replace(/^([=:])\s+/, "$1 ")
                : e[0]
  }
  function c(e) {
...
var t = e.session;
t && !t.multiSelect &&
  (t.$selectionMarkers = [], t.selection.$initRangeList(),
...
n && (n.multiSelect.off("addRange", this.$onAddRange),
  ...
  t && this.inMultiSelectMode != t.selection.inMultiSelectMode &&
    ...
    enableMultiselect: {
      set: function(e) {
m(this), e ? (this.on("changeSession", this.$multiselectOnSessionChange),
              this.on("mousedown", o))
...
this.foldingStartMarker = null,
  this.foldingStopMarker = null, this.getFoldWidget = function(e, t, n) {
    var r = e.getLine(n);
...
"use strict";
function o(e) {
  this.session = e, this.session.widgetManager = this,
...
this.getRowLength = function(e) {
  ...
  var t = this.editor;
  if (!t) return;
  this.editor = null, t.widgetManager = null,
  ...
  for (var u = i + 1; u < s; u++)
    n[u] && (n[u].hidden = o);
  n[s] && (o ? n[i] ? n[s].hidden = o : n[i] = n[s]
  ...
  e.html && !e.el && (e.el = i.createElement("div"), e.el.innerHTML = e.html),
    e.el && (i.addCssClass(e.el, "ace_lineWidgetContainer"),
             e.el.style.position = "absolute", e.el.style.zIndex = 5,
             n.container.appendChild(e.el), e._inDocument = !0),
  ...
  return this.session._emit("changeFold", { data: { start: { row: e.row } } }),
         this.$updateRows(), this.renderWidgets(null, n),
         this.onWidgetChanged(e), e
}, this.removeLineWidget = function(e) {
  e._inDocument = !1, e.session = null,
  ...
  while (i > 0 && !r[i])
    i--;
  this.firstRow = n.firstRow, this.lastRow = n.lastRow,
  ...
  for (var o = i; o <= s; o++) {
    ...
    u.fixedWidth || (f -= t.scrollLeft),
      ...
      u.fullWidth && u.screenWidth &&
        (u.el.style.minWidth = n.width + 2 * n.padding + "px"),
      u.fixedWidth ? u.el.style.right = t.scrollBar.getWidth() + "px"
                   : u.el.style.right = ""
  }
}
}).call(o.prototype),
  ...
  ace.define("ace/ext/error_marker",
             [
               "require", "exports", "module", "ace/line_widgets",
...
function u(e, t, n) {
  ...
  i < 0 && (i = -i - 1), i >= r.length ? i = n > 0 ? 0 : r.length - 1
...
t
  ...
  if (f) {
    ...
    s.row = c.row, l = e.renderer.$gutterLayer.$annotations[s.row]
  } else {
    if (a) return;
  ...
  p.innerHTML = l.text.join("<br>"), p.appendChild(i.createElement("div"));
  ...
  h.destroy =
    ...
    e.keyBinding.removeKeyboardHandler(m), n.widgetManager.removeLineWidget(h),
      e.off("changeSelection", h.destroy), e.off("changeSession", h.destroy),
      e.off("mouseup", h.destroy), e.off("change", h.destroy)
  },
  e.keyBinding.addKeyboardHandler(m), e.on("changeSelection", h.destroy),
  e.on("changeSession", h.destroy), e.on("mouseup", h.destroy),
  e.on("change", h.destroy), e.session.widgetManager.addLineWidget(h),
  h.el.onmousedown = e.focus.bind(e),
  e.renderer.scrollCursorIntoView(null, .5, { bottom: h.el.offsetHeight })
},
 i.importCssString(
  ...
  ace.define("ace/ace",
             [
               ...
               "ace/lib/dom", "ace/lib/event", "ace/range", "ace/editor",
               "ace/edit_session", "ace/undomanager", "ace/virtual_renderer",
               "ace/worker/worker_client", "ace/keyboard/hash_handler",
               "ace/placeholder", "ace/multi_select",
               "ace/mode/folding/fold_mode", "ace/theme/textmate",
               "ace/ext/error_marker", "ace/config"
             ],
             function(e, t, n) {
"use strict";
e("./lib/fixoldbrowsers");
var r = e("./lib/dom"), i = e("./lib/event"), s = e("./range").Range,
    o = e("./editor").Editor, u = e("./edit_session").EditSession,
...
e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"),
  ...
  t.Range = s, t.Editor = o, t.EditSession = u, t.UndoManager = a,
  t.VirtualRenderer = f, t.version = "1.4.2"
             });
(function() {
