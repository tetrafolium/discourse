this.workbox = this.workbox || {}, this.workbox.routing = function(t, e, r) {
  ...
  const s = "GET", n = t => t && "object" == typeof t ? t : { handle: t };
  class o {
    constructor(t, e, r) {
  ...
  class u extends o {
    constructor(t, e, r) {
      super(({ url: e }) => {
        ...
        return r ? e.origin !== location.origin && 0 !== r.index ? null
                                                                 : r.slice(1)
                 : null
      }, e, r)
    }
  ...
  class c {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let s,
        { params: n, route: o } =
          this.findMatchingRoute({ url: r, request: t, event: e }),
                              i = o && o.handler;
      if (!i && this.u && (i = this.u), i) {
        ...
        return s && this.h &&
                 (s =
                    s.catch(t => this.h.handle({ url: r, event: e, err: t }))),
               s
      }
    }
    findMatchingRoute({ url: t, request: e, event: r }) {
      ...
      for (const n of s) {
        let s, o = n.match({ url: t, request: e, event: r });
        if (o)
  ...
  return t.NavigationRoute = i, t.RegExpRoute = u,
           ...
           const s = e.cacheNames.getPrecacheName(r.cacheName),
                 n = new i(async () => {
                   try {
                     ...
                     if (e) return e;
                     throw new Error(
                       `The cache ${s} did not have an entry for ` +
                       `${t}.`)
                   } catch (e) {
                     return fetch(t)
                   }
         ...
         t.Route = o, t.Router = c,
         t.setCatchHandler = (t => { h().setCatchHandler(t) }),
         t.setDefaultHandler = (t => { h().setDefaultHandler(t) }), t
