this.workbox = this.workbox || {}, this.workbox.core = function(e) {
  ...
  const r = {
    ...
    suffix: self.registration.scope
        ...
        i = {
          updateDetails: e => {
            Object.keys(r).forEach(t => { void 0 !== e[t] && (r[t] = e[t]) })
          },
  ...
  const l = "cacheDidUpdate", u = "cacheKeyWillBeUsed", h = "cacheWillUpdate",
        f = "cachedResponseWillBeUsed", w = "fetchDidFail",
        g = "fetchDidSucceed", d = "requestWillFetch",
        ...
        m = async ({ request: e, response: t, event: n, plugins: s }) => {
          ...
          for (let t of s)
            if (h in t &&
                (a = !0, !(r = await t[h].call(
                             t, { request: e, response: r, event: n }))))
              break;
          ...
          put: async ({
            ...
            if (!s)
              throw new n("cache-put-with-no-response", { url: c(u.url) });
            let h = await m({ event: r, plugins: a, response: s, request: u });
            if (!h) return;
            const f = await caches.open(e), w = p(a, l);
            let g = w.length > 0
  ...
  class x {
    ...
    async open() {
      if (!this.l)
        return this.l = await new Promise((e, t) => {
                 let n = !1;
                 setTimeout(() => {
                   n = !0,
                 ...
                 s.onerror = (() => t(s.error)),
                 s.onupgradeneeded =
                   (e => { n ? (s.transaction.abort(), e.target.result.close())
                             : this.o && this.o(e) }),
    ...
    async getAllKeys(e, t, n) {
      return (await this.getAllMatching(
                e, { query: t, count: n, includeKeys: !0 }))
        .map(({ key: e }) => e)
    }
    async getAllMatching(e, {
      ...
      return await this.transaction([e], "readonly", (i, c) => {
        const o = i.objectStore(e), l = t ? o.index(t) : o, u = [];
    ...
    async transaction(e, t, n) {
      return await this.open(), await new Promise((s, r) => {
               ...
               a.oncomplete = (() => s()), n(a, e => s(e))
             })
    }
    async u(e, t, n, ...s) {
      return await this.transaction(
        [t], n,
        (n, r) => { n.objectStore(t)[e](...s).onsuccess =
                      (({ target: e }) => { r(e.result) }) })
    }
    t() {
      this.close()
  ...
  const D = {
    fetch:
      async ({ request: e, fetchOptions: t, event: s, plugins: r = [] }) => {
        if (s && s.preloadResponse) {
          const e = await s.preloadResponse;
          if (e) return e
        }
        "string" == typeof e && (e = new Request(e));
        const a = p(r, w), i = a.length > 0 ? e.clone() : null;
        try {
          for (let t of r)
    ...
    deleteDatabase:
      async e => {
        await new Promise((t, n) => {
          ...
          s.onerror = (({ target: e }) => { n(e.error) }),
          s.onblocked = (() => { n(new Error("Delete blocked")) }),
          s.onsuccess = (() => { t() })
        })
      },
  ...
  return e._private = E,
         ...
         e.cacheNames = N,
         e.registerQuotaErrorCallback =
           function(e) {
           s.add(e)
         },
         e.setCacheNameDetails = (e => { i.updateDetails(e) }),
         e.skipWaiting =
