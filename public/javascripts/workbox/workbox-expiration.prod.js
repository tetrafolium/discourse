this.workbox = this.workbox || {}, this.workbox.expiration =
  ...
  const h = "workbox-expiration", c = "cache-entries", r = t => {
  ...
  class o {
    ...
    async setTimestamp(t, e) {
      t = r(t), await this.s.put(
                  c, { url: t, timestamp: e, cacheName: this.t, id: this.h(t) })
    }
    ...
    async expireEntries(t, e) {
      ...
      for (const t of s)
        await this.s.delete(c, t.id), i.push(t.url);
      return i
    }
    h(t) {
      return this.t + "|" + r(t)
  ...
  class u {
    constructor(t, e = {}) {
      this.o = !1, this.u = !1, this.l = e.maxEntries, this.p = e.maxAgeSeconds,
      this.t = t, this.m = new o(t)
    }
    async expireEntries() {
  ...
  return t.CacheExpiration = u, t.Plugin = class {
    constructor(t = {}) {
      this.D = t, this.p = t.maxAgeSeconds, this.g = new Map,
      t.purgeOnQuotaError &&
    ...
    cachedResponseWillBeUsed(
      { event: t, request: e, cacheName: s, cachedResponse: i }) {
      if (!i) return null;
      let a = this.N(i);
      const n = this.k(s);
      n.expireEntries();
    ...
    async deleteCacheAndMetadata() {
      for (const [t, e] of this.g)
        await caches.delete(t), await e.delete();
      this.g = new Map
    }
  }
  , t
