...
var
  ...
  extend =
    ...
    for (prop in from) {
      ...
      if (hasProp && typeof from[prop] === 'object' && from[prop] !== null &&
  ...
  renderDay =
    ...
    return '<td data-day="' + opts.day + '" class="' + arr.join(' ') +
           ...
           '" data-pika-day="' + opts.day + '">' + opts.day + '</button>' +
           '</td>';
  },
  ...
  renderWeek =
    ...
    var onejan = new Date(y, 0, 1),
        weekNum = Math.ceil(
          (((new Date(y, m, d) - onejan) / 86400000) + onejan.getDay() + 1) /
          7);
  ...
  renderTitle =
    ...
    var i, j, arr,
      opts = instance._o, isMinYear = year === opts.minYear,
    ...
    if (c === (instance._o.numberOfMonths - 1)) {
      html += '<button class="pika-next' + (next ? '' : ' is-disabled') +
...
Pikaday.prototype = {
  ...
  adjustCalendars: function() {
    ...
    for (var c = 1; c < this._o.numberOfMonths; c++) {
      this.calendars[c] = adjustCalendar(
        { month: this.calendars[0].month + c, year: this.calendars[0].year });
    }
    this.draw();
  },
  ...
  draw: function(force) {
    ...
    var opts = this._o, minYear = opts.minYear, maxYear = opts.maxYear,
    ...
    for (var c = 0; c < opts.numberOfMonths; c++) {
      html +=
        ...
        renderTitle(this, c, this.calendars[c].year, this.calendars[c].month,
  ...
  adjustPosition: function() {
    var field, pEl, width, height, viewportWidth, viewportHeight, scrollTop,
      left, top, clientRect, leftAligned, bottomAligned;
  ...
  render: function(year, month, randId) {
    ...
    for (var i = 0, r = 0; i < cells; i++) {
      var day = new Date(year, month, 1 + (i - before)),
          ...
          dayNumber = 1 + (i - before), monthNumber = month, yearNumber = year,
