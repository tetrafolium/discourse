...
import DiscoverySortableController from
  "discourse/controllers/discovery-sortable";
  ...
  initialize(registry, app) {
    ...
    site.get("filters").forEach(filter => {
      ...
      app[`Discovery${filterCapitalized}CategoryController`] =
        DiscoverySortableController.extend();
      app[`Discovery${filterCapitalized}ParentCategoryController`] =
        DiscoverySortableController.extend();
      ...
      app[`Discovery${filterCapitalized}ParentCategoryRoute`] =
        buildCategoryRoute(filter);
    ...
    Discourse.DiscoveryTopCategoryController =
      DiscoverySortableController.extend();
    Discourse.DiscoveryTopParentCategoryController =
      DiscoverySortableController.extend();
    Discourse.DiscoveryTopCategoryNoneController =
      DiscoverySortableController.extend();
    ...
    Discourse.DiscoveryTopCategoryNoneRoute =
      buildCategoryRoute("top", { no_subcategories: true });
    ...
    site.get("periods").forEach(period => {
      ...
      app[`DiscoveryTop${periodCapitalized}CategoryController`] =
        DiscoverySortableController.extend();
      app[`DiscoveryTop${periodCapitalized}ParentCategoryController`] =
        DiscoverySortableController.extend();
      app[`DiscoveryTop${periodCapitalized}CategoryNoneController`] =
        DiscoverySortableController.extend();
      app[`DiscoveryTop${periodCapitalized}Route`] =
        buildTopicRoute("top/" + period);
      app[`DiscoveryTop${periodCapitalized}CategoryRoute`] =
        buildCategoryRoute("top/" + period);
      app[`DiscoveryTop${periodCapitalized}ParentCategoryRoute`] =
        buildCategoryRoute("top/" + period);
    ...
    app["TagsShowCategoryNoneRoute"] =
      TagsShowRoute.extend({ noSubcategories: true });
    app["TagsShowParentCategoryRoute"] = TagsShowRoute.extend();

    app["TagShowRoute"] = TagsShowRoute;

    site.get("filters").forEach(function(filter) {
      app["TagsShow" + filter.capitalize() + "Route"] =
        TagsShowRoute.extend({ navMode: filter });
      app["TagShow" + filter.capitalize() + "Route"] =
        TagsShowRoute.extend({ navMode: filter });
      ...
      app["TagsShowParentCategory" + filter.capitalize() + "Route"] =
        TagsShowRoute.extend({ navMode: filter });
    });
  }
};
