...
export default Component.extend(UploadMixin, {
  type: "csv", tagName: "span", uploadUrl: "/invites/upload_csv",
  ...
  ,
    ...
    return uploading ? I18n.t("uploading")
                     : I18n.t("user.invited.bulk_invite.text");
  }
  ,

    @discourseComputed("uploading") uploadButtonDisabled(uploading) {
  ...
  ,
    ...
    _init: on("didInsertElement", function() {
      ...
      $upload.on("fileuploadadd", (e, data) => {
        bootbox.confirm(I18n.t("user.invited.bulk_invite.confirmation_message"),
                        I18n.t("cancel"), I18n.t("go_ahead"),
