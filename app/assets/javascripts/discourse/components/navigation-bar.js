...
export default Component.extend(FilterModeMixin, {
  tagName: "ul", classNameBindings: [":nav", ":nav-pills"],
  ...
  ,
    ...
    @discourseComputed("filterType", "navItems") selectedNavItem(filterType,
                                                                 navItems) {
