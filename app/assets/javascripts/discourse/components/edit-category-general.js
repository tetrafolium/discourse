...
export default buildCategoryPanel("general", {
  ...
  ,
    ...
    customizeTextContentLink:
      Discourse.getURL("/admin/customize/site_texts?q=uncategorized"),

    // background colors are available as a pipe-separated string
    @discourseComputed backgroundColors() {
    const categories = this.site.get("categoriesList");
    return this.siteSettings.category_colors.split("|")
      .map(function(i) {
  ...
  ,
    ...
    @discourseComputed noCategoryStyle() {
  ...
  ,
    ...
    @discourseComputed("category.parent_category_id", "category.categoryName",
  ...
  ,
    ...
    @discourseComputed("category.id") subCategories(categoryId) {
