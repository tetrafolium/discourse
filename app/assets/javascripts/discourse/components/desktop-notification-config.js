...
export default Component.extend({
  ...
  ,
    ...
    @discourseComputed notificationsDisabled: {
      set(value) {
  ...
  ,
    ...
    @discourseComputed isEnabledPush: {
      set(value) {
        ...
        pushNotificationKeyValueStore.setItem(
          pushNotificationUserSubscriptionKey(user), value);
        return pushNotificationKeyValueStore.getItem(
          pushNotificationUserSubscriptionKey(user));
      },
      get() {
        const user = this.currentUser;
        return user ? pushNotificationKeyValueStore.getItem(
                        pushNotificationUserSubscriptionKey(user))
                    : false;
      }
    },
