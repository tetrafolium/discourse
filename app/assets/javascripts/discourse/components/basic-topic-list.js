...
export default Component.extend({
  loadingMore: alias("topicList.loadingMore"), loading: not("loaded"),

    @discourseComputed("topicList.loaded") loaded() {
  ...
  ,
    ...
    @observes("topicList.[]") _topicListChanged:
      function() {
  ...
  ,
    ...
    @discourseComputed("topics") showUnreadIndicator(topics) {
