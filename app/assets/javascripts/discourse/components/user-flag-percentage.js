...
export default Component.extend({
  tagName: "",
    ...
    @discourseComputed("percentage") showPercentage(percentage) {
    return percentage.total >= 3;
  }
  ,

    // We do a little logic to choose which icon to display and which text
    @discourseComputed("agreed", "disagreed",
                       "ignored") percentage(agreed, disagreed, ignored) {
    ...
    result.title = I18n.t("review.user_percentage.summary", {
      agreed: I18n.t("review.user_percentage.agreed", { count: result.agreed }),
      disagreed:
        I18n.t("review.user_percentage.disagreed", { count: result.disagreed }),
      ignored:
        I18n.t("review.user_percentage.ignored", { count: result.ignored }),
      count: total
    });
