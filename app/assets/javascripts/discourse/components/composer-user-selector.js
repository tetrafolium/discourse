...
export default Component.extend({
  showSelector: true, shouldHide: false, defaultUsernameCount: 0,
  ...
  ,
    ...
    @observes("usernames") _checkWidth() {
    let width = 0;
  ...
  ,
    ...
    @discourseComputed("usernames") splitUsernames(usernames) {
