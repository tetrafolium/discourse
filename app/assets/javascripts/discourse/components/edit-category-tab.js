...
export default Component.extend({
  tagName: "li", classNameBindings: ["active", "tabClassName"],

    @discourseComputed("tab") tabClassName(tab) {
  ...
  ,
    ...
    @discourseComputed("tab") title(tab) {
  ...
  ,
    ...
    const $modalBody =
      $(this.element).parents("#discourse-modal").find(".modal-body");
