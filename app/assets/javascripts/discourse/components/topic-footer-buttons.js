...
export default Component.extend({
  elementId: "topic-footer-buttons",
    ...
    @discourseComputed("topic.isPrivateMessage") canArchive(isPM) {
  ...
  ,
    ...
    @discourseComputed("buttons.[]") inlineButtons(buttons) {
  ...
  ,
    ...
    @discourseComputed("buttons.[]",
                       "topic.assigned_to_user") dropdownButtons(buttons) {
    return buttons.filter(button => button.dropdown);
  }
  ,

    @discourseComputed("topic.isPrivateMessage") showNotificationsButton(isPM) {
  ...
  ,
    ...
    @discourseComputed("topic.message_archived") archiveIcon:
      archived => (archived ? "envelope" : "folder"),

      @discourseComputed("topic.message_archived") archiveTitle: archived =>
        archived ? "topic.move_to_inbox.help" : "topic.archive_message.help",

      @discourseComputed("topic.message_archived") archiveLabel: archived =>
