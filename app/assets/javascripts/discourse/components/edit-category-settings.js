...
export default buildCategoryPanel("settings", {
  ...
  ,
    ...
    @discourseComputed availableSubcategoryListStyles() {
    return [
      { name: I18n.t("category.subcategory_list_styles.rows"), value: "rows" },
      {
        name:
          I18n.t("category.subcategory_list_styles.rows_with_featured_topics"),
      ...
      {
        name:
          I18n.t("category.subcategory_list_styles.boxes_with_featured_topics"),
  ...
  ,
    ...
    @discourseComputed availableViews() {
    return [
  ...
  ,
    ...
    @discourseComputed availableTopPeriods() {
  ...
  ,
    ...
    @discourseComputed searchPrioritiesOptions() {
    const options = [];
    ...
    Object.entries(searchPriorities).forEach(entry => {
      ...
      options.push(
        { name: I18n.t(`category.search_priority.options.${name}`), value });
    });
  ...
  ,
    ...
    @discourseComputed availableSorts() {
    return [
      "likes", "op_likes", "views", "posts", "activity", "posters", "category",
      "created"
  ...
  ,
    ...
    @discourseComputed sortAscendingOptions() {
    return [
