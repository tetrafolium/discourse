...
export default Component.extend({
  ...
  ,
    ...
    groupTrustLevel:
      computed("model.grant_trust_level", "trustLevelOptions",
               function() {
                 return (this.model.get("grant_trust_level") ||
  ...
  ,
    ...
    @discourseComputed("model.visibility_level",
  ...
  ,
    ...
    emailDomains: computed("model.emailDomains",
                           function() {
                             return this.model.emailDomains
    ...
    actions: {
      onChangeEmailDomainsSetting(value) {
        this.set("model.automatic_membership_email_domains",
