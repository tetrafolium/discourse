...
export default Component.extend({
  tagName: "tr",
    classNameBindings:
      [":topic-list-item", "unboundClassNames", "topic.visited"],
    attributeBindings: ["data-topic-id"], "data-topic-id": alias("topic.id"),
  ...
  ,
    ...
    @observes("topic.pinned") renderTopicListItem() {
  ...
  ,
    ...
    if (this.includeUnreadIndicator) {
      this.messageBus.subscribe(this.unreadIndicatorChannel, data => {
        const nodeClassList =
          document.querySelector(`.indicator-topic-${data.topic_id}`).classList;
  ...
  ,
    ...
    @discourseComputed("topic.id") unreadIndicatorChannel(topicId) {
  ...
  ,
    ...
    @discourseComputed expandPinned:
      function() {
