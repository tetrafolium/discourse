...
export default Component.extend({
  classNameBindings: ["hidden:hidden", ":create-topics-notice"],
    ...
    publicTopicCount: null, publicPostCount: null,
  ...
  ,
    ...
    @discourseComputed("enabled", "shouldSee", "publicTopicCount",
                       "publicPostCount") hidden() {
    return (!this.enabled || !this.shouldSee || this.publicTopicCount == null ||
            this.publicPostCount == null);
  }
  ,

    @discourseComputed("publicTopicCount", "publicPostCount",
                       "topicTrackingState.incomingCount") message() {
    let msg = null;

    if (this.publicTopicCount < this.requiredTopics &&
    ...
    return new Handlebars.SafeString(I18n.messageFormat(msg, {
  ...
  ,
    ...
    @observes("topicTrackingState.incomingCount") fetchLiveStats() {
    if (!this.enabled) {
      return;
    }
