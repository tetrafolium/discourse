...
export default Controller.extend(ModalFunctionality, {
  topicController: inject("topic"),
    ...
    @discourseComputed("saving", "new_user") buttonDisabled(saving, newUser) {
    return saving || isEmpty(newUser);
  }
  ,

    onShow() {
    this.setProperties({ saving: false, new_user: "" });
  }
  ,
    ...
    actions: {
      changeOwnershipOfPosts() {
        ...
        Topic.changeOwners(this.get("topicController.model.id"), options)
          .then(
            () => {
              ...
              next(() => DiscourseURL.routeTo(
                     this.get("topicController.model.url")));
            },
            () => {
