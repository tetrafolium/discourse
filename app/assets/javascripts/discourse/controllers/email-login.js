...
export default Controller.extend({
  lockImageUrl: Discourse.getURL("/images/lock.svg"),
    ...
    @discourseComputed("model") secondFactorRequired(model) {
    return model.security_key_required || model.second_factor_required;
  }
  ,

    @discourseComputed("model") secondFactorMethod(model) {
    return model.security_key_required ? SECOND_FACTOR_METHODS.SECURITY_KEY
