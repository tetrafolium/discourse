...
export default Controller.extend({
  userTopicsList: controller("user-topics-list"), user: controller(),
    router: service(),

    pmView: false, viewingSelf: alias("user.viewingSelf"),
    ...
    showToggleBulkSelect: true, pmTaggingEnabled: alias("site.can_tag_pms"),
    tagId: null,
  ...
  ,
    ...
    @discourseComputed("hasSelection", "pmView",
                       "archive") canArchive(hasSelection, pmView, archive) {
    return hasSelection && pmView !== "archive" && !archive;
  }
  ,
    ...
    Topic.bulkOperation(selected, params)
      .then(
        () => {
