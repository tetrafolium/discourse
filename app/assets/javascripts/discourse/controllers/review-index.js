...
export default Controller.extend({
  queryParams:
    [
      ...
      "from_date", "to_date", "sort_order", "additional_filters"
    ],
    type: null, status: "pending", priority: "low", category_id: null,
    reviewables: null, topic_id: null, filtersExpanded: false, username: "",
    from_date: null, to_date: null, sort_order: "priority",
  ...
  ,
    ...
    @discourseComputed("reviewableTypes") allTypes() {
  ...
  ,
    ...
    @discourseComputed sortOrders() {
    return ["priority", "priority_asc", "created_at", "created_at_asc"].map(
      order => {
        return { id: order, name: I18n.t(`review.filters.orders.${order}`) };
      });
  }
  ,
    ...
    return [
      "pending", "approved", "rejected", "deleted", "ignored", "reviewed", "all"
    ].map(id => {
  ...
  ,
    ...
    @discourseComputed("filtersExpanded") toggleFiltersIcon(filtersExpanded) {
