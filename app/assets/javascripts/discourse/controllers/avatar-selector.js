...
export default Controller.extend(ModalFunctionality, {
  gravatarName: setting("gravatar_name"),
    ...
    @discourseComputed("selected", "user.system_avatar_upload_id",
  ...
  ,
    ...
    @discourseComputed("selected", "user.system_avatar_template",
  ...
  ,
    ...
    @discourseComputed() allowAvatarUpload() {
    return (this.siteSettings.allow_uploaded_avatars &&
  ...
  ,
    ...
    actions: {
      ...
      refreshGravatar() {
        ...
        return ajax(`/user_avatar/${
                      this.get("user.username")}/refresh_gravatar.json`,
                    { method: "POST" })
          .then(result => {
      ...
      saveAvatarSelection() {
        ...
        this.user.pickAvatar(selectedUploadId, type)
          .then(() => window.location.reload())
          .catch(popupAjaxError);
      }
    }
