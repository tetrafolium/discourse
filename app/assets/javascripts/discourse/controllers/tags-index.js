...
export default Controller.extend({
  ...
  ,
    ...
    @discourseComputed actionsMapping() {
    return {
            ...
            const tagsString =
              more === 0
                ...
                : I18n.t("tagging.delete_unused_confirmation_more_tags",
                         { count: more, tags: joinedTags });

            const string = I18n.t("tagging.delete_unused_confirmation",
                                  { count: tags.length, tags: tagsString });

            bootbox.confirm(string, I18n.t("tagging.cancel_delete_unused"),
                            I18n.t("tagging.delete_unused"), proceed => {
                              if (proceed) {
