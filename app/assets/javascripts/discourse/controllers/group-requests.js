...
export default Controller.extend({
  ...
  ,
    ...
    @discourseComputed("model.requesters.[]") hasRequesters(requesters) {
  ...
  ,
    ...
    actions: {
      ...
      acceptRequest(user) {
        ...
        user.setProperties({ request_accepted: true, request_denied: false });
      },
      ...
      denyRequest(user) {
        ...
        user.setProperties({ request_accepted: false, request_denied: true });
      }
    }
});
