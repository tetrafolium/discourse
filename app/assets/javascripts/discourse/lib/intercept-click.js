...
export default function interceptClick(e) {
  ...
  const $currentTarget = $(e.currentTarget), href = $currentTarget.attr("href");

  if (!href || href === "#" || $currentTarget.attr("target") ||
      $currentTarget.data("ember-action") ||
      $currentTarget.data("auto-route") || $currentTarget.data("share-url") ||
      ...
      $currentTarget.hasClass("lightbox") || href.indexOf("mailto:") === 0 ||
      (href.match(/^http[s]?:\/\//i) &&
       !href.match(
