...
export default DiscourseRoute.extend({
  queryParams:
    {q: {}, expanded: false, context_id: {}, context: {}, skip_context: {}},
  category: null,
  ...
  model(params) {
    ...
    if (params.context_id && !args.skip_context) {
      args.search_context = { type: params.context, id: params.context_id };
    }
    ...
    return PreloadStore
      ...
      .then(results => {
        const grouped_search_result =
          results ? results.grouped_search_result : {};
        const model =
          (results && translateResults(results)) || { grouped_search_result };
