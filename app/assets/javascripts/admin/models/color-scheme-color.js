...
const ColorSchemeColor = EmberObject.extend({
  ...
  ,
    ...
    @discourseComputed("hex") changed(hex) {
  ...
  ,
    ...
    @discourseComputed("default_hex", "hex") savedIsOverriden(defaultHex) {
  ...
  ,
    ...
    @discourseComputed("name") translatedName(name) {
    if (!this.is_advanced) {
  ...
  ,
    ...
    @discourseComputed("name") description(name) {
    if (!this.is_advanced) {
  ...
  **/
  ...
  ,
    ...
    @discourseComputed("hex") valid(hex) {
