...
const ScreenedIpAddress = EmberObject.extend({
  ...
  ,
    ...
    @discourseComputed("ip_address") isRange(ipAddress) {
  ...
  ,
    ...
    save() {
    return ajax(
      "/admin/logs/screened_ip_addresses" + (this.id ? "/" + this.id : "") +
        ".json",
      {
        type: this.id ? "PUT" : "POST",
        data: { ip_address: this.ip_address, action_name: this.action_name }
      });
  }
  ,
