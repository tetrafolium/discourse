...
export default Controller.extend({
  ...
  **/
    @observes("testEmailAddress") testEmailAddressChanged:
      function() {
      ...
      sendTestEmail:
        function() {
          ...
          ajax("/admin/email/test",
               { type: "POST", data: { email_address: this.testEmailAddress } })
            .then(response => this.set("sentTestEmailMessage",
                                       response.sent_test_email_message))
            .catch(e => {
