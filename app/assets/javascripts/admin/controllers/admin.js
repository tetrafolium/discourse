...
export default Controller.extend({
  ...
  ,
    ...
    @discourseComputed("siteSettings.enable_badges") showBadges(enableBadges) {
  ...
  ,
    ...
    let cssClasses = currentPath.split(".")
                       .filter(segment => {
                         return (segment !== "index" && segment !== "loading" &&
                                 segment !== "show" && segment !== "admin");
                       })
                       .map(dasherize)
                       .join(" ");
