...
const SCSS_VARIABLE_NAMES = [
  ...
  "small-width", "medium-width", "large-width", "google", "instagram",
  "facebook", "cas", "twitter", "github", "base-font-size", "base-line-height",
  "base-font-family", "primary-low", "primary-medium", "secondary-low",
  "secondary-medium", "tertiary-low", "quaternary-low", "highlight-low",
  "highlight-medium", "danger-low", "danger-medium", "success-low", "love-low"
];
...
export default Controller.extend(ModalFunctionality, {
  ...
  ,
    ...
    enabled: and("nameValid", "fileSelected"), disabled: not("enabled"),
    ...
    if (name) {
      ...
      } else if (themeFields.some(
                   tf => THEME_FIELD_VARIABLE_TYPE_IDS.includes(tf.type_id) &&
                         name === tf.name)) {
        return I18n.t(
  ...
  ,
    ...
    @discourseComputed("errorMessage") nameValid(errorMessage) {
    return null === errorMessage;
  }
  ,

    @observes("name") uploadChanged() {
