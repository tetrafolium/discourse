...
export default Controller.extend(bufferedProperty("model"), {
  adminBadges: controller(), saving: false, savingStatus: "",
  ...
  ,
    ...
    @discourseComputed("model.query",
                       "buffered.query") hasQuery(modelQuery, bufferedQuery) {
    if (bufferedQuery) {
  ...
  ,
    ...
    @observes("model.id") _resetSaving:
      function() {
    ...
    actions: {
      save() {
        if (!this.saving) {
          let fields = [
            "allow_title", "multiple_grant", "listable", "auto_revoke",
            "enabled", "show_posts", "target_posts", "name", "description",
            "long_description", "icon", "image", "query", "badge_grouping_id",
          ...
          const boolFields = [
            "allow_title", "multiple_grant", "listable", "auto_revoke",
            "enabled", "show_posts", "target_posts"
          ];
      ...
      destroy() {
        ...
        return bootbox.confirm(
          I18n.t("admin.badges.delete_confirm"), I18n.t("no_value"),
