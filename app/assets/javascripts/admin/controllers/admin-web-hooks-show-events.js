...
export default Controller.extend({
  pingDisabled: false, incomingCount: alias("incomingEventIds.length"),
  ...
  ,
    ...
    this.messageBus.subscribe(
      `/web_hook_events/${this.get("model.extras.web_hook_id")}`, data => {
    ...
    actions: {
      ...
      showInserted() {
        ...
        ajax(`/admin/api/web_hooks/${webHookId}/events/bulk`, {
          ...
          const objects =
            data.map(event => this.store.createRecord("web-hook-event", event));
