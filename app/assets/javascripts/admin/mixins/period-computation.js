...
export default Mixin.create({
  queryParams: ["period"], period: "monthly",
  ...
  ,
    ...
    @discourseComputed("period") startDate(period) {
  ...
  ,
    ...
    @discourseComputed() lastWeek() {
    return moment().locale("en").utc().endOf("day").subtract(1, "week");
  }
  ,

    @discourseComputed() lastMonth() {
