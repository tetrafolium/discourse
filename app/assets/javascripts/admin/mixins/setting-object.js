...
export default Mixin.create({
  ...
  ,
    ...
    computedValueProperty:
      computed("valueProperty", "validValues.[]",
               function() {
    ...
    computedNameProperty:
      computed("nameProperty", "validValues.[]",
               function() {
    ...
    @discourseComputed("valid_values") validValues(validValues) {
    const vals = [], translateNames = this.translate_names;
  ...
  ,
    ...
    @discourseComputed("valid_values") allowsNone(validValues) {
