  ...
  ,
    ...
    actions: {
      lookup() {
        ...
        if (!this.location) {
          ajax("/admin/users/ip-info", { data: { ip: this.ip } })
            .then(location =>
      ...
      deleteOtherAccounts() {
        bootbox.confirm(
          I18n.t("ip_lookup.confirm_delete_other_accounts"), I18n.t("no_value"),
          I18n.t("yes_value"), confirmed => {
            if (confirmed) {
              this.setProperties({
                other_accounts: null,
