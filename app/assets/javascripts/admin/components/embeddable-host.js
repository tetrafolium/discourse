...
export default Component.extend(bufferedProperty("host"), {
  editToggled: false, tagName: "tr", categoryId: null,

    editing: or("host.isNew", "editToggled"),

    @on("didInsertElement") @observes("editing") _focusOnInput() {
  ...
  ,
    ...
    @discourseComputed("buffered.host", "host.isSaving") cantSave(host,
                                                                  isSaving) {
  ...
  ,
    ...
    actions: {
      ...
      save() {
        ...
        const props =
          this.buffered.getProperties("host", "path_whitelist", "class_name");
