...
export default Component.extend({
  ...
  ,
    ...
    @discourseComputed("currentTargetName",
                       "fieldName") activeSectionMode(targetName, fieldName) {
  ...
  ,
    ...
    @discourseComputed("fieldName", "currentTargetName", "theme") activeSection:
      {
    ...
    @discourseComputed("maximized") maximizeIcon(maximized) {
  ...
  ,
    ...
    @discourseComputed("currentTargetName", "fieldName",
                       "theme.theme_fields.@each.error") error(target,
                                                               fieldName) {
