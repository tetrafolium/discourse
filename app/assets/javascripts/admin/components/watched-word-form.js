...
export default Component.extend({
  classNames: ["watched-word-form"], formSubmitted: false, actionKey: null,
    showMessage: false,
  ...
  ,
    ...
    @discourseComputed("word") isUniqueWord(word) {
    ...
    return filtered.every(content =>
                            content.word.toLowerCase() !== word.toLowerCase());
  }
  ,
    ...
    actions: {
      submit() {
        ...
        if (!this.formSubmitted) {
          ...
          const watchedWord =
            WatchedWord.create({ word: this.word, action: this.actionKey });
