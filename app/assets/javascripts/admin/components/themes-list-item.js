...
export default Component.extend({
  childrenExpanded: false, classNames: ["themes-list-item"],
  ...
  ,
    ...
    @observes("theme.selected") triggerAnimation() {
    this.animate();
  }
  ,
  ...
  ,
    ...
    @discourseComputed("theme.component", "theme.childThemes.@each.name",
    ...
    children =
      this.childrenExpanded ? children : children.slice(0, MAX_COMPONENTS);
  ...
  ,
    ...
    @discourseComputed("children") childrenString(children) {
    return children.join(", ");
  }
  ,

    @discourseComputed("theme.childThemes.length", "theme.component",
                       "childrenExpanded", "children.length")
  ...
  ,
    ...
    $list.animate({ opacity: 0 }, { duration });
  }
  ,
