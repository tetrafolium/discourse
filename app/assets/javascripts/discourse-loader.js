...
var EMBER_MODULES = {};
var ALIASES = {
  "ember-addons/ember-computed-decorators": "discourse-common/utils/decorators"
};
if (typeof Ember !== "undefined") {
  EMBER_MODULES = {
    jquery: { default: $ },
    "@ember/array":
      { default: Ember.Array, A: Ember.A, isArray: Ember.isArray },
    "@ember/array/proxy": { default: Ember.ArrayProxy },
    "@ember/component": {
    ...
    "@ember/controller":
      { default: Ember.Controller, inject: Ember.inject.controller },
    "@ember/debug": { warn: Ember.warn },
    "@ember/object": {
    ...
    "@ember/object/evented": { default: Ember.Evented, on: Ember.on },
    ...
    "@ember/service": { default: Ember.Service, inject: Ember.inject.service },
    "@ember/utils": {
    ...
    "@ember/template": { htmlSafe: Ember.String.htmlSafe },
    "@ember/application": {
      default: Ember.Application,
      setOwner: Ember.setOwner,
      getOwner: Ember.getOwner
    },
    "@ember/component/helper": { default: Ember.Helper },
    "@ember/error": { default: Ember.error },
    "@ember/object/internals": { guidFor: Ember.guidFor }
  };
}
...
function reify(mod, name, rseen) {
  ...
  return { deps: reified, module: module };
}
...
function requireFrom(name, origin) {
  ...
  if (!mod) {
    throw new Error("Could not find module `" + name + "` imported from `" +
                    origin + "`");
  }
